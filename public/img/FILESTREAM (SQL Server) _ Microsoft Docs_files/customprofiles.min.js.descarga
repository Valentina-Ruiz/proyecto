...
goog.addDependency=function(a,b,c){if(!COMPILED){var d;a=a.replace(/\\/g,"/");for(var f=goog.dependencies_,e=0;d=b[e];e++)f.nameToPath[d]=a,a in f.pathToNames||(f.pathToNames[a]={}),f.pathToNames[a][d]=!0;for(d=0;b=c[d];d++)a in f.requires||(f.requires[a]={}),f.requires[a][b]=!0}};goog.ENABLE_DEBUG_LOADER=!0;
...
goog.string.numerateCompare=function(a,b){if(a==b)return 0;if(!a)return-1;if(!b)return 1;for(var c=a.toLowerCase().match(goog.string.numerateCompareRegExp_),d=b.toLowerCase().match(goog.string.numerateCompareRegExp_),f=Math.min(c.length,d.length),e=0;e<f;e++){var g=c[e],h=d[e];if(g!=h)return c=parseInt(g,10),!isNaN(c)&&(d=parseInt(h,10),!isNaN(d)&&c-d)?c-d:g<h?-1:1}return c.length!=d.length?c.length-d.length:a<b?-1:1};goog.string.urlEncode=function(a){return encodeURIComponent(String(a))};
...
goog.string.unescapeEntitiesUsingDom_=function(a){var b={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"'},c=document.createElement("div");return a.replace(goog.string.HTML_ENTITY_PATTERN_,function(a,f){var e=b[a];if(e)return e;if("#"==f.charAt(0)){var g=Number("0"+f.substr(1));isNaN(g)||(e=String.fromCharCode(g))}e||(c.innerHTML=a+" ",e=c.firstChild.nodeValue.slice(0,-1));return b[a]=e})};
...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),f=goog.string.trim(String(b)).split("."),e=Math.max(d.length,f.length),g=0;0==c&&g<e;g++){var h=d[g]||"",k=f[g]||"",l=RegExp("(\\d*)(\\D*)","g"),m=RegExp("(\\d*)(\\D*)","g");do{var n=l.exec(h)||["","",""],p=m.exec(k)||["","",""];if(0==n[0].length&&0==p[0].length)break;var c=0==n[1].length?0:parseInt(n[1],10),q=0==p[1].length?0:parseInt(p[1],10),c=goog.string.compareElements_(c,q)||goog.string.compareElements_(0==
...
goog.uri.utils.findParam_=function(a,b,c,d){for(var f=c.length;0<=(b=a.indexOf(c,b))&&b<d;){var e=a.charCodeAt(b-1);if(e==goog.uri.utils.CharCode_.AMPERSAND||e==goog.uri.utils.CharCode_.QUESTION)if(e=a.charCodeAt(b+f),!e||e==goog.uri.utils.CharCode_.EQUAL||e==goog.uri.utils.CharCode_.AMPERSAND||e==goog.uri.utils.CharCode_.HASH)return b;b+=f+1}return-1};goog.uri.utils.hashOrEndRe_=/#|$/;goog.uri.utils.hasParam=function(a,b){return 0<=goog.uri.utils.findParam_(a,0,b,a.search(goog.uri.utils.hashOrEndRe_))};
goog.uri.utils.getParamValue=function(a,b){var c=a.search(goog.uri.utils.hashOrEndRe_),d=goog.uri.utils.findParam_(a,0,b,c);if(0>d)return null;var f=a.indexOf("&",d);if(0>f||f>c)f=c;d+=b.length+1;return goog.string.urlDecode(a.substr(d,f-d))};goog.uri.utils.getParamValues=function(a,b){for(var c=a.search(goog.uri.utils.hashOrEndRe_),d=0,f,e=[];0<=(f=goog.uri.utils.findParam_(a,d,b,c));){d=a.indexOf("&",f);if(0>d||d>c)d=c;f+=b.length+1;e.push(goog.string.urlDecode(a.substr(f,d-f)))}return e};
goog.uri.utils.trailingQueryPunctuationRe_=/[?&]($|#)/;goog.uri.utils.removeParam=function(a,b){for(var c=a.search(goog.uri.utils.hashOrEndRe_),d=0,f,e=[];0<=(f=goog.uri.utils.findParam_(a,d,b,c));)e.push(a.substring(d,f)),d=Math.min(a.indexOf("&",f)+1||c,c);e.push(a.substr(d));return e.join("").replace(goog.uri.utils.trailingQueryPunctuationRe_,"$1")};goog.uri.utils.setParam=function(a,b,c){return goog.uri.utils.appendParam(goog.uri.utils.removeParam(a,b),b,c)};
goog.uri.utils.appendPath=function(a,b){goog.uri.utils.assertNoFragmentsOrQueries_(a);goog.string.endsWith(a,"/")&&(a=a.substr(0,a.length-1));goog.string.startsWith(b,"/")&&(b=b.substr(1));return goog.string.buildString(a,"/",b)};goog.uri.utils.StandardQueryParam={RANDOM:"zx"};goog.uri.utils.makeUnique=function(a){return goog.uri.utils.setParam(a,goog.uri.utils.StandardQueryParam.RANDOM,goog.string.getRandomString())};goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},f;for(f in a)b.call(c,a[f],f,a)&&(d[f]=a[f]);return d};goog.object.map=function(a,b,c){var d={},f;for(f in a)d[f]=b.call(c,a[f],f,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.object.extend=function(a,b){for(var c,d,f=1;f<arguments.length;f++){d=arguments[f];for(c in d)a[c]=d[c];for(var e=0;e<goog.object.PROTOTYPE_FIELDS_.length;e++)c=goog.object.PROTOTYPE_FIELDS_[e],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}};
...
goog.array.forEach=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.forEach?function(a,b,c){goog.asserts.assert(null!=a.length);goog.array.ARRAY_PROTOTYPE_.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=goog.isString(a)?a.split(""):a,e=0;e<d;e++)e in f&&b.call(c,f[e],e,a)};goog.array.forEachRight=function(a,b,c){for(var d=a.length,f=goog.isString(a)?a.split(""):a,d=d-1;0<=d;--d)d in f&&b.call(c,f[d],d,a)};
goog.array.filter=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.filter?function(a,b,c){goog.asserts.assert(null!=a.length);return goog.array.ARRAY_PROTOTYPE_.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=[],e=0,g=goog.isString(a)?a.split(""):a,h=0;h<d;h++)if(h in g){var k=g[h];b.call(c,k,h,a)&&(f[e++]=k)}return f};
goog.array.map=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.map?function(a,b,c){goog.asserts.assert(null!=a.length);return goog.array.ARRAY_PROTOTYPE_.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=Array(d),e=goog.isString(a)?a.split(""):a,g=0;g<d;g++)g in e&&(f[g]=b.call(c,e[g],g,a));return f};goog.array.reduce=function(a,b,c,d){if(a.reduce)return d?a.reduce(goog.bind(b,d),c):a.reduce(b,c);var f=c;goog.array.forEach(a,function(c,g){f=b.call(d,f,c,g,a)});return f};
goog.array.reduceRight=function(a,b,c,d){if(a.reduceRight)return d?a.reduceRight(goog.bind(b,d),c):a.reduceRight(b,c);var f=c;goog.array.forEachRight(a,function(c,g){f=b.call(d,f,c,g,a)});return f};
goog.array.some=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.some?function(a,b,c){goog.asserts.assert(null!=a.length);return goog.array.ARRAY_PROTOTYPE_.some.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=goog.isString(a)?a.split(""):a,e=0;e<d;e++)if(e in f&&b.call(c,f[e],e,a))return!0;return!1};
goog.array.every=goog.NATIVE_ARRAY_PROTOTYPES&&goog.array.ARRAY_PROTOTYPE_.every?function(a,b,c){goog.asserts.assert(null!=a.length);return goog.array.ARRAY_PROTOTYPE_.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=goog.isString(a)?a.split(""):a,e=0;e<d;e++)if(e in f&&!b.call(c,f[e],e,a))return!1;return!0};goog.array.count=function(a,b,c){var d=0;goog.array.forEach(a,function(a,e,g){b.call(c,a,e,g)&&++d},c);return d};
goog.array.find=function(a,b,c){b=goog.array.findIndex(a,b,c);return 0>b?null:goog.isString(a)?a.charAt(b):a[b]};goog.array.findIndex=function(a,b,c){for(var d=a.length,f=goog.isString(a)?a.split(""):a,e=0;e<d;e++)if(e in f&&b.call(c,f[e],e,a))return e;return-1};goog.array.findRight=function(a,b,c){b=goog.array.findIndexRight(a,b,c);return 0>b?null:goog.isString(a)?a.charAt(b):a[b]};
...
goog.array.extend=function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c],f;if(goog.isArray(d)||(f=goog.isArrayLike(d))&&Object.prototype.hasOwnProperty.call(d,"callee"))a.push.apply(a,d);else if(f)for(var e=a.length,g=d.length,h=0;h<g;h++)a[e+h]=d[h];else a.push(d)}};goog.array.splice=function(a,b,c,d){goog.asserts.assert(null!=a.length);return goog.array.ARRAY_PROTOTYPE_.splice.apply(a,goog.array.slice(arguments,1))};
goog.array.slice=function(a,b,c){goog.asserts.assert(null!=a.length);return 2>=arguments.length?goog.array.ARRAY_PROTOTYPE_.slice.call(a,b):goog.array.ARRAY_PROTOTYPE_.slice.call(a,b,c)};goog.array.removeDuplicates=function(a,b){for(var c=b||a,d={},f=0,e=0;e<a.length;){var g=a[e++],h=goog.isObject(g)?"o"+goog.getUid(g):(typeof g).charAt(0)+g;Object.prototype.hasOwnProperty.call(d,h)||(d[h]=!0,c[f++]=g)}c.length=f};
goog.array.binarySearch=function(a,b,c){return goog.array.binarySearch_(a,c||goog.array.defaultCompare,!1,b)};goog.array.binarySelect=function(a,b,c){return goog.array.binarySearch_(a,b,!0,void 0,c)};goog.array.binarySearch_=function(a,b,c,d,f){for(var e=0,g=a.length,h;e<g;){var k=e+g>>1,l;l=c?b.call(f,a[k],k,a):b(d,a[k]);0<l?e=k+1:(g=k,h=!l)}return h?e:~e};goog.array.sort=function(a,b){goog.asserts.assert(null!=a.length);goog.array.ARRAY_PROTOTYPE_.sort.call(a,b||goog.array.defaultCompare)};
...
goog.array.compare3=function(a,b,c){c=c||goog.array.defaultCompare;for(var d=Math.min(a.length,b.length),f=0;f<d;f++){var e=c(a[f],b[f]);if(0!=e)return e}return goog.array.defaultCompare(a.length,b.length)};goog.array.defaultCompare=function(a,b){return a>b?1:a<b?-1:0};goog.array.defaultCompareEquality=function(a,b){return a===b};goog.array.binaryInsert=function(a,b,c){c=goog.array.binarySearch(a,b,c);return 0>c?(goog.array.insertAt(a,b,-(c+1)),!0):!1};
goog.array.binaryRemove=function(a,b,c){b=goog.array.binarySearch(a,b,c);return 0<=b?goog.array.removeAt(a,b):!1};goog.array.bucket=function(a,b){for(var c={},d=0;d<a.length;d++){var f=a[d],e=b(f,d,a);goog.isDef(e)&&(c[e]||(c[e]=[])).push(f)}return c};goog.array.toObject=function(a,b,c){var d={};goog.array.forEach(a,function(f,e){d[b.call(c,f,e,a)]=f});return d};
goog.array.range=function(a,b,c){var d=[],f=0,e=a;c=c||1;void 0!==b&&(f=a,e=b);if(0>c*(e-f))return[];if(0<c)for(a=f;a<e;a+=c)d.push(a);else for(a=f;a>e;a+=c)d.push(a);return d};goog.array.repeat=function(a,b){for(var c=[],d=0;d<b;d++)c[d]=a;return c};goog.array.flatten=function(a){for(var b=[],c=0;c<arguments.length;c++){var d=arguments[c];goog.isArray(d)?b.push.apply(b,goog.array.flatten.apply(null,d)):b.push(d)}return b};
goog.array.rotate=function(a,b){goog.asserts.assert(null!=a.length);a.length&&(b%=a.length,0<b?goog.array.ARRAY_PROTOTYPE_.unshift.apply(a,a.splice(-b,b)):0>b&&goog.array.ARRAY_PROTOTYPE_.push.apply(a,a.splice(0,-b)));return a};goog.array.zip=function(a){if(!arguments.length)return[];for(var b=[],c=0;;c++){for(var d=[],f=0;f<arguments.length;f++){var e=arguments[f];if(c>=e.length)return b;d.push(e[c])}b.push(d)}};
goog.array.shuffle=function(a,b){for(var c=b||Math.random,d=a.length-1;0<d;d--){var f=Math.floor(c()*(d+1)),e=a[d];a[d]=a[f];a[f]=e}};goog.iter={};goog.iter.StopIteration="StopIteration"in goog.global?goog.global.StopIteration:Error("StopIteration");goog.iter.Iterator=function(){};goog.iter.Iterator.prototype.next=function(){throw goog.iter.StopIteration;};goog.iter.Iterator.prototype.__iterator__=function(a){return this};
...
goog.iter.range=function(a,b,c){var d=0,f=a,e=c||1;1<arguments.length&&(d=a,f=b);if(0==e)throw Error("Range step argument must not be zero");var g=new goog.iter.Iterator;g.next=function(){if(0<e&&d>=f||0>e&&d<=f)throw goog.iter.StopIteration;var a=d;d+=e;return a};return g};goog.iter.join=function(a,b){return goog.iter.toArray(a).join(b)};goog.iter.map=function(a,b,c){var d=goog.iter.toIterator(a);a=new goog.iter.Iterator;a.next=function(){for(;;){var a=d.next();return b.call(c,a,void 0,d)}};return a};
...
goog.structs.forEach=function(a,b,c){if("function"==typeof a.forEach)a.forEach(b,c);else if(goog.isArrayLike(a)||goog.isString(a))goog.array.forEach(a,b,c);else for(var d=goog.structs.getKeys(a),f=goog.structs.getValues(a),e=f.length,g=0;g<e;g++)b.call(c,f[g],d&&d[g],a)};
goog.structs.filter=function(a,b,c){if("function"==typeof a.filter)return a.filter(b,c);if(goog.isArrayLike(a)||goog.isString(a))return goog.array.filter(a,b,c);var d,f=goog.structs.getKeys(a),e=goog.structs.getValues(a),g=e.length;if(f){d={};for(var h=0;h<g;h++)b.call(c,e[h],f[h],a)&&(d[f[h]]=e[h])}else for(d=[],h=0;h<g;h++)b.call(c,e[h],void 0,a)&&d.push(e[h]);return d};
goog.structs.map=function(a,b,c){if("function"==typeof a.map)return a.map(b,c);if(goog.isArrayLike(a)||goog.isString(a))return goog.array.map(a,b,c);var d,f=goog.structs.getKeys(a),e=goog.structs.getValues(a),g=e.length;if(f){d={};for(var h=0;h<g;h++)d[f[h]]=b.call(c,e[h],f[h],a)}else for(d=[],h=0;h<g;h++)d[h]=b.call(c,e[h],void 0,a);return d};
goog.structs.some=function(a,b,c){if("function"==typeof a.some)return a.some(b,c);if(goog.isArrayLike(a)||goog.isString(a))return goog.array.some(a,b,c);for(var d=goog.structs.getKeys(a),f=goog.structs.getValues(a),e=f.length,g=0;g<e;g++)if(b.call(c,f[g],d&&d[g],a))return!0;return!1};
goog.structs.every=function(a,b,c){if("function"==typeof a.every)return a.every(b,c);if(goog.isArrayLike(a)||goog.isString(a))return goog.array.every(a,b,c);for(var d=goog.structs.getKeys(a),f=goog.structs.getValues(a),e=f.length,g=0;g<e;g++)if(!b.call(c,f[g],d&&d[g],a))return!1;return!0};goog.structs.Map=function(a,b){this.map_={};this.keys_=[];var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.addAll(a)};goog.structs.Map.prototype.count_=0;goog.structs.Map.prototype.version_=0;goog.structs.Map.prototype.getCount=function(){return this.count_};
...
goog.structs.Map.prototype.getValueIterator=function(){return this.__iterator__(!1)};goog.structs.Map.prototype.__iterator__=function(a){this.cleanupKeysArray_();var b=0,c=this.keys_,d=this.map_,f=this.version_,e=this,g=new goog.iter.Iterator;g.next=function(){for(;;){if(f!=e.version_)throw Error("The map has changed since the iterator was created");if(b>=c.length)throw goog.iter.StopIteration;var g=c[b++];return a?g:d[g]}};return g};
...
goog.Uri.prototype.resolve=function(a){var b=this.clone(),c=a.hasScheme();c?b.setScheme(a.getScheme()):c=a.hasUserInfo();c?b.setUserInfo(a.getUserInfo()):c=a.hasDomain();c?b.setDomain(a.getDomain()):c=a.hasPort();var d=a.getPath();if(c)b.setPort(a.getPort());else if(c=a.hasPath()){if("/"!=d.charAt(0))if(this.hasDomain()&&!this.hasPath())d="/"+d;else{var f=b.getPath().lastIndexOf("/");-1!=f&&(d=b.getPath().substr(0,f+1)+d)}d=goog.Uri.removeDotSegments(d)}c?b.setPath(d):c=a.hasQuery();c?b.setQueryData(a.getDecodedQuery()):
...
goog.Uri.QueryData.prototype.ensureKeyMapInitialized_=function(){if(!this.keyMap_&&(this.keyMap_=new goog.structs.Map,this.count_=0,this.encodedQuery_))for(var a=this.encodedQuery_.split("&"),b=0;b<a.length;b++){var c=a[b].indexOf("="),d=null,f=null;0<=c?(d=a[b].substring(0,c),f=a[b].substring(c+1)):d=a[b];d=goog.string.urlDecode(d);d=this.getKeyName_(d);this.add(d,f?goog.string.urlDecode(f):"")}};
goog.Uri.QueryData.createFromMap=function(a,b,c){b=goog.structs.getKeys(a);if("undefined"==typeof b)throw Error("Keys are undefined");c=new goog.Uri.QueryData(null,null,c);a=goog.structs.getValues(a);for(var d=0;d<b.length;d++){var f=b[d],e=a[d];goog.isArray(e)?c.setValues(f,e):c.add(f,e)}return c};
...
goog.Uri.QueryData.prototype.toString=function(){if(this.encodedQuery_)return this.encodedQuery_;if(!this.keyMap_)return"";for(var a=[],b=this.keyMap_.getKeys(),c=0;c<b.length;c++)for(var d=b[c],f=goog.string.urlEncode(d),d=this.getValues(d),e=0;e<d.length;e++){var g=f;""!==d[e]&&(g+="="+goog.string.urlEncode(d[e]));a.push(g)}return this.encodedQuery_=a.join("&")};goog.Uri.QueryData.prototype.toDecodedString=function(){return goog.Uri.decodeOrEmpty_(this.toString())};
...
goog.structs.Set.prototype.equals=function(a){return this.getCount()==goog.structs.getCount(a)&&this.isSubsetOf(a)};goog.structs.Set.prototype.isSubsetOf=function(a){var b=goog.structs.getCount(a);if(this.getCount()>b)return!1;!(a instanceof goog.structs.Set)&&5<b&&(a=new goog.structs.Set(a));return goog.structs.every(this,function(b){return goog.structs.contains(a,b)})};goog.structs.Set.prototype.__iterator__=function(a){return this.map_.__iterator__(!1)};goog.debug.catchErrors=function(a,b,c){c=c||goog.global;var d=c.onerror,f=!!b;goog.userAgent.WEBKIT&&!goog.userAgent.isVersion("535.3")&&(f=!f);c.onerror=function(b,c,h){d&&d(b,c,h);a({message:b,fileName:c,line:h});return f}};goog.debug.expose=function(a,b){if("undefined"==typeof a)return"undefined";if(null==a)return"NULL";var c=[],d;for(d in a)if(b||!goog.isFunction(a[d])){var f=d+" = ";try{f+=a[d]}catch(e){f+="*** "+e+" ***"}c.push(f)}return c.join("\n")};
goog.debug.deepExpose=function(a,b){var c=new goog.structs.Set,d=[],f=function(a,g){var h=g+"  ";try{if(goog.isDef(a))if(goog.isNull(a))d.push("NULL");else if(goog.isString(a))d.push('"'+a.replace(/\n/g,"\n"+g)+'"');else if(goog.isFunction(a))d.push(String(a).replace(/\n/g,"\n"+g));else if(goog.isObject(a))if(c.contains(a))d.push("*** reference loop detected ***");else{c.add(a);d.push("{");for(var k in a)if(b||!goog.isFunction(a[k]))d.push("\n"),d.push(h),d.push(k+" = "),f(a[k],h);d.push("\n"+g+"}")}else d.push(a);
else d.push("undefined")}catch(l){d.push("*** "+l+" ***")}};f(a,"");return d.join("")};goog.debug.exposeArray=function(a){for(var b=[],c=0;c<a.length;c++)goog.isArray(a[c])?b.push(goog.debug.exposeArray(a[c])):b.push(a[c]);return"[ "+b.join(", ")+" ]"};
...
goog.debug.normalizeErrorObject=function(a){var b=goog.getObjectByName("window.location.href");if(goog.isString(a))return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c,d,f=!1;try{c=a.lineNumber||a.line||"Not available"}catch(e){c="Not available",f=!0}try{d=a.fileName||a.filename||a.sourceURL||goog.global.$googDebugFname||b}catch(e){d="Not available",f=!0}return!f&&a.lineNumber&&a.fileName&&a.stack?a:{message:a.message,name:a.name,lineNumber:c,fileName:d,
...
10))};goog.debug.Formatter.getTwoDigitString_=function(a){return 10>a?"0"+a:String(a)};goog.debug.Formatter.getRelativeTime_=function(a,b){var c=(a.getMillis()-b)/1E3,d=c.toFixed(3),f=0;if(1>c)f=2;else for(;100>c;)f++,c*=10;for(;0<f--;)d=" "+d;return d};goog.debug.HtmlFormatter=function(a){goog.debug.Formatter.call(this,a)};goog.inherits(goog.debug.HtmlFormatter,goog.debug.Formatter);goog.debug.HtmlFormatter.prototype.showExceptionText=!0;
...
goog.debug.Console.autoInstall=function(){goog.debug.Console.instance||(goog.debug.Console.instance=new goog.debug.Console);-1!=window.location.href.indexOf("Debug=true")&&goog.debug.Console.instance.setCapturing(!0)};goog.debug.Console.show=function(){alert(goog.debug.Console.instance.logBuffer_)};goog.debug.Console.logToConsole_=function(a,b,c){if(a[b])a[b](c);else a.log(c)};goog.net={};goog.net.Cookies=function(a){this.document_=a};goog.net.Cookies.MAX_COOKIE_LENGTH=3950;goog.net.Cookies.SPLIT_RE_=/\s*;\s*/;goog.net.Cookies.prototype.isEnabled=function(){return navigator.cookieEnabled};goog.net.Cookies.prototype.isValidName=function(a){return!/[;=\s]/.test(a)};goog.net.Cookies.prototype.isValidValue=function(a){return!/[;\r\n]/.test(a)};
goog.net.Cookies.prototype.set=function(a,b,c,d,f,e){if(!this.isValidName(a))throw Error('Invalid cookie name "'+a+'"');if(!this.isValidValue(b))throw Error('Invalid cookie value "'+b+'"');goog.isDef(c)||(c=-1);f=f?";domain="+f:"";d=d?";path="+d:"";e=e?";secure":"";c=0>c?"":0==c?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(goog.now()+1E3*c)).toUTCString();this.setCookie_(a+"="+b+f+d+c+e)};
goog.net.Cookies.prototype.get=function(a,b){for(var c=a+"=",d=this.getParts_(),f=0,e;e=d[f];f++){if(0==e.lastIndexOf(c,0))return e.substr(c.length);if(e==a)return""}return b};goog.net.Cookies.prototype.remove=function(a,b,c){var d=this.containsKey(a);this.set(a,"",0,b,c);return d};goog.net.Cookies.prototype.getKeys=function(){return this.getKeyValues_().keys};goog.net.Cookies.prototype.getValues=function(){return this.getKeyValues_().values};goog.net.Cookies.prototype.isEmpty=function(){return!this.getCookie_()};
...
goog.net.Cookies.prototype.setCookie_=function(a){this.document_.cookie=a};goog.net.Cookies.prototype.getCookie_=function(){return this.document_.cookie};goog.net.Cookies.prototype.getParts_=function(){return(this.getCookie_()||"").split(goog.net.Cookies.SPLIT_RE_)};goog.net.Cookies.prototype.getKeyValues_=function(){for(var a=this.getParts_(),b=[],c=[],d,f,e=0;f=a[e];e++)d=f.indexOf("="),-1==d?(b.push(""),c.push(f)):(b.push(f.substring(0,d)),c.push(f.substring(d+1)));return{keys:b,values:c}};
goog.net.cookies=new goog.net.Cookies(document);goog.net.cookies.MAX_COOKIE_LENGTH=goog.net.Cookies.MAX_COOKIE_LENGTH;goog.userAgent.product={};goog.userAgent.product.ASSUME_FIREFOX=!1;goog.userAgent.product.ASSUME_CAMINO=!1;goog.userAgent.product.ASSUME_IPHONE=!1;goog.userAgent.product.ASSUME_IPAD=!1;goog.userAgent.product.ASSUME_ANDROID=!1;goog.userAgent.product.ASSUME_CHROME=!1;goog.userAgent.product.ASSUME_SAFARI=!1;
...
goog.userAgent.product.SAFARI=goog.userAgent.product.PRODUCT_KNOWN_?goog.userAgent.product.ASSUME_SAFARI:goog.userAgent.product.detectedSafari_;goog.object.extend(fyre,{util:{}});fyre.util.browser={};fyre.util.browser.isMobile=function(){var a=goog.userAgent.getUserAgentString();return goog.userAgent.MOBILE||goog.userAgent.product.ANDROID||-1<a.indexOf("IEMobile")};
...
fyre.sp.config.API_PATH="/api/v1.0/public";fyre.sp.config.JS_CONFIG=fyre.sp.config.API_PATH+"/config/js-config";fyre.sp.config.PUBLIC_API_URL="";fyre.sp.config.JANRAIN_ENGAGE_EMBED_ID="janrainEngageEmbed";fyre.sp.config.JANRAIN_ENGAGE_ID="janrainAuthWidget";
if((window.Livefyre||{}).userPrivacyOptOut){var storage=fyre.util.browser.localStorage(),keys=[fyre.sp.config.authCookie,fyre.sp.config.iframeCookie,fyre.sp.config.mobileAuthTriggerCookie,fyre.sp.config.mobileNextCookie];goog.array.forEach(keys,function(a){storage.removeItem(a);goog.net.cookies.set("lfsp-profile",null,0,"/")})};fyre.logging={};fyre.logging.CustomLogger=function(){goog.debug.Console.call(this);this.formatter_.showRelativeTime=!1};goog.inherits(fyre.logging.CustomLogger,goog.debug.Console);fyre.logging.CustomLogger.prototype.addLogRecord=function(a){fyre.logging.CustomLogger.superClass_.addLogRecord.call(this,a);-1===fyre.sp.config.servers.sentry_dsn.indexOf(".livefyre.com")||a.getLevel()};
...
goog.events.Listener.prototype.init=function(a,b,c,d,f,e){if(goog.isFunction(a))this.isFunctionListener_=!0;else if(a&&a.handleEvent&&goog.isFunction(a.handleEvent))this.isFunctionListener_=!1;else throw Error("Invalid listener argument");this.listener=a;this.proxy=b;this.src=c;this.type=d;this.capture=!!f;this.handler=e;this.callOnce=!1;this.key=goog.events.ListenableKey.reserveKey();this.removed=!1};
...
goog.events.listen=function(a,b,c,d,f){if(goog.isArray(b)){for(var e=0;e<b.length;e++)goog.events.listen(a,b[e],c,d,f);return null}a=goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a)?a.listen(b,goog.events.wrapListener_(c),d,f):goog.events.listen_(a,b,c,!1,d,f);b=a.key;goog.events.listeners_[b]=a;return b};goog.events.CUSTOM_EVENT_ATTR="customEvent_";
goog.events.listen_=function(a,b,c,d,f,e){if(!b)throw Error("Invalid event type");f=!!f;var g=goog.events.listenerTree_;b in g||(g[b]={count_:0,remaining_:0});g=g[b];f in g||(g[f]={count_:0,remaining_:0},g.count_++);var g=g[f],h=goog.getUid(a),k;g.remaining_++;if(g[h]){k=g[h];for(var l=0;l<k.length;l++)if(g=k[l],g.listener==c&&g.handler==e){if(g.removed)break;d||(k[l].callOnce=!1);return k[l]}}else k=g[h]=[],g.count_++;l=goog.events.getProxy();g=new goog.events.Listener;g.init(c,l,a,b,f,e);g.callOnce=
d;l.src=a;l.listener=g;k.push(g);goog.events.sources_[h]||(goog.events.sources_[h]=[]);goog.events.sources_[h].push(g);a.addEventListener?a!=goog.global&&a[goog.events.CUSTOM_EVENT_ATTR]?goog.events.STRICT_EVENT_TARGET&&a.assertInitialized():a.addEventListener(b,l,f):a.attachEvent(goog.events.getOnString_(b),l);return g};
...
goog.events.listenOnce=function(a,b,c,d,f){if(goog.isArray(b)){for(var e=0;e<b.length;e++)goog.events.listenOnce(a,b[e],c,d,f);return null}a=goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a)?a.listenOnce(b,goog.events.wrapListener_(c),d,f):goog.events.listen_(a,b,c,!0,d,f);b=a.key;goog.events.listeners_[b]=a;return b};goog.events.listenWithWrapper=function(a,b,c,d,f){b.listen(a,c,d,f)};
goog.events.unlisten=function(a,b,c,d,f){if(goog.isArray(b)){for(var e=0;e<b.length;e++)goog.events.unlisten(a,b[e],c,d,f);return null}if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a))return a.unlisten(b,goog.events.wrapListener_(c),d,f);d=!!d;a=goog.events.getListeners_(a,b,d);if(!a)return!1;for(e=0;e<a.length;e++)if(a[e].listener==c&&a[e].capture==d&&a[e].handler==f)return goog.events.unlistenByKey(a[e].key);return!1};
goog.events.unlistenByKey=function(a){var b=goog.events.listeners_[a];if(!b||b.removed)return!1;var c=b.src;if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(c))return c.unlistenByKey(b);var d=b.type,f=b.proxy,e=b.capture;c.removeEventListener?c!=goog.global&&c[goog.events.CUSTOM_EVENT_ATTR]||c.removeEventListener(d,f,e):c.detachEvent&&c.detachEvent(goog.events.getOnString_(d),f);c=goog.getUid(c);goog.events.sources_[c]&&(f=goog.events.sources_[c],goog.array.remove(f,
b),0==f.length&&delete goog.events.sources_[c]);b.removed=!0;if(b=goog.events.listenerTree_[d][e][c])b.needsCleanup_=!0,goog.events.cleanUp_(d,e,c,b);delete goog.events.listeners_[a];return!0};goog.events.unlistenWithWrapper=function(a,b,c,d,f){b.unlisten(a,c,d,f)};goog.events.cleanUp=function(a){delete goog.events.listeners_[a.key]};
goog.events.cleanUp_=function(a,b,c,d){if(!d.locked_&&d.needsCleanup_){for(var f=0,e=0;f<d.length;f++)d[f].removed?d[f].proxy.src=null:(f!=e&&(d[e]=d[f]),e++);d.length=e;d.needsCleanup_=!1;0==e&&(delete goog.events.listenerTree_[a][b][c],goog.events.listenerTree_[a][b].count_--,0==goog.events.listenerTree_[a][b].count_&&(delete goog.events.listenerTree_[a][b],goog.events.listenerTree_[a].count_--),0==goog.events.listenerTree_[a].count_&&delete goog.events.listenerTree_[a])}};
goog.events.removeAll=function(a,b){var c=0,d=null==b;if(null!=a){if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&a&&goog.events.Listenable.isImplementedBy(a))return a.removeAllListeners(b);var f=goog.getUid(a);if(goog.events.sources_[f])for(var f=goog.events.sources_[f],e=f.length-1;0<=e;e--){var g=f[e];if(d||b==g.type)goog.events.unlistenByKey(g.key),c++}}else goog.object.forEach(goog.events.listeners_,function(a,b){goog.events.unlistenByKey(b);c++});return c};
...
goog.events.getListeners_=function(a,b,c){var d=goog.events.listenerTree_;return b in d&&(d=d[b],c in d&&(d=d[c],a=goog.getUid(a),d[a]))?d[a]:null};goog.events.getListener=function(a,b,c,d,f){d=!!d;if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a))return a.getListener(b,goog.events.wrapListener_(c),d,f);if(a=goog.events.getListeners_(a,b,d))for(b=0;b<a.length;b++)if(!a[b].removed&&a[b].listener==c&&a[b].capture==d&&a[b].handler==f)return a[b];return null};
goog.events.hasListener=function(a,b,c){if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a))return a.hasListener(b,c);a=goog.getUid(a);var d=goog.events.sources_[a];if(d){var f=goog.isDef(b),e=goog.isDef(c);return f&&e?(d=goog.events.listenerTree_[b],!!d&&!!d[c]&&a in d[c]):f||e?goog.array.some(d,function(a){return f&&a.type==b||e&&a.capture==c}):!0}return!1};
...
goog.events.fireListeners=function(a,b,c,d){if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(a))return a.fireListeners(b,c,d);var f=goog.events.listenerTree_;return b in f&&(f=f[b],c in f)?goog.events.fireListeners_(f[c],a,b,c,d):!0};
goog.events.fireListeners_=function(a,b,c,d,f){var e=1;b=goog.getUid(b);if(a[b]){var g=--a.remaining_,h=a[b];h.locked_?h.locked_++:h.locked_=1;try{for(var k=h.length,l=0;l<k;l++){var m=h[l];m&&!m.removed&&(e&=!1!==goog.events.fireListener(m,f))}}finally{a.remaining_=Math.max(g,a.remaining_),h.locked_--,goog.events.cleanUp_(c,d,b,h)}}return Boolean(e)};goog.events.fireListener=function(a,b){a.callOnce&&goog.events.unlistenByKey(a.key);return a.handleEvent(b)};goog.events.getTotalListenerCount=function(){return goog.object.getCount(goog.events.listeners_)};
...
var c=b.type||b,d=goog.events.listenerTree_;if(!(c in d))return!0;if(goog.isString(b))b=new goog.events.Event(b,a);else if(b instanceof goog.events.Event)b.target=b.target||a;else{var f=b;b=new goog.events.Event(c,a);goog.object.extend(b,f)}var f=1,e,d=d[c],c=!0 in d,g;if(c){e=[];for(g=a;g;g=g.getParentEventTarget())e.push(g);g=d[!0];g.remaining_=g.count_;for(var h=e.length-1;!b.propagationStopped_&&0<=h&&g.remaining_;h--)b.currentTarget=e[h],f&=goog.events.fireListeners_(g,e[h],b.type,!0,b)&&0!=
b.returnValue_}if(!1 in d)if(g=d[!1],g.remaining_=g.count_,c)for(h=0;!b.propagationStopped_&&h<e.length&&g.remaining_;h++)b.currentTarget=e[h],f&=goog.events.fireListeners_(g,e[h],b.type,!1,b)&&0!=b.returnValue_;else for(d=a;!b.propagationStopped_&&d&&g.remaining_;d=d.getParentEventTarget())b.currentTarget=d,f&=goog.events.fireListeners_(g,d,b.type,!1,b)&&0!=b.returnValue_;return Boolean(f)};goog.events.protectBrowserEventEntryPoint=function(a){goog.events.handleBrowserEvent_=a.protectEntryPoint(goog.events.handleBrowserEvent_)};
goog.events.handleBrowserEvent_=function(a,b){if(a.removed)return!0;var c=a.type,d=goog.events.listenerTree_;if(!(c in d))return!0;var d=d[c],f,e;if(!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT){f=b||goog.getObjectByName("window.event");var g=!0 in d,h=!1 in d;if(g){if(goog.events.isMarkedIeEvent_(f))return!0;goog.events.markIeEvent_(f)}var k=new goog.events.BrowserEvent;k.init(f,this);f=!0;try{if(g){for(var l=[],m=k.currentTarget;m;m=m.parentNode)l.push(m);e=d[!0];e.remaining_=e.count_;for(var n=
l.length-1;!k.propagationStopped_&&0<=n&&e.remaining_;n--)k.currentTarget=l[n],f&=goog.events.fireListeners_(e,l[n],c,!0,k);if(h)for(e=d[!1],e.remaining_=e.count_,n=0;!k.propagationStopped_&&n<l.length&&e.remaining_;n++)k.currentTarget=l[n],f&=goog.events.fireListeners_(e,l[n],c,!1,k)}else f=goog.events.fireListener(a,k)}finally{l&&(l.length=0)}return f}c=new goog.events.BrowserEvent(b,this);return f=goog.events.fireListener(a,c)};
...
goog.events.Listenable.USE_LISTENABLE_INTERFACE&&(goog.events.EventTarget.prototype.listen=function(a,b,c,d){return this.listenInternal_(a,b,!1,c,d)},goog.events.EventTarget.prototype.listenOnce=function(a,b,c,d){return this.listenInternal_(a,b,!0,c,d)},goog.events.EventTarget.prototype.listenInternal_=function(a,b,c,d,f){this.assertInitialized();var e=this.eventTargetListeners_[a]||(this.eventTargetListeners_[a]=[]),g;g=goog.events.EventTarget.findListenerIndex_(e,b,d,f);if(-1<g)return g=e[g],c||
(g.callOnce=!1),g;g=new goog.events.Listener;g.init(b,null,this,a,!!d,f);g.callOnce=c;e.push(g);return g},goog.events.EventTarget.prototype.unlisten=function(a,b,c,d){if(!(a in this.eventTargetListeners_))return!1;a=this.eventTargetListeners_[a];b=goog.events.EventTarget.findListenerIndex_(a,b,c,d);return-1<b?(c=a[b],goog.events.cleanUp(c),c.removed=!0,goog.array.removeAt(a,b)):!1},goog.events.EventTarget.prototype.unlistenByKey=function(a){var b=a.type;if(!(b in this.eventTargetListeners_))return!1;
if(b=goog.array.remove(this.eventTargetListeners_[b],a))goog.events.cleanUp(a),a.removed=!0;return b},goog.events.EventTarget.prototype.removeAllListeners=function(a,b){var c=0,d;for(d in this.eventTargetListeners_)if(!a||d==a){for(var f=this.eventTargetListeners_[d],e=0;e<f.length;e++)++c,goog.events.cleanUp(f[e]),f[e].removed=!0;f.length=0}return c},goog.events.EventTarget.prototype.fireListeners=function(a,b,c){if(!(a in this.eventTargetListeners_))return!0;var d=!0;a=goog.array.clone(this.eventTargetListeners_[a]);
for(var f=0;f<a.length;++f){var e=a[f];e&&!e.removed&&e.capture==b&&(e.callOnce&&this.unlistenByKey(e),d=!1!==e.handleEvent(c)&&d)}return d&&0!=c.returnValue_},goog.events.EventTarget.prototype.getListeners=function(a,b){var c=this.eventTargetListeners_[a],d=[];if(c)for(var f=0;f<c.length;++f){var e=c[f];e.capture==b&&d.push(e)}return d},goog.events.EventTarget.prototype.getListener=function(a,b,c,d){a=this.eventTargetListeners_[a];var f=-1;a&&(f=goog.events.EventTarget.findListenerIndex_(a,b,c,d));
return-1<f?a[f]:null},goog.events.EventTarget.prototype.hasListener=function(a,b){var c=goog.isDef(a),d=goog.isDef(b);return goog.object.some(this.eventTargetListeners_,function(f,e){for(var g=0;g<f.length;++g)if(!(c&&f[g].type!=a||d&&f[g].capture!=b))return!0;return!1})},goog.events.EventTarget.prototype.setTargetForTesting=function(a){this.actualEventTarget_=a},goog.events.EventTarget.dispatchEventInternal_=function(a,b,c){var d=b.type||b;if(goog.isString(b))b=new goog.events.Event(b,a);else if(b instanceof
goog.events.Event)b.target=b.target||a;else{var f=b;b=new goog.events.Event(d,a);goog.object.extend(b,f)}var f=!0,e;if(c)for(var g=c.length-1;!b.propagationStopped_&&0<=g;g--)e=b.currentTarget=c[g],f=e.fireListeners(d,!0,b)&&f;b.propagationStopped_||(e=b.currentTarget=a,f=e.fireListeners(d,!0,b)&&f,b.propagationStopped_||(f=e.fireListeners(d,!1,b)&&f));if(c)for(g=0;!b.propagationStopped_&&g<c.length;g++)e=b.currentTarget=c[g],f=e.fireListeners(d,!1,b)&&f;return f},goog.events.EventTarget.findListenerIndex_=
function(a,b,c,d){for(var f=0;f<a.length;++f){var e=a[f];if(e.listener==b&&e.capture==!!c&&e.handler==d)return f}return-1});goog.Timer=function(a,b){goog.events.EventTarget.call(this);this.interval_=a||1;this.timerObject_=b||goog.Timer.defaultTimerObject;this.boundTick_=goog.bind(this.tick_,this);this.last_=goog.now()};goog.inherits(goog.Timer,goog.events.EventTarget);goog.Timer.MAX_TIMEOUT_=2147483647;goog.Timer.prototype.enabled=!1;goog.Timer.defaultTimerObject=goog.global;goog.Timer.intervalScale=.8;goog.Timer.prototype.timer_=null;goog.Timer.prototype.getInterval=function(){return this.interval_};
...
goog.Timer.TICK="tick";goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};goog.net.HttpStatus={CONTINUE:100,SWITCHING_PROTOCOLS:101,OK:200,CREATED:201,ACCEPTED:202,NON_AUTHORITATIVE_INFORMATION:203,NO_CONTENT:204,RESET_CONTENT:205,PARTIAL_CONTENT:206,MULTIPLE_CHOICES:300,MOVED_PERMANENTLY:301,FOUND:302,SEE_OTHER:303,NOT_MODIFIED:304,USE_PROXY:305,TEMPORARY_REDIRECT:307,BAD_REQUEST:400,UNAUTHORIZED:401,PAYMENT_REQUIRED:402,FORBIDDEN:403,NOT_FOUND:404,METHOD_NOT_ALLOWED:405,NOT_ACCEPTABLE:406,PROXY_AUTHENTICATION_REQUIRED:407,REQUEST_TIMEOUT:408,CONFLICT:409,GONE:410,LENGTH_REQUIRED:411,
...
this.timeoutId_=goog.Timer.defaultTimerObject.setTimeout(goog.bind(this.timeout_,this),this.timeoutInterval_)),this.logger_.fine(this.formatMsg_("Sending request")),this.inSend_=!0,this.xhr_.send(a),this.inSend_=!1}catch(e){this.logger_.fine(this.formatMsg_("Send error: "+e.message)),this.error_(goog.net.ErrorCode.EXCEPTION,e)}};goog.net.XhrIo.isContentTypeHeader_=function(a){return goog.string.caseInsensitiveEquals(goog.net.XhrIo.CONTENT_TYPE_HEADER,a)};
...
goog.dom.classes.swap=function(a,b,c){for(var d=goog.dom.classes.get(a),f=!1,e=0;e<d.length;e++)d[e]==b&&(goog.array.splice(d,e--,1),f=!0);f&&(d.push(c),goog.dom.classes.set(a,d.join(" ")));return f};goog.dom.classes.addRemove=function(a,b,c){var d=goog.dom.classes.get(a);goog.isString(b)?goog.array.remove(d,b):goog.isArray(b)&&(d=goog.dom.classes.getDifference_(d,b));goog.isString(c)&&!goog.array.contains(d,c)?d.push(c):goog.isArray(c)&&goog.dom.classes.add_(d,c);goog.dom.classes.set(a,d.join(" "))};
...
goog.math.sign=function(a){return 0==a?0:0>a?-1:1};goog.math.longestCommonSubsequence=function(a,b,c,d){c=c||function(a,b){return a==b};d=d||function(b,c){return a[b]};for(var f=a.length,e=b.length,g=[],h=0;h<f+1;h++)g[h]=[],g[h][0]=0;for(var k=0;k<e+1;k++)g[0][k]=0;for(h=1;h<=f;h++)for(k=1;k<=f;k++)c(a[h-1],b[k-1])?g[h][k]=g[h-1][k-1]+1:g[h][k]=Math.max(g[h-1][k],g[h][k-1]);for(var l=[],h=f,k=e;0<h&&0<k;)c(a[h-1],b[k-1])?(l.unshift(d(h-1,k-1)),h--,k--):g[h-1][k]>g[h][k-1]?h--:k--;return l};
...
goog.dom.append_(a,c,b,2);return c};goog.dom.append_=function(a,b,c,d){function f(c){c&&b.appendChild(goog.isString(c)?a.createTextNode(c):c)}for(;d<c.length;d++){var e=c[d];goog.isArrayLike(e)&&!goog.dom.isNodeLike(e)?goog.array.forEach(goog.dom.isNodeList(e)?goog.array.toArray(e):e,f):f(e)}};goog.dom.$dom=goog.dom.createDom;goog.dom.createElement=function(a){return document.createElement(a)};goog.dom.createTextNode=function(a){return document.createTextNode(String(a))};
goog.dom.createTable=function(a,b,c){return goog.dom.createTable_(document,a,b,!!c)};goog.dom.createTable_=function(a,b,c,d){for(var f=["<tr>"],e=0;e<c;e++)f.push(d?"<td>&nbsp;</td>":"<td></td>");f.push("</tr>");f=f.join("");c=["<table>"];for(e=0;e<b;e++)c.push(f);c.push("</table>");a=a.createElement(goog.dom.TagName.DIV);a.innerHTML=c.join("");return a.removeChild(a.firstChild)};goog.dom.htmlToDocumentFragment=function(a){return goog.dom.htmlToDocumentFragment_(document,a)};
...
goog.dom.compareNodeOrder=function(a,b){if(a==b)return 0;if(a.compareDocumentPosition)return a.compareDocumentPosition(b)&2?1:-1;if(goog.userAgent.IE&&!goog.userAgent.isDocumentMode(9)){if(a.nodeType==goog.dom.NodeType.DOCUMENT)return-1;if(b.nodeType==goog.dom.NodeType.DOCUMENT)return 1}if("sourceIndex"in a||a.parentNode&&"sourceIndex"in a.parentNode){var c=a.nodeType==goog.dom.NodeType.ELEMENT,d=b.nodeType==goog.dom.NodeType.ELEMENT;if(c&&d)return a.sourceIndex-b.sourceIndex;var f=a.parentNode,e=
b.parentNode;return f==e?goog.dom.compareSiblingOrder_(a,b):!c&&goog.dom.contains(f,b)?-1*goog.dom.compareParentsDescendantNodeIe_(a,b):!d&&goog.dom.contains(e,a)?goog.dom.compareParentsDescendantNodeIe_(b,a):(c?a.sourceIndex:f.sourceIndex)-(d?b.sourceIndex:e.sourceIndex)}d=goog.dom.getOwnerDocument(a);c=d.createRange();c.selectNode(a);c.collapse(!0);d=d.createRange();d.selectNode(b);d.collapse(!0);return c.compareBoundaryPoints(goog.global.Range.START_TO_END,d)};
goog.dom.compareParentsDescendantNodeIe_=function(a,b){var c=a.parentNode;if(c==b)return-1;for(var d=b;d.parentNode!=c;)d=d.parentNode;return goog.dom.compareSiblingOrder_(d,a)};goog.dom.compareSiblingOrder_=function(a,b){for(var c=b;c=c.previousSibling;)if(c==a)return-1;return 1};
goog.dom.findCommonAncestor=function(a){var b,c=arguments.length;if(!c)return null;if(1==c)return arguments[0];var d=[],f=Infinity;for(b=0;b<c;b++){for(var e=[],g=arguments[b];g;)e.unshift(g),g=g.parentNode;d.push(e);f=Math.min(f,e.length)}e=null;for(b=0;b<f;b++){for(var g=d[0][b],h=1;h<c;h++)if(g!=d[h][b])return e;e=g}return e};goog.dom.getOwnerDocument=function(a){return a.nodeType==goog.dom.NodeType.DOCUMENT?a:a.ownerDocument||a.document};
...
goog.dom.getNodeAtOffset=function(a,b,c){a=[a];for(var d=0,f=null;0<a.length&&d<b;)if(f=a.pop(),!(f.nodeName in goog.dom.TAGS_TO_IGNORE_))if(f.nodeType==goog.dom.NodeType.TEXT)var e=f.nodeValue.replace(/(\r\n|\r|\n)/g,"").replace(/ +/g," "),d=d+e.length;else if(f.nodeName in goog.dom.PREDEFINED_TAG_VALUES_)d+=goog.dom.PREDEFINED_TAG_VALUES_[f.nodeName].length;else for(e=f.childNodes.length-1;0<=e;e--)a.push(f.childNodes[e]);goog.isObject(c)&&(c.remainder=f?f.nodeValue.length+b-d-1:0,c.node=f);return f};
...
goog.dom.getAncestorByClass=function(a,b){return goog.dom.getAncestorByTagNameAndClass(a,null,b)};goog.dom.getAncestor=function(a,b,c,d){c||(a=a.parentNode);c=null==d;for(var f=0;a&&(c||f<=d);){if(b(a))return a;a=a.parentNode;f++}return null};goog.dom.getActiveElement=function(a){try{return a&&a.activeElement}catch(b){}return null};goog.dom.DomHelper=function(a){this.document_=a||goog.global.document||document};goog.dom.DomHelper.prototype.getDomHelper=goog.dom.getDomHelper;
...
goog.net.IframeIo.send=function(a,b,c,d,f){var e=new goog.net.IframeIo;goog.events.listen(e,goog.net.EventType.READY,e.dispose,!1,e);b&&goog.events.listen(e,goog.net.EventType.COMPLETE,b);e.send(a,c,d,f)};goog.net.IframeIo.getIframeByName=function(a){return window.frames[a]};goog.net.IframeIo.getInstanceByName=function(a){return goog.net.IframeIo.instances_[a]};
...
goog.events.listen(b.getElementById(a),goog.events.EventType.LOAD,this.onIframeLoaded_,!1,this);for(var d=this.form_.getElementsByTagName("textarea"),c=0,f=d.length;c<f;c++){var e=d[c].value;goog.dom.getRawTextContent(d[c])!=e&&(goog.dom.setTextContent(d[c],e),d[c].value=e)}d=b.importNode(this.form_,!0);d.target=a;d.action=this.form_.action;b.body.appendChild(d);for(var e=this.form_.getElementsByTagName("select"),g=d.getElementsByTagName("select"),c=0,f=e.length;c<f;c++)for(var h=e[c].getElementsByTagName("option"),
k=g[c].getElementsByTagName("option"),l=0,m=h.length;l<m;l++)k[l].selected=h[l].selected;e=this.form_.getElementsByTagName("input");g=d.getElementsByTagName("input");c=0;for(f=e.length;c<f;c++)if("file"==e[c].type&&e[c].value!=g[c].value){this.logger_.fine("File input value not cloned properly.  Will submit using original form.");this.form_.target=a;d=this.form_;break}this.logger_.fine("Submitting form");try{this.errorHandled_=!1,d.submit(),b.close(),goog.userAgent.GECKO&&(this.firefoxSilentErrorTimeout_=
...
goog.net.IframeIo.prototype.handleLoad_=function(a){this.logger_.fine("Iframe loaded");this.complete_=!0;this.active_=!1;var b;try{var c=a.body;this.lastContent_=c.textContent||c.innerText;this.lastContentHtml_=c.innerHTML}catch(f){b=goog.net.ErrorCode.ACCESS_DENIED}var d;!b&&"function"==typeof this.errorChecker_&&(d=this.errorChecker_(a))&&(b=goog.net.ErrorCode.CUSTOM_ERROR);this.logger_.finer("Last content: "+this.lastContent_);this.logger_.finer("Last uri: "+this.lastUri_);b?(this.logger_.fine("Load event occurred but failed"),
...
goog.net.xpc.IframePollingTransport.prototype.send=function(a,b){var c=a+":"+b;if(!goog.userAgent.IE||b.length<=this.MAX_FRAME_LENGTH_)this.sendQueue_.push("|"+c);else for(var d=b.length,f=Math.ceil(d/this.MAX_FRAME_LENGTH_),e=0,g=1;e<d;)this.sendQueue_.push(","+g+"/"+f+"|"+c.substr(e,this.MAX_FRAME_LENGTH_)),g++,e+=this.MAX_FRAME_LENGTH_;this.sendNextFrame_()};
...
goog.net.xpc.NixTransport.prototype.handleMessage_=function(a,b){this.getWindow().setTimeout(goog.bind(function(){this.channel_.xpcDeliver(a,b)},this),1)};goog.net.xpc.NixTransport.prototype.send=function(a,b){"unknown"!==typeof this.nixChannel_&&goog.net.xpc.logger.severe("NIX channel not connected");this.nixChannel_.SendMessage(a,b)};goog.net.xpc.NixTransport.prototype.disposeInternal=function(){goog.net.xpc.NixTransport.superClass_.disposeInternal.call(this);this.nixChannel_=null};goog.events.EventWrapper=function(){};goog.events.EventWrapper.prototype.listen=function(a,b,c,d,f){};goog.events.EventWrapper.prototype.unlisten=function(a,b,c,d,f){};goog.events.EventHandler=function(a){goog.Disposable.call(this);this.handler_=a;this.keys_=[]};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(a,b,c,d,f){goog.isArray(b)||(goog.events.EventHandler.typeArray_[0]=b,b=goog.events.EventHandler.typeArray_);for(var e=0;e<b.length;e++){var g=goog.events.listen(a,b[e],c||this,d||!1,f||this.handler_||this);this.keys_.push(g)}return this};
goog.events.EventHandler.prototype.listenOnce=function(a,b,c,d,f){if(goog.isArray(b))for(var e=0;e<b.length;e++)this.listenOnce(a,b[e],c,d,f);else a=goog.events.listenOnce(a,b,c||this,d,f||this.handler_||this),this.keys_.push(a);return this};goog.events.EventHandler.prototype.listenWithWrapper=function(a,b,c,d,f){b.listen(a,c,d,f||this.handler_||this,this);return this};goog.events.EventHandler.prototype.getListenerCount=function(){return this.keys_.length};
goog.events.EventHandler.prototype.unlisten=function(a,b,c,d,f){if(goog.isArray(b))for(var e=0;e<b.length;e++)this.unlisten(a,b[e],c,d,f);else if(a=goog.events.getListener(a,b,c||this,d,f||this.handler_||this))a=a.key,goog.events.unlistenByKey(a),goog.array.remove(this.keys_,a);return this};goog.events.EventHandler.prototype.unlistenWithWrapper=function(a,b,c,d,f){b.unlisten(a,c,d,f||this.handler_||this,this);return this};
...
goog.net.xpc.IframeRelayTransport.receiveMessage_=function(a,b){var c=b.indexOf(":"),d=b.substr(0,c),f=b.substr(c+1);if(goog.userAgent.IE&&-1!=(c=d.indexOf("|"))){var e=d.substr(0,c),d=d.substr(c+1),c=d.indexOf("+"),g=d.substr(0,c),c=parseInt(d.substr(c+1),10),h=goog.net.xpc.IframeRelayTransport.fragmentMap_[g];h||(h=goog.net.xpc.IframeRelayTransport.fragmentMap_[g]={fragments:[],received:0,expected:0});goog.string.contains(d,"++")&&(h.expected=c+1);h.fragments[c]=f;h.received++;if(h.received!=h.expected)return;
f=h.fragments.join("");delete goog.net.xpc.IframeRelayTransport.fragmentMap_[g]}else var e=d;goog.net.xpc.channels[a].xpcDeliver(e,decodeURIComponent(f))};goog.net.xpc.IframeRelayTransport.prototype.transportServiceHandler=function(a){a==goog.net.xpc.SETUP?(this.send(goog.net.xpc.TRANSPORT_SERVICE_,goog.net.xpc.SETUP_ACK_),this.channel_.notifyConnected()):a==goog.net.xpc.SETUP_ACK_&&this.channel_.notifyConnected()};
goog.net.xpc.IframeRelayTransport.prototype.send=function(a,b){var c=encodeURIComponent(b),d=c.length,f=goog.net.xpc.IframeRelayTransport.IE_PAYLOAD_MAX_SIZE_;if(goog.userAgent.IE&&d>f)for(var e=goog.string.getRandomString(),g=0,h=0;g<d;h++){var k=c.substr(g,f),g=g+f;this.send_(a,k,e+(g>=d?"++":"+")+h)}else this.send_(a,c)};
...
var f=d.style;f.visibility="hidden";f.width=d.style.height="0px";f.position="absolute";f=this.peerRelayUri_;f+="#"+this.channel_.name;this.peerIframeId_&&(f+=","+this.peerIframeId_);f+="|"+a;c&&(f+="|"+c);f+=":"+b;d.src=f;this.getWindow().document.body.appendChild(d);goog.net.xpc.logger.finest("msg sent: "+f)};goog.net.xpc.IframeRelayTransport.iframeLoadHandler_=function(){goog.net.xpc.logger.finest("iframe-load");goog.dom.removeNode(this);this.xpcOnload=null};
...
goog.async.Deferred.prototype.fire_=function(){this.unhandledExceptionTimeoutId_&&this.hasFired()&&this.hasErrback_()&&(goog.global.clearTimeout(this.unhandledExceptionTimeoutId_),delete this.unhandledExceptionTimeoutId_);this.parent_&&(this.parent_.branches_--,delete this.parent_);for(var a=this.result_,b=!1,c=!1;this.sequence_.length&&!this.blocked_;){var d=this.sequence_.shift(),f=d[0],e=d[1],d=d[2];if(f=this.hadError_?e:f)try{var g=f.call(d||this.defaultScope_,a);goog.isDef(g)&&(this.hadError_=
...
goog.net.xpc.NativeMessagingTransport.messageReceived_=function(a){var b=a.getBrowserEvent().data;if(!goog.isString(b))return!1;var c=b.indexOf("|"),d=b.indexOf(":");if(-1==c||-1==d)return!1;var f=b.substring(0,c),c=b.substring(c+1,d),b=b.substring(d+1);goog.net.xpc.logger.fine("messageReceived: channel="+f+", service="+c+", payload="+b);if(d=goog.net.xpc.channels[f])return d.xpcDeliver(c,b,a.getBrowserEvent().origin),!0;a=goog.net.xpc.NativeMessagingTransport.parseTransportPayload_(b)[0];for(var e in goog.net.xpc.channels)if(d=
goog.net.xpc.channels[e],d.getRole()==goog.net.xpc.CrossPageChannelRole.INNER&&!d.isConnected()&&c==goog.net.xpc.TRANSPORT_SERVICE_&&(a==goog.net.xpc.SETUP||a==goog.net.xpc.SETUP_NTPV2))return goog.net.xpc.logger.fine("changing channel name to "+f),d.name=f,delete goog.net.xpc.channels[e],goog.net.xpc.channels[f]=d,d.xpcDeliver(c,b),!0;goog.net.xpc.logger.info('channel name mismatch; message ignored"');return!1};
...
goog.net.xpc.NativeMessagingTransport.prototype.send=function(a,b){var c=this.channel_.getPeerWindowObject();c?(this.send=function(a,b){var e=this,g=this.channel_.name;this.sendTimerId_=goog.Timer.callOnce(function(){e.sendTimerId_=0;try{var h=c.postMessage?c:c.document;h.postMessage?(h.postMessage(g+"|"+a+":"+b,e.peerHostname_),goog.net.xpc.logger.fine("send(): service="+a+" payload="+b+" to hostname="+e.peerHostname_)):goog.net.xpc.logger.warning("Peer window had no postMessage function.")}catch(k){goog.net.xpc.logger.warning("Error performing postMessage, ignoring.",
...
goog.net.xpc.CrossPageChannel.prototype.createPeerIframe=function(a,b,c){goog.net.xpc.logger.info("createPeerIframe()");var d=this.cfg_[goog.net.xpc.CfgFields.IFRAME_ID];d||(d=this.cfg_[goog.net.xpc.CfgFields.IFRAME_ID]="xpcpeer"+goog.net.xpc.getRandomString(4));var f=goog.dom.getDomHelper(a).createElement("IFRAME");f.id=f.name=d;b?b(f):f.style.width=f.style.height="100%";this.cleanUpIncompleteConnection_();this.peerWindowDeferred_=new goog.async.Deferred(void 0,this);var e=this.getPeerUri(c);this.peerLoadHandler_.listenOnce(f,
"load",this.peerWindowDeferred_.callback,!1,this.peerWindowDeferred_);goog.userAgent.GECKO||goog.userAgent.WEBKIT?window.setTimeout(goog.bind(function(){a.appendChild(f);f.src=e.toString();goog.net.xpc.logger.info("peer iframe created ("+d+")")},this),1):(f.src=e.toString(),a.appendChild(f),goog.net.xpc.logger.info("peer iframe created ("+d+")"));return f};
...
goog.net.jsloader.load=function(a,b){var c=b||{},d=c.document||document,f=goog.dom.createElement(goog.dom.TagName.SCRIPT),e={script_:f,timeout_:void 0},g=new goog.async.Deferred(goog.net.jsloader.cancel_,e),h=null,k=goog.isDefAndNotNull(c.timeout)?c.timeout:goog.net.jsloader.DEFAULT_TIMEOUT;0<k&&(h=window.setTimeout(function(){goog.net.jsloader.cleanup_(f,!0);g.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.TIMEOUT,"Timeout reached for loading script "+a))},k),e.timeout_=h);f.onload=
f.onreadystatechange=function(){f.readyState&&"loaded"!=f.readyState&&"complete"!=f.readyState||(goog.net.jsloader.cleanup_(f,c.cleanupWhenDone||!1,h),g.callback(null))};f.onerror=function(){goog.net.jsloader.cleanup_(f,!0,h);g.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.LOAD_ERROR,"Error while loading script "+a))};goog.dom.setProperties(f,{type:"text/javascript",charset:"UTF-8",src:a});goog.net.jsloader.getScriptParentElement_(d).appendChild(f);return g};
goog.net.jsloader.loadAndVerify=function(a,b,c){goog.global[goog.net.jsloader.GLOBAL_VERIFY_OBJS_]||(goog.global[goog.net.jsloader.GLOBAL_VERIFY_OBJS_]={});var d=goog.global[goog.net.jsloader.GLOBAL_VERIFY_OBJS_];if(goog.isDef(d[b]))return goog.async.Deferred.fail(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.VERIFY_OBJECT_ALREADY_EXISTS,"Verification object "+b+" already defined."));c=goog.net.jsloader.load(a,c);var f=new goog.async.Deferred(goog.bind(c.cancel,c));c.addCallback(function(){var c=
d[b];goog.isDef(c)?(f.callback(c),delete d[b]):f.errback(new goog.net.jsloader.Error(goog.net.jsloader.ErrorCode.VERIFY_ERROR,"Script "+a+" loaded, but verification object "+b+" was not defined."))});c.addErrback(function(a){goog.isDef(d[b])&&delete d[b];f.errback(a)});return f};goog.net.jsloader.getScriptParentElement_=function(a){var b=a.getElementsByTagName(goog.dom.TagName.HEAD);return!b||goog.array.isEmpty(b)?a.documentElement:b[0]};
...
goog.net.Jsonp.prototype.send=function(a,b,c,d){a=a||null;d=d||"_"+(goog.net.Jsonp.scriptCounter_++).toString(36)+goog.now().toString(36);goog.global[goog.net.Jsonp.CALLBACKS]||(goog.global[goog.net.Jsonp.CALLBACKS]={});var f=this.uri_.clone();a&&goog.net.Jsonp.addPayloadToUri_(a,f);b&&(b=goog.net.Jsonp.newReplyHandler_(d,b),goog.global[goog.net.Jsonp.CALLBACKS][d]=b,f.setParameterValues(this.callbackParamName_,goog.net.Jsonp.CALLBACKS+"."+d));b=goog.net.jsloader.load(f.toString(),{timeout:this.timeout_,
...
fyre.sp.events.PROFILE_EDIT_SUBMIT="profile_edit_submit";fyre.sp.events.PROFILE_EDIT_SUBMIT_SUCCESS="profile_edit_submit_success";fyre.sp.events.PROFILE_EDIT_SUBMIT_FAILURE="profile_edit_submit_failure";fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT="privacy_profile_access";fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_SUCCESS="privacy_profile_access_success";fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_FAILURE="privacy_profile_access_failure";fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT="privacy_profile_delete";
fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_SUCCESS="privacy_profile_delete_success";fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_FAILURE="privacy_profile_delete_failure";fyre.sp.events.ENGAGE_AUTH_INIT="engage_auth_init";fyre.sp.events.ENGAGE_TOKEN_RECEIVED="engage_token_received";fyre.sp.events.ENGAGE_AUTH_COMPLETE="engage_auth_complete";fyre.sp.events.ENGAGE_AUTH_CLOSE="engage_auth_close";fyre.sp.events.ENGAGE_CLOSE="engage_close";fyre.sp.events.PW_RESET_INIT="pw_reset_init";
...
goog.math.Rect.intersection=function(a,b){var c=Math.max(a.left,b.left),d=Math.min(a.left+a.width,b.left+b.width);if(c<=d){var f=Math.max(a.top,b.top),e=Math.min(a.top+a.height,b.top+b.height);if(f<=e)return new goog.math.Rect(c,f,d-c,e-f)}return null};goog.math.Rect.intersects=function(a,b){return a.left<=b.left+b.width&&b.left<=a.left+a.width&&a.top<=b.top+b.height&&b.top<=a.top+a.height};goog.math.Rect.prototype.intersects=function(a){return goog.math.Rect.intersects(this,a)};
goog.math.Rect.difference=function(a,b){var c=goog.math.Rect.intersection(a,b);if(!c||!c.height||!c.width)return[a.clone()];var c=[],d=a.top,f=a.height,e=a.left+a.width,g=a.top+a.height,h=b.left+b.width,k=b.top+b.height;b.top>a.top&&(c.push(new goog.math.Rect(a.left,a.top,a.width,b.top-a.top)),d=b.top,f-=b.top-a.top);k<g&&(c.push(new goog.math.Rect(a.left,k,a.width,g-k)),f=k-d);b.left>a.left&&c.push(new goog.math.Rect(a.left,d,b.left-a.left,f));h<e&&c.push(new goog.math.Rect(h,d,e-h,f));return c};
...
goog.style.getComputedTextAlign=function(a){return goog.style.getStyle_(a,"textAlign")};goog.style.getComputedCursor=function(a){return goog.style.getStyle_(a,"cursor")};goog.style.setPosition=function(a,b,c){var d,f=goog.userAgent.GECKO&&(goog.userAgent.MAC||goog.userAgent.X11)&&goog.userAgent.isVersion("1.9");b instanceof goog.math.Coordinate?(d=b.x,b=b.y):(d=b,b=c);a.style.left=goog.style.getPixelStyleValue_(d,f);a.style.top=goog.style.getPixelStyleValue_(b,f)};
...
goog.style.getVisibleRectForElement=function(a){for(var b=new goog.math.Box(0,Infinity,Infinity,0),c=goog.dom.getDomHelper(a),d=c.getDocument().body,f=c.getDocument().documentElement,e=c.getDocumentScrollElement();a=goog.style.getOffsetParent(a);)if(!(goog.userAgent.IE&&0==a.clientWidth||goog.userAgent.WEBKIT&&0==a.clientHeight&&a==d)&&a!=d&&a!=f&&"visible"!=goog.style.getStyle_(a,"overflow")){var g=goog.style.getPageOffset(a),h=goog.style.getClientLeftTop(a);g.x+=h.x;g.y+=h.y;b.top=Math.max(b.top,
g.y);b.right=Math.min(b.right,g.x+a.clientWidth);b.bottom=Math.min(b.bottom,g.y+a.clientHeight);b.left=Math.max(b.left,g.x)}d=e.scrollLeft;e=e.scrollTop;b.left=Math.max(b.left,d);b.top=Math.max(b.top,e);c=c.getViewportSize();b.right=Math.min(b.right,d+c.width);b.bottom=Math.min(b.bottom,e+c.height);return 0<=b.top&&0<=b.left&&b.bottom>b.top&&b.right>b.left?b:null};
goog.style.getContainerOffsetToScrollInto=function(a,b,c){var d=goog.style.getPageOffset(a),f=goog.style.getPageOffset(b),e=goog.style.getBorderBox(b),g=d.x-f.x-e.left,d=d.y-f.y-e.top,f=b.clientWidth-a.offsetWidth;a=b.clientHeight-a.offsetHeight;e=b.scrollLeft;b=b.scrollTop;c?(e+=g-f/2,b+=d-a/2):(e+=Math.min(g,Math.max(g-f,0)),b+=Math.min(d,Math.max(d-a,0)));return new goog.math.Coordinate(e,b)};
...
goog.style.getPageOffset=function(a){var b,c=goog.dom.getOwnerDocument(a),d=goog.style.getStyle_(a,"position");goog.asserts.assertObject(a,"Parameter is required");var f=goog.userAgent.GECKO&&c.getBoxObjectFor&&!a.getBoundingClientRect&&"absolute"==d&&(b=c.getBoxObjectFor(a))&&(0>b.screenX||0>b.screenY),e=new goog.math.Coordinate(0,0),g=goog.style.getClientViewportElement(c);if(a==g)return e;if(a.getBoundingClientRect)b=goog.style.getBoundingClientRect_(a),a=goog.dom.getDomHelper(c).getDocumentScroll(),
e.x=b.left+a.x,e.y=b.top+a.y;else if(c.getBoxObjectFor&&!f)b=c.getBoxObjectFor(a),a=c.getBoxObjectFor(g),e.x=b.screenX-a.screenX,e.y=b.screenY-a.screenY;else{b=a;do{e.x+=b.offsetLeft;e.y+=b.offsetTop;b!=a&&(e.x+=b.clientLeft||0,e.y+=b.clientTop||0);if(goog.userAgent.WEBKIT&&"fixed"==goog.style.getComputedPosition(b)){e.x+=c.body.scrollLeft;e.y+=c.body.scrollTop;break}b=b.offsetParent}while(b&&b!=a);if(goog.userAgent.OPERA||goog.userAgent.WEBKIT&&"absolute"==d)e.y-=c.body.offsetTop;for(b=a;(b=goog.style.getOffsetParent(b))&&
b!=c.body&&b!=g;)e.x-=b.scrollLeft,goog.userAgent.OPERA&&"TR"==b.tagName||(e.y-=b.scrollTop)}return e};goog.style.getPageOffsetLeft=function(a){return goog.style.getPageOffset(a).x};goog.style.getPageOffsetTop=function(a){return goog.style.getPageOffset(a).y};
goog.style.getFramedPageOffset=function(a,b){var c=new goog.math.Coordinate(0,0),d=goog.dom.getWindow(goog.dom.getOwnerDocument(a)),f=a;do{var e=d==b?goog.style.getPageOffset(f):goog.style.getClientPosition(f);c.x+=e.x;c.y+=e.y}while(d&&d!=b&&(f=d.frameElement)&&(d=d.parent));return c};
...
goog.style.setBorderBoxSize=function(a,b){var c=goog.dom.getOwnerDocument(a),d=goog.dom.getDomHelper(c).isCss1CompatMode();if(!goog.userAgent.IE||d&&goog.userAgent.isVersion("8"))goog.style.setBoxSizingSize_(a,b,"border-box");else if(c=a.style,d){var d=goog.style.getPaddingBox(a),f=goog.style.getBorderBox(a);c.pixelWidth=b.width-f.left-d.left-d.right-f.right;c.pixelHeight=b.height-f.top-d.top-d.bottom-f.bottom}else c.pixelWidth=b.width,c.pixelHeight=b.height};
goog.style.getContentBoxSize=function(a){var b=goog.dom.getOwnerDocument(a),c=goog.userAgent.IE&&a.currentStyle;if(c&&goog.dom.getDomHelper(b).isCss1CompatMode()&&"auto"!=c.width&&"auto"!=c.height&&!c.boxSizing)return b=goog.style.getIePixelValue_(a,c.width,"width","pixelWidth"),a=goog.style.getIePixelValue_(a,c.height,"height","pixelHeight"),new goog.math.Size(b,a);c=goog.style.getBorderBoxSize(a);b=goog.style.getPaddingBox(a);a=goog.style.getBorderBox(a);return new goog.math.Size(c.width-a.left-
b.left-b.right-a.right,c.height-a.top-b.top-b.bottom-a.bottom)};
goog.style.setContentBoxSize=function(a,b){var c=goog.dom.getOwnerDocument(a),d=goog.dom.getDomHelper(c).isCss1CompatMode();if(!goog.userAgent.IE||d&&goog.userAgent.isVersion("8"))goog.style.setBoxSizingSize_(a,b,"content-box");else if(c=a.style,d)c.pixelWidth=b.width,c.pixelHeight=b.height;else{var d=goog.style.getPaddingBox(a),f=goog.style.getBorderBox(a);c.pixelWidth=b.width+f.left+d.left+d.right+f.right;c.pixelHeight=b.height+f.top+d.top+d.bottom+f.bottom}};
...
goog.style.getBox_=function(a,b){if(goog.userAgent.IE){var c=goog.style.getIePixelDistance_(a,b+"Left"),d=goog.style.getIePixelDistance_(a,b+"Right"),f=goog.style.getIePixelDistance_(a,b+"Top"),e=goog.style.getIePixelDistance_(a,b+"Bottom");return new goog.math.Box(f,d,e,c)}c=goog.style.getComputedStyle(a,b+"Left");d=goog.style.getComputedStyle(a,b+"Right");f=goog.style.getComputedStyle(a,b+"Top");e=goog.style.getComputedStyle(a,b+"Bottom");return new goog.math.Box(parseFloat(f),parseFloat(d),parseFloat(e),
...
(function(a,b){a.Handlebars=b()})(fyre.lib,function(){return function(a){function b(d){if(c[d])return c[d].exports;var f=c[d]={exports:{},id:d,loaded:!1};a[d].call(f.exports,f,f.exports,b);f.loaded=!0;return f.exports}var c={};b.m=a;b.c=c;b.p="";return b(0)}([function(a,b,c){function d(){var a=new h.HandlebarsEnvironment;m.extend(a,h);a.SafeString=k["default"];a.Exception=l["default"];a.Utils=m;a.escapeExpression=m.escapeExpression;a.VM=n;a.template=function(b){return n.template(b,a)};return a}var f=
c(1)["default"],e=c(2)["default"];b.__esModule=!0;var g=c(3),h=f(g),g=c(17),k=e(g),g=c(5),l=e(g),g=c(4),m=f(g),g=c(18),n=f(g);c=c(19);e=e(c);c=d();c.create=d;e["default"](c);c["default"]=c;b["default"]=c;a.exports=b["default"]},function(a,b){b["default"]=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var f in a)Object.prototype.hasOwnProperty.call(a,f)&&(b[f]=a[f]);b["default"]=a;return b};b.__esModule=!0},function(a,b){b["default"]=function(a){return a&&a.__esModule?a:{"default":a}};
b.__esModule=!0},function(a,b,c){function d(a,b,c){this.helpers=a||{};this.partials=b||{};this.decorators=c||{};h.registerDefaultHelpers(this);k.registerDefaultDecorators(this)}a=c(2)["default"];b.__esModule=!0;b.HandlebarsEnvironment=d;var f=c(4),e=c(5),g=a(e),h=c(6),k=c(14);c=c(16);c=a(c);b.VERSION="4.0.5";b.COMPILER_REVISION=7;b.REVISION_CHANGES={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:"== 1.x.x",5:"== 2.0.0-alpha.x",6:">= 2.0.0-beta.1",7:">= 4.0.0"};d.prototype={constructor:d,logger:c["default"],
log:c["default"].log,registerHelper:function(a,b){if("[object Object]"===f.toString.call(a)){if(b)throw new g["default"]("Arg not supported with multiple helpers");f.extend(this.helpers,a)}else this.helpers[a]=b},unregisterHelper:function(a){delete this.helpers[a]},registerPartial:function(a,b){if("[object Object]"===f.toString.call(a))f.extend(this.partials,a);else{if("undefined"===typeof b)throw new g["default"]('Attempting to register a partial called "'+a+'" as undefined');this.partials[a]=b}},
unregisterPartial:function(a){delete this.partials[a]},registerDecorator:function(a,b){if("[object Object]"===f.toString.call(a)){if(b)throw new g["default"]("Arg not supported with multiple decorators");f.extend(this.decorators,a)}else this.decorators[a]=b},unregisterDecorator:function(a){delete this.decorators[a]}};b.log=c["default"].log;b.createFrame=f.createFrame;b.logger=c["default"]},function(a,b){function c(a){return f[a]}function d(a){for(var b=1;b<arguments.length;b++)for(var c in arguments[b])Object.prototype.hasOwnProperty.call(arguments[b],
c)&&(a[c]=arguments[b][c]);return a}b.__esModule=!0;b.extend=d;b.indexOf=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1};b.escapeExpression=function(a){if("string"!==typeof a){if(a&&a.toHTML)return a.toHTML();if(null==a)return"";if(!a)return a+"";a=""+a}return g.test(a)?a.replace(e,c):a};b.isEmpty=function(a){return a||0===a?l(a)&&0===a.length?!0:!1:!0};b.createFrame=function(a){var b=d({},a);b._parent=a;return b};b.blockParams=function(a,b){a.path=b;return a};b.appendContextPath=
function(a,b){return(a?a+".":"")+b};var f={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},e=/[&<>"'`=]/g,g=/[&<>"'`=]/,h=Object.prototype.toString;b.toString=h;var k=function(a){return"function"===typeof a};k(/x/)&&(b.isFunction=k=function(a){return"function"===typeof a&&"[object Function]"===h.call(a)});b.isFunction=k;var l=Array.isArray||function(a){return a&&"object"===typeof a?"[object Array]"===h.call(a):!1};b.isArray=l},function(a,b){function c(a,b){var g=
...
f["default"](a);e["default"](a);g["default"](a);h["default"](a);k["default"](a);l["default"](a)};b=c(7);var d=a(b);b=c(8);var f=a(b);b=c(9);var e=a(b);b=c(10);var g=a(b);b=c(11);var h=a(b);b=c(12);var k=a(b);c=c(13);var l=a(c)},function(a,b,c){b.__esModule=!0;var d=c(4);b["default"]=function(a){a.registerHelper("blockHelperMissing",function(b,c){var h=c.inverse,k=c.fn;if(!0===b)return k(this);if(!1===b||null==b)return h(this);if(d.isArray(b))return 0<b.length?(c.ids&&(c.ids=[c.name]),a.helpers.each(b,
c)):h(this);c.data&&c.ids&&(h=d.createFrame(c.data),h.contextPath=d.appendContextPath(c.data.contextPath,c.name),c={data:h});return k(b,c)})};a.exports=b["default"]},function(a,b,c){var d=c(2)["default"];b.__esModule=!0;var f=c(4);c=c(5);var e=d(c);b["default"]=function(a){a.registerHelper("each",function(a,b){function c(b,e,g){r&&(r.key=b,r.index=e,r.first=0===e,r.last=!!g,u&&(r.contextPath=u+b));q+=d(a[b],{data:r,blockParams:f.blockParams([a[b],b],[u+b,null])})}if(!b)throw new e["default"]("Must pass iterator to #each");
var d=b.fn,g=b.inverse,p=0,q="",r=void 0,u=void 0;b.data&&b.ids&&(u=f.appendContextPath(b.data.contextPath,b.ids[0])+".");f.isFunction(a)&&(a=a.call(this));b.data&&(r=f.createFrame(b.data));if(a&&"object"===typeof a)if(f.isArray(a))for(var t=a.length;p<t;p++)p in a&&c(p,p,p===a.length-1);else{var t=void 0,v;for(v in a)a.hasOwnProperty(v)&&(void 0!==t&&c(t,p-1),t=v,p++);void 0!==t&&c(t,p-1,!0)}0===p&&(q=g(this));return q})};a.exports=b["default"]},function(a,b,c){var d=c(2)["default"];b.__esModule=
!0;c=c(5);var f=d(c);b["default"]=function(a){a.registerHelper("helperMissing",function(){if(1!==arguments.length)throw new f["default"]('Missing helper: "'+arguments[arguments.length-1].name+'"');})};a.exports=b["default"]},function(a,b,c){b.__esModule=!0;var d=c(4);b["default"]=function(a){a.registerHelper("if",function(a,b){d.isFunction(a)&&(a=a.call(this));return!b.hash.includeZero&&!a||d.isEmpty(a)?b.inverse(this):b.fn(this)});a.registerHelper("unless",function(b,c){return a.helpers["if"].call(this,
b,{fn:c.inverse,inverse:c.fn,hash:c.hash})})};a.exports=b["default"]},function(a,b){b.__esModule=!0;b["default"]=function(a){a.registerHelper("log",function(){for(var b=[void 0],f=arguments[arguments.length-1],e=0;e<arguments.length-1;e++)b.push(arguments[e]);e=1;null!=f.hash.level?e=f.hash.level:f.data&&null!=f.data.level&&(e=f.data.level);b[0]=e;a.log.apply(a,b)})};a.exports=b["default"]},function(a,b){b.__esModule=!0;b["default"]=function(a){a.registerHelper("lookup",function(a,b){return a&&a[b]})};
a.exports=b["default"]},function(a,b,c){b.__esModule=!0;var d=c(4);b["default"]=function(a){a.registerHelper("with",function(a,b){d.isFunction(a)&&(a=a.call(this));var c=b.fn;if(d.isEmpty(a))return b.inverse(this);var f=b.data;b.data&&b.ids&&(f=d.createFrame(b.data),f.contextPath=d.appendContextPath(b.data.contextPath,b.ids[0]));return c(a,{data:f,blockParams:d.blockParams([a],[f&&f.contextPath])})})};a.exports=b["default"]},function(a,b,c){a=c(2)["default"];b.__esModule=!0;b.registerDefaultDecorators=
function(a){d["default"](a)};b=c(15);var d=a(b)},function(a,b,c){b.__esModule=!0;var d=c(4);b["default"]=function(a){a.registerDecorator("inline",function(a,b,c,f){var l=a;b.partials||(b.partials={},l=function(f,k){var l=c.partials;c.partials=d.extend({},l,b.partials);var q=a(f,k);c.partials=l;return q});b.partials[f.args[0]]=f.fn;return l})};a.exports=b["default"]},function(a,b,c){b.__esModule=!0;var d=c(4),f={methodMap:["debug","info","warn","error"],level:"info",lookupLevel:function(a){if("string"===
typeof a){var b=d.indexOf(f.methodMap,a.toLowerCase());a=0<=b?b:parseInt(a,10)}return a},log:function(a){a=f.lookupLevel(a);if("undefined"!==typeof console&&f.lookupLevel(f.level)<=a){var b=f.methodMap[a];console[b]||(b="log");for(var c=arguments.length,d=Array(1<c?c-1:0),l=1;l<c;l++)d[l-1]=arguments[l];console[b].apply(console,d)}}};b["default"]=f;a.exports=b["default"]},function(a,b){function c(a){this.string=a}b.__esModule=!0;c.prototype.toString=c.prototype.toHTML=function(){return""+this.string};
b["default"]=c;a.exports=b["default"]},function(a,b,c){function d(a,b,c,d,e,f,h){function k(b){var e=1>=arguments.length||void 0===arguments[1]?{}:arguments[1],g=h;h&&b!==h[0]&&(g=[b].concat(h));return c(a,b,a.helpers,a.partials,e.data||d,f&&[e.blockParams].concat(f),g)}k=g(c,k,a,h,d,f);k.program=b;k.depth=h?h.length:0;k.blockParams=e||0;return k}function f(){return""}function e(a,b){b&&"root"in b||(b=b?m.createFrame(b):{},b.root=a);return b}function g(a,b,c,d,e,f){if(a.decorator){var g={};b=a.decorator(b,
...
a[1]+").");}};b.template=function(a,b){function c(b){function d(b){return""+a.main(f,b,f.helpers,f.partials,k,m,l)}var h=1>=arguments.length||void 0===arguments[1]?{}:arguments[1],k=h.data;c._setup(h);!h.partial&&a.useData&&(k=e(b,k));var l=void 0,m=a.useBlockParams?[]:void 0;a.useDepths&&(l=h.depths?b!==h.depths[0]?[b].concat(h.depths):h.depths:[b]);d=g(a.main,d,f,h.depths||[],k,m);return d(b,h)}if(!b)throw new l["default"]("No environment passed to template");if(!a||!a.main)throw new l["default"]("Unknown template object: "+
typeof a);a.main.decorator=a.main_d;b.VM.checkRevision(a.compiler);var f={strict:function(a,b){if(!(b in a))throw new l["default"]('"'+b+'" not defined in '+a);return a[b]},lookup:function(a,b){for(var c=a.length,d=0;d<c;d++)if(a[d]&&null!=a[d][b])return a[d][b]},lambda:function(a,b){return"function"===typeof a?a.call(b):a},escapeExpression:k.escapeExpression,invokePartial:function(c,d,e){e.hash&&(d=k.extend({},d,e.hash),e.ids&&(e.ids[0]=!0));c=b.VM.resolvePartial.call(this,c,d,e);var f=b.VM.invokePartial.call(this,
...
c,e,f):g||(g=this.programs[a]=d(this,a,h));return g},data:function(a,b){for(;a&&b--;)a=a._parent;return a},merge:function(a,b){var c=a||b;a&&b&&a!==b&&(c=k.extend({},b,a));return c},noop:b.VM.noop,compilerInfo:a.compiler};c.isTop=!0;c._setup=function(c){if(c.partial)f.helpers=c.helpers,f.partials=c.partials,f.decorators=c.decorators;else if(f.helpers=f.merge(c.helpers,b.helpers),a.usePartial&&(f.partials=f.merge(c.partials,b.partials)),a.usePartial||a.useDecorators)f.decorators=f.merge(c.decorators,
b.decorators)};c._child=function(b,c,e,g){if(a.useBlockParams&&!e)throw new l["default"]("must pass block params");if(a.useDepths&&!g)throw new l["default"]("must pass parent depths");return d(f,b,a[b],c,0,e,g)};return c};b.wrapProgram=d;b.resolvePartial=function(a,b,c){a?a.call||c.name||(c.name=a,a=c.partials[a]):a="@partial-block"===c.name?c.data["partial-block"]:c.partials[c.name];return a};b.invokePartial=function(a,b,c){c.partial=!0;c.ids&&(c.data.contextPath=c.ids[0]||c.data.contextPath);var d=
void 0;c.fn&&c.fn!==f&&(c.data=m.createFrame(c.data),d=c.data["partial-block"]=c.fn,d.partials&&(c.partials=k.extend({},c.partials,d.partials)));void 0===a&&d&&(a=d);if(void 0===a)throw new l["default"]("The partial "+c.name+" could not be found");if(a instanceof Function)return a(b,c)};b.noop=f;b=c(4);var k=h(b);b=c(5);var l=a(b),m=c(3)},function(a,b){(function(c){b.__esModule=!0;b["default"]=function(a){var b="undefined"!==typeof c?c:window,e=b.Handlebars;a.noConflict=function(){b.Handlebars===
a&&(b.Handlebars=e);return a}};a.exports=b["default"]}).call(b,function(){return this}())}])});goog.exportSymbol("fyre.lib.Handlebars",fyre.lib.Handlebars);fyre.sp.templates={};
fyre.sp.templates.popover="function"==typeof fyre.sp.templates.popover?fyre.sp.templates.popover:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing;return'<div class="fyre-cp-popover light '+a.escapeExpression((g=null!=(g=c.pos||(null!=b?b.pos:b))?g:h,"function"===typeof g?g.call(d,{name:"pos",hash:{},data:f}):g))+'">\n  <div class="lf-arrow"></div>\n  <div class="fyre-cp-popover-content">'+(null!=(e=(g=null!=(g=c.content||(null!=
b?b.content:b))?g:h,"function"===typeof g?g.call(d,{name:"content",hash:{},data:f}):g))?e:"")+"</div>\n</div>\n"},useData:!0});goog.exportSymbol("fyre.sp.templates.popover",fyre.sp.templates.popover);goog.format={};goog.format.EmailAddress=function(a,b){this.name_=b||"";this.address_=a||""};goog.format.EmailAddress.OPENERS_='"<([';goog.format.EmailAddress.CLOSERS_='">)]';goog.format.EmailAddress.SPECIAL_CHARS_RE_=/[()<>@,;:\\\".\[\]]/;goog.format.EmailAddress.ALL_DOUBLE_QUOTES_=/\"/g;goog.format.EmailAddress.ESCAPED_DOUBLE_QUOTES_=/\\\"/g;goog.format.EmailAddress.ALL_BACKSLASHES_=/\\/g;goog.format.EmailAddress.ESCAPED_BACKSLASHES_=/\\\\/g;goog.format.EmailAddress.prototype.getName=function(){return this.name_};
...
goog.format.EmailAddress.parse=function(a){for(var b="",c="",d=0;d<a.length;){var f=goog.format.EmailAddress.getToken_(a,d);"<"==f.charAt(0)&&-1!=f.indexOf(">")?(c=f.indexOf(">"),c=f.substring(1,c)):""==c&&(b+=f);d+=f.length}""==c&&-1!=b.indexOf("@")&&(c=b,b="");b=goog.string.collapseWhitespace(b);b=goog.string.stripQuotes(b,"'");b=goog.string.stripQuotes(b,'"');b=b.replace(goog.format.EmailAddress.ESCAPED_DOUBLE_QUOTES_,'"');b=b.replace(goog.format.EmailAddress.ESCAPED_BACKSLASHES_,"\\");c=goog.string.collapseWhitespace(c);
return new goog.format.EmailAddress(c,b)};goog.format.EmailAddress.parseList=function(a){for(var b=[],c="",d,f=0;f<a.length;)d=goog.format.EmailAddress.getToken_(a,f),","==d||";"==d||" "==d&&goog.format.EmailAddress.parse(c).isValid()?(goog.string.isEmpty(c)||b.push(goog.format.EmailAddress.parse(c)),c="",f++):(c+=d,f+=d.length);goog.string.isEmpty(c)||b.push(goog.format.EmailAddress.parse(c));return b};
goog.format.EmailAddress.getToken_=function(a,b){var c=a.charAt(b),d=goog.format.EmailAddress.OPENERS_.indexOf(c);if(-1==d||goog.format.EmailAddress.isEscapedDlQuote_(a,b))return c;for(var d=goog.format.EmailAddress.CLOSERS_.charAt(d),f=a.indexOf(d,b+1);0<=f&&goog.format.EmailAddress.isEscapedDlQuote_(a,f);)f=a.indexOf(d,f+1);return 0<=f?a.substring(b,f+1):c};
...
goog.functions.withReturnValue=function(a,b){return goog.functions.sequence(a,goog.functions.constant(b))};goog.functions.compose=function(a,b){var c=arguments,d=c.length;return function(){var a;d&&(a=c[d-1].apply(this,arguments));for(var b=d-2;0<=b;b--)a=c[b].call(this,a);return a}};goog.functions.sequence=function(a){var b=arguments,c=b.length;return function(){for(var a,f=0;f<c;f++)a=b[f].apply(this,arguments);return a}};
...
passwordErrorTooShort:"Minimum of 6 characters for password",passwordErrorTooLong:"Maximum of 32 characters for password",passwordErrorMissingUppercase:"Password should contain at least one uppercase character",passwordErrorMissingLowercase:"Password should contain at least one lowercase character",passwordErrorMissingSymbol:"Password should contain at least one symbol in the set !@#$%^&*()?.,<>';:\"[]{}|"}};fyre.sp.templates.passwordError="function"==typeof fyre.sp.templates.passwordError?fyre.sp.templates.passwordError:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){return"lf-error"},3:function(a,b,c,d,f){var e,g,h=null!=b?b:{},k=c.helperMissing,l='    <p class="';d=(e=null!=(e=c.username||(null!=b?b.username:b))?e:k,g={name:"username",hash:{},fn:a.noop,inverse:a.program(1,f,0),data:f},"function"===typeof e?e.call(h,g):e);c.username||(d=c.blockHelperMissing.call(b,d,g));null!=d&&(l+=d);return l+
'">'+a.escapeExpression((e=null!=(e=c.usernameMsg||(null!=b?b.usernameMsg:b))?e:k,"function"===typeof e?e.call(h,{name:"usernameMsg",hash:{},data:f}):e))+"</p>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g,h=null!=b?b:{},k=c.helperMissing,l=a.escapeExpression,m=c.blockHelperMissing,n='<div class="lf-password-popover">\n  <h5>'+l((e=null!=(e=c.title||(null!=b?b.title:b))?e:k,"function"===typeof e?e.call(h,{name:"title",hash:{},data:f}):e))+'</h5>\n  <p class="';d=(e=null!=(e=c.len||
(null!=b?b.len:b))?e:k,g={name:"len",hash:{},fn:a.noop,inverse:a.program(1,f,0),data:f},"function"===typeof e?e.call(h,g):e);c.len||(d=m.call(b,d,g));null!=d&&(n+=d);n+='">'+l((e=null!=(e=c.lengthMsg||(null!=b?b.lengthMsg:b))?e:k,"function"===typeof e?e.call(h,{name:"lengthMsg",hash:{},data:f}):e))+'</p>\n  <p class="';d=(e=null!=(e=c.chars||(null!=b?b.chars:b))?e:k,g={name:"chars",hash:{},fn:a.noop,inverse:a.program(1,f,0),data:f},"function"===typeof e?e.call(h,g):e);c.chars||(d=m.call(b,d,g));null!=
d&&(n+=d);n+='">'+l((e=null!=(e=c.charsMsg||(null!=b?b.charsMsg:b))?e:k,"function"===typeof e?e.call(h,{name:"charsMsg",hash:{},data:f}):e))+'</p>\n  <p class="';d=(e=null!=(e=c.sym||(null!=b?b.sym:b))?e:k,g={name:"sym",hash:{},fn:a.noop,inverse:a.program(1,f,0),data:f},"function"===typeof e?e.call(h,g):e);c.sym||(d=m.call(b,d,g));null!=d&&(n+=d);n+='">'+l((e=null!=(e=c.symMsg||(null!=b?b.symMsg:b))?e:k,"function"===typeof e?e.call(h,{name:"symMsg",hash:{},data:f}):e))+"</p>\n";d=(e=null!=(e=c.checkUsername||
(null!=b?b.checkUsername:b))?e:k,g={name:"checkUsername",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f},"function"===typeof e?e.call(h,g):e);c.checkUsername||(d=m.call(b,d,g));null!=d&&(n+=d);return n+"</div>\n"},useData:!0});goog.exportSymbol("fyre.sp.templates.passwordError",fyre.sp.templates.passwordError);goog.dom.forms={};goog.dom.forms.getFormDataMap=function(a){var b=new goog.structs.Map;goog.dom.forms.getFormDataHelper_(a,b,goog.dom.forms.addFormDataToMap_);return b};goog.dom.forms.getFormDataString=function(a){var b=[];goog.dom.forms.getFormDataHelper_(a,b,goog.dom.forms.addFormDataToStringBuffer_);return b.join("&")};
goog.dom.forms.getFormDataHelper_=function(a,b,c){for(var d=a.elements,f,e=0;f=d[e];e++)if(f.form==a&&!f.disabled&&"fieldset"!=f.tagName.toLowerCase()){var g=f.name;switch(f.type.toLowerCase()){case "file":case "submit":case "reset":case "button":break;case "select-multiple":f=goog.dom.forms.getValue(f);if(null!=f)for(var h,k=0;h=f[k];k++)c(b,g,h);break;default:h=goog.dom.forms.getValue(f),null!=h&&c(b,g,h)}}d=a.getElementsByTagName("input");for(e=0;f=d[e];e++)f.form==a&&"image"==f.type.toLowerCase()&&
(g=f.name,c(b,g,f.value),c(b,g+".x","0"),c(b,g+".y","0"))};goog.dom.forms.addFormDataToMap_=function(a,b,c){var d=a.get(b);d||(d=[],a.set(b,d));d.push(c)};goog.dom.forms.addFormDataToStringBuffer_=function(a,b,c){a.push(encodeURIComponent(b)+"="+encodeURIComponent(c))};goog.dom.forms.hasFileInput=function(a){a=a.elements;for(var b,c=0;b=a[c];c++)if(!b.disabled&&b.type&&"file"==b.type.toLowerCase())return!0;return!1};
...
goog.dom.forms.getValueByName=function(a,b){var c=a.elements[b];if(c.type)return goog.dom.forms.getValue(c);for(var d=0;d<c.length;d++){var f=goog.dom.forms.getValue(c[d]);if(f)return f}return null};goog.dom.forms.getInputChecked_=function(a){return a.checked?a.value:null};goog.dom.forms.getSelectSingle_=function(a){var b=a.selectedIndex;return 0<=b?a.options[b].value:null};
...
fyre.forms.validate.prototype.applyValidation=function(a){var b=fyre.forms.validate.CLASSES,c=this.getValidationSchemes(a);if(c){var d=goog.dom.forms.getValue(a);goog.array.some(c.split(" "),function(c){if(""!==c){c=c.split("-");var e=c.shift();c.push(d);c.push(a);e=this.validator[e];goog.asserts.assert(e);c=e.apply(this,c);if(!c.isValid)return this.errors.push([a,c.msg,c.fn]),!0;-1<a.className.indexOf(b.REAL_TIME)&&this.removeErrors(a)}},this)}};
fyre.forms.validate.prototype.getValidationSchemes=function(a){return a.getAttribute("data-fyre-validate")};
fyre.forms.validate.prototype.addError=function(a,b,c){var d=fyre.forms.validate.CLASSES,f=fyre.dom.create("div",{"class":d.FIELD_ERROR});f.html(fyre.sp.templates.popover({content:b,pos:c||"top"}));fyre.dom(goog.dom.getChildren(f.element)[0]);b=fyre.dom.create("span",{"class":d.INPUT_ERROR});goog.dom.insertChildAt(f.element,b.element,0);a=fyre.dom(a);a.after(f.element);this.errorElements.push(a);return f};
fyre.forms.validate.prototype.addPasswordError=function(a,b){var c=fyre.forms.validate.CLASSES,d={title:this.translations.passwordPopoverTitle,lengthMsg:this.translations.passwordLength,charsMsg:this.translations.passwordCharacters,symMsg:this.translations.passwordSymbols,len:b.len,chars:b.chars,sym:b.sym,checkUsername:b.checkUsername};b.checkUsername&&(d.username=b.username,d.usernameMsg=this.translations.passwordUsername);var f=fyre.sp.templates.passwordError(d),d=fyre.util.browser.isMobile(),f=
this.addError(a,f,d?"bottom":"right"),c=f.findElementByClass(c.POPOVER);c.addClass("lf-password-error");d?c.css({top:a.parentElement.offsetHeight-7+"px"}):c.css({left:a.offsetLeft+a.offsetWidth+"px"});return f};
fyre.forms.validate.prototype.removeErrors=function(a){var b=fyre.forms.validate.CLASSES.FIELD_ERROR,c=a?[fyre.dom(a)]:this.errorElements,d,f;goog.array.forEach(c,function(a){a.removeClass(b);(d=a.next())&&-1<d.element.className.indexOf(b)&&d.remove();(f=a.prev())&&f.removeClass(b)});a?(goog.array.removeIf(this.errors,function(b){return b[0]===a}),goog.array.removeIf(this.errorElements,function(b){return b.element===a})):(this.errors=[],this.errorElements=[])};
...
fyre.forms.validate.Validator.prototype.fileType=function(a,b){var c,d=[],f=fyre.forms.validate.Validator.FILE_TYPES;switch(a){case f.IMAGE:c=/.+\.(gif|jpg|jpeg|tiff|png)$/i,d=["gif","jpg","jpeg","tiff","png"]}return{isValid:b?c.test(b):!0,msg:this.getTranslatedError("validfileextensions")+": "+d.join(", ")}};fyre.forms.validate.Validator.prototype.fileSize=function(a,b,c){a=parseInt(a,10);b=c.size;return{isValid:b?b<a:!0,msg:this.getTranslatedError("filesizemustbelessthanMB",a/1E6)}};
...
(c=!1));return{fn:"addPasswordError",isValid:c,msg:b}};fyre.forms.validate.prototype.getTranslatedError=function(a,b){var c=this.translations[a];"object"===typeof fyre.sp.config&&"object"===typeof fyre.sp.config.strings&&fyre.sp.config.strings[a]&&(c=fyre.sp.config.strings[a]);b&&c&&(c=c.replace(/{#}/g,b));return c};fyre.sp.templates.editpassworderrorv2="function"==typeof fyre.sp.templates.editpassworderrorv2?fyre.sp.templates.editpassworderrorv2:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing;a=a.escapeExpression;return'<div class="fyre-lfep2">\n    '+a((c.include||b&&b.include||h).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-cp-one-column">\n        <p class="fyre-cp-reset-pw-error">'+
(null!=(e=(g=null!=(g=c.errorMsg||(null!=b?b.errorMsg:b))?g:h,"function"===typeof g?g.call(d,{name:"errorMsg",hash:{},data:f}):g))?e:"")+'</p>\n        <div class="fyre-cp-form-btns">\n            <a href="'+a((g=null!=(g=c.signInLink||(null!=b?b.signInLink:b))?g:h,"function"===typeof g?g.call(d,{name:"signInLink",hash:{},data:f}):g))+'" title="Sign in" class="fyre-cp-link-sign-in">'+a((g=null!=(g=c.signIn||(null!=b?b.signIn:b))?g:h,"function"===typeof g?g.call(d,{name:"signIn",hash:{},data:f}):g))+
'</a>\n            <input type="button" value="Start Over" class="fyre-cp-form-submit-btn fyre-cp-form-start-over-btn" />\n        </div>\n    </section>\n</div>\n'},useData:!0});goog.exportSymbol("fyre.sp.templates.editpassworderrorv2",fyre.sp.templates.editpassworderrorv2);goog.crypt={};goog.crypt.stringToByteArray=function(a){for(var b=[],c=0,d=0;d<a.length;d++){for(var f=a.charCodeAt(d);255<f;)b[c++]=f&255,f>>=8;b[c++]=f}return b};goog.crypt.byteArrayToString=function(a){return String.fromCharCode.apply(null,a)};goog.crypt.byteArrayToHex=function(a){return goog.array.map(a,function(a){a=a.toString(16);return 1<a.length?a:"0"+a}).join("")};
...
goog.crypt.utf8ByteArrayToString=function(a){for(var b=[],c=0,d=0;c<a.length;){var f=a[c++];if(128>f)b[d++]=String.fromCharCode(f);else if(191<f&&224>f){var e=a[c++];b[d++]=String.fromCharCode((f&31)<<6|e&63)}else{var e=a[c++],g=a[c++];b[d++]=String.fromCharCode((f&15)<<12|(e&63)<<6|g&63)}}return b.join("")};goog.crypt.xorByteArray=function(a,b){goog.asserts.assert(a.length==b.length,"XOR array lengths must match");for(var c=[],d=0;d<a.length;d++)c.push(a[d]^b[d]);return c};goog.crypt.base64={};goog.crypt.base64.byteToCharMap_=null;goog.crypt.base64.charToByteMap_=null;goog.crypt.base64.byteToCharMapWebSafe_=null;goog.crypt.base64.charToByteMapWebSafe_=null;goog.crypt.base64.ENCODED_VALS_BASE="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";goog.crypt.base64.ENCODED_VALS=goog.crypt.base64.ENCODED_VALS_BASE+"+/=";goog.crypt.base64.ENCODED_VALS_WEBSAFE=goog.crypt.base64.ENCODED_VALS_BASE+"-_.";
...
goog.crypt.base64.encodeByteArray=function(a,b){if(!goog.isArrayLike(a))throw Error("encodeByteArray takes an array as a parameter");goog.crypt.base64.init_();for(var c=b?goog.crypt.base64.byteToCharMapWebSafe_:goog.crypt.base64.byteToCharMap_,d=[],f=0;f<a.length;f+=3){var e=a[f],g=f+1<a.length,h=g?a[f+1]:0,k=f+2<a.length,l=k?a[f+2]:0,m=e>>2,e=(e&3)<<4|h>>4,h=(h&15)<<2|l>>6,l=l&63;k||(l=64,g||(h=64));d.push(c[m],c[e],c[h],c[l])}return d.join("")};
...
goog.crypt.base64.decodeStringToByteArray=function(a,b){goog.crypt.base64.init_();for(var c=b?goog.crypt.base64.charToByteMapWebSafe_:goog.crypt.base64.charToByteMap_,d=[],f=0;f<a.length;){var e=c[a.charAt(f++)],g=f<a.length?c[a.charAt(f)]:0;++f;var h=f<a.length?c[a.charAt(f)]:0;++f;var k=f<a.length?c[a.charAt(f)]:0;++f;if(null==e||null==g||null==h||null==k)throw Error();d.push(e<<2|g>>4);64!=h&&(d.push(g<<4&240|h>>2),64!=k&&d.push(h<<6&192|k))}return d};
...
fyre.util.loadCSS=function(a,b,c){var d=document.getElementsByTagName("head")[0],f=document.createElement("link");2>arguments.length&&(b=document);fyre.util.existsOnPage("link","href",a,b)||(d=b.getElementsByTagName("head")[0],f=b.createElement("link"),f.rel="stylesheet",f.type="text/css",f.href=a,f.media="all",goog.isObject(c)&&goog.object.extend(f,c),d.appendChild(f))};
...
fyre.util.loadScript=function(a,b,c){var d,f;2>arguments.length&&(b=document);fyre.util.existsOnPage("script","src",a,b)||(d=b.getElementsByTagName("head")[0],f=b.createElement("script"),f.type="text/javascript",f.src=a,goog.isObject(c)&&goog.object.extend(f,c),d.appendChild(f))};fyre.util.existsOnPage=function(a,b,c,d){4>arguments.length&&(d=document);return goog.array.some(d.getElementsByTagName(a),function(a){return goog.isString(a[b])&&-1<a[b].indexOf(c)})};fyre.util.base64.encodeString=function(a){return goog.crypt.base64.encodeString(a)};
...
(a=fyre.util.extend({},this.options,a));for(var b=0,c=d.length;b<c;b++){var e=d[b];a[e]&&(this[e]=a[e])}this.options=a},_ensureElement:function(){if(this.el)this.setElement(this.el,!1);else{var a=g(this,"attributes")||{};this.id&&(a.id=this.id);this.className&&(a["class"]=this.className);this.setElement(this.make(this.tagName,a),!1)}}});b.View.extend=function(a,b){var c=e(this,a,b);c.extend=this.extend;return c};var f=function(){},e=function(a,b,c){var d;d=b&&b.hasOwnProperty("constructor")?b.constructor:
function(){a.apply(this,arguments)};fyre.util.extend(d,a);f.prototype=a.prototype;d.prototype=new f;b&&fyre.util.extend(d.prototype,b);c&&fyre.util.extend(d,c);d.prototype.constructor=d;d.__super__=a.prototype;return d},g=function(a,b){return a&&a[b]?goog.isFunction(a[b])?a[b]():a[b]:null}})();fyre.lib.html5={};
...
fyre.ui.View.prototype.handleAppReady=function(){this.render=this.renderSafe;this.render()};fyre.ui.View.prototype.registerControl=function(a,b){var c=goog.array.slice(arguments,1),d,f,e,g=goog.array.clone(c);goog.asserts.assert(0===c.length%2);if(a)for(goog.isArray(a)||(a=[a]),d=0,f=a.length;d<f;d++){for(e=fyre.dom.getElement(a[d]);!goog.array.isEmpty(c);)this.container.getHandler().listen(e,c.shift(),goog.bind(c.shift(),this));c=goog.array.clone(g)}};fyre.ui.View.prototype.registerControls=function(){};
...
goog.ui.Dialog.prototype.focus=function(){goog.ui.Dialog.superClass_.focus.call(this);if(this.getButtonSet()){var a=this.getButtonSet().getDefault();if(a)for(var b=this.getDomHelper().getDocument(),c=this.buttonEl_.getElementsByTagName("button"),d=0,f;f=c[d];d++)if(f.name==a&&!f.disabled){try{if(goog.userAgent.WEBKIT||goog.userAgent.OPERA){var e=b.createElement("input");e.style.cssText="position:fixed;width:0;height:0;left:0;top:0;";this.getElement().appendChild(e);e.focus();this.getElement().removeChild(e)}f.focus()}catch(g){}break}}};
...
goog.ui.Dialog.prototype.onKey_=function(a){var b=!1,c=!1,d=this.getButtonSet(),f=a.target;if(a.type==goog.events.EventType.KEYDOWN)if(this.escapeToCancel_&&a.keyCode==goog.events.KeyCodes.ESC){var e=d&&d.getCancel(),f="SELECT"==f.tagName&&!f.disabled;e&&!f?(c=!0,b=d.get(e),b=this.dispatchEvent(new goog.ui.Dialog.Event(e,b))):f||(b=!0)}else a.keyCode==goog.events.KeyCodes.TAB&&a.shiftKey&&f==this.getElement()&&this.setupBackwardTabWrap();else if(a.keyCode==goog.events.KeyCodes.ENTER){if("BUTTON"==
f.tagName)e=f.name;else if(d){var g=d.getDefault(),h=g&&d.getButton(g),f=("TEXTAREA"==f.tagName||"SELECT"==f.tagName||"A"==f.tagName)&&!f.disabled;!h||h.disabled||f||(e=g)}e&&d&&(c=!0,b=this.dispatchEvent(new goog.ui.Dialog.Event(e,String(d.get(e)))))}if(b||c)a.stopPropagation(),a.preventDefault();b&&this.setVisible(!1)};goog.ui.Dialog.Event=function(a,b){this.type=goog.ui.Dialog.EventType.SELECT;this.key=a;this.caption=b};goog.inherits(goog.ui.Dialog.Event,goog.events.Event);
...
goog.ui.Dialog.ButtonSet.prototype.decorate=function(a){if(a&&a.nodeType==goog.dom.NodeType.ELEMENT){this.element_=a;a=this.element_.getElementsByTagName("button");for(var b=0,c,d,f;c=a[b];b++)if(d=c.name||c.id,f=goog.dom.getTextContent(c)||c.value,d){var e=0==b;this.set(d,f,e,c.name==goog.ui.Dialog.DefaultButtonKeys.CANCEL);e&&goog.dom.classes.add(c,this.class_+"-default")}}};goog.ui.Dialog.ButtonSet.prototype.getElement=function(){return this.element_};
...
goog.ui.ContainerRenderer.prototype.decorate=function(a,b){b.id&&a.setId(b.id);var c=this.getCssClass(),d=!1,f=goog.dom.classes.get(b);f&&goog.array.forEach(f,function(b){b==c?d=!0:b&&this.setStateFromClassName(a,b,c)},this);d||goog.dom.classes.add(b,c);this.decorateChildren(a,this.getContentElement(b));return b};
...
0):(c=b.keyCode||this.keyCode_,d=b.charCode||0,goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_&&(f=this.altKey_),goog.userAgent.MAC&&d==goog.events.KeyCodes.QUESTION_MARK&&c==goog.events.KeyCodes.WIN_KEY&&(c=goog.events.KeyCodes.SLASH));var e=c,g=b.keyIdentifier;c?63232<=c&&c in goog.events.KeyHandler.safariKey_?e=goog.events.KeyHandler.safariKey_[c]:25==c&&a.shiftKey&&(e=9):g&&g in goog.events.KeyHandler.keyIdentifier_&&(e=goog.events.KeyHandler.keyIdentifier_[g]);a=e==this.lastKey_;this.lastKey_=
e;b=new goog.events.KeyEvent(e,d,a,b);b.altKey=f;this.dispatchEvent(b)};goog.events.KeyHandler.prototype.getElement=function(){return this.element_};
...
goog.ui.ControlRenderer.prototype.decorate=function(a,b){b.id&&a.setId(b.id);var c=this.getContentElement(b);c&&c.firstChild?a.setContentInternal(c.firstChild.nextSibling?goog.array.clone(c.childNodes):c.firstChild):a.setContentInternal(null);var d=0,f=this.getCssClass(),e=this.getStructuralCssClass(),g=!1,h=!1,c=!1,k=goog.dom.classes.get(b);goog.array.forEach(k,function(a){g||a!=f?h||a!=e?d|=this.getStateFromClass(a):h=!0:(g=!0,e==f&&(h=!0))},this);a.setStateInternal(d);g||(k.push(f),e==f&&(h=!0));
h||k.push(e);var l=a.getExtraClassNames();l&&k.push.apply(k,l);if(goog.userAgent.IE&&!goog.userAgent.isVersion("7")){var m=this.getAppliedCombinedClassNames_(k);0<m.length&&(k.push.apply(k,m),c=!0)}g&&h&&!l&&!c||goog.dom.classes.set(b,k.join(" "));this.setAriaStates(a,b);return b};goog.ui.ControlRenderer.prototype.initializeDom=function(a){a.isRightToLeft()&&this.setRightToLeft(a.getElement(),!0);a.isEnabled()&&this.setFocusable(a,a.isVisible())};
...
fyre.ui.Dialog.prototype.decorate=function(a){var b=a.openInternal,c=a.closeInternal,d=a.repositionInternal,f=this,e=function(a){return function(){a.close.apply(a);a.trigger(goog.ui.Dialog.EventType.SELECT)}}(a);a.openInternal=function(){b&&!1===b.call(a)||(f.setElement(a.el),f.open(),goog.events.listen(f.dialog,goog.ui.Dialog.EventType.SELECT,e),a.reposition(),goog.isFunction(a.setFocus)&&a.setFocus())};a.closeInternal=function(){c&&!1===c.call(a)||(f.close(),goog.events.unlisten(f.dialog,goog.ui.Dialog.EventType.SELECT,
e))};a.repositionInternal=function(){d&&!1===d.call(a)||f.dialog.reposition()};a.popupType=function(){return fyre.ui.Dialog}};fyre.sp.templates.css="function"==typeof fyre.sp.templates.css?fyre.sp.templates.css:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return".fyre-lfep2,\n.fyre-lfep2 input,\n.fyre-lfep2 textarea {\n    font-family: "+a((e=null!=(e=c.brandFont||(null!=b?b.brandFont:b))?e:g,"function"===typeof e?e.call(d,{name:"brandFont",hash:{},data:f}):e))+";\n}\n\n.fyre-cp-form-btns .fyre-cp-form-back-btn,\n.fyre-cp-form-btns .fyre-cp-form-submit-btn {\n    background-color: "+
a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?e:g,"function"===typeof e?e.call(d,{name:"brandColor",hash:{},data:f}):e))+";\n}\n\n.fyre-cp-link-create {\n    color: "+a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?e:g,"function"===typeof e?e.call(d,{name:"brandColor",hash:{},data:f}):e))+";\n}\n\np.fyre-profile-user-comments span,\np.fyre-profile-user-likes span {\n    color: "+a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?e:g,"function"===typeof e?e.call(d,{name:"brandColor",
hash:{},data:f}):e))+";\n}\n\n.fyre-profile-comment-footer a {\n    color: "+a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?e:g,"function"===typeof e?e.call(d,{name:"brandColor",hash:{},data:f}):e))+";\n}\n\na.fyre-profile-more-link {\n    color: "+a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?e:g,"function"===typeof e?e.call(d,{name:"brandColor",hash:{},data:f}):e))+";\n}\n\n.fyre-cp-form .fyre-cp-edit-save-msg {\n    color: "+a((e=null!=(e=c.brandColor||(null!=b?b.brandColor:b))?
e:g,"function"===typeof e?e.call(d,{name:"brandColor",hash:{},data:f}):e))+"\n}"},useData:!0});goog.exportSymbol("fyre.sp.templates.css",fyre.sp.templates.css);fyre.sp.client.EngageClient=function(a,b){fyre.object.Communicator.call(this,a,b)};goog.inherits(fyre.sp.client.EngageClient,fyre.object.Communicator);
...
fyre.sp.client.EngageClient.prototype.initAuth=function(){fyre.util.existsOnPage("script","src",this.src)||fyre.util.loadScript(this.src,window.document,{id:this.id})};fyre.sp.client.EngageClient.prototype._janrainSetup=function(a){"object"!==typeof janrain&&(janrain={});janrain.settings={tokenUrl:a.tokenUrl||window.location.href,tokenAction:a.tokenAction||"event",popup:!1===a.popup?!1:!0,type:"embed",language:fyre.sp.config.localization};this.janrain=janrain};fyre.sp.templates.engagev2="function"==typeof fyre.sp.templates.engagev2?fyre.sp.templates.engagev2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e,g;d=null!=b?b:{};return'<div class="fyre-login">\n    <div id="fyre-engage-v2">\n        <div>\n            <div class="fyre-login-header">\n                '+a.escapeExpression((g=null!=(g=c.signInWith||(null!=b?b.signInWith:b))?g:c.helperMissing,"function"===typeof g?g.call(d,{name:"signInWith",hash:{},data:f}):g))+"\n            </div>\n"+
(null!=(e=c["if"].call(d,null!=(e=null!=(e=null!=b?b.lfep2:b)?e.lfSocialOptions:e)?e.multiCol:e,{name:"if",hash:{},fn:a.program(2,f,0),inverse:a.program(7,f,0),data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(9,f,0),inverse:a.noop,data:f}))?e:"")+"        </div>\n    </div>\n</div>\n"},2:function(a,b,c,d,f){var e;d=null!=b?b:{};return'                <ul class="fyre-social-list fyre-social-list-col">\n'+(null!=(e=c.each.call(d,null!=(e=null!=(e=null!=
(e=null!=b?b.lfep2:b)?e.lfSocialOptions:e)?e.services:e)?e.col1:e,{name:"each",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+'                </ul>\n                <ul class="fyre-social-list fyre-social-list-col">\n'+(null!=(e=c.each.call(d,null!=(e=null!=(e=null!=(e=null!=b?b.lfep2:b)?e.lfSocialOptions:e)?e.services:e)?e.col2:e,{name:"each",hash:{},fn:a.program(5,f,0),inverse:a.noop,data:f}))?e:"")+"                </ul>\n"},3:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;
a=a.escapeExpression;return'                        <li class="social-login" data-service="'+a((e=null!=(e=c.service||(null!=b?b.service:b))?e:g,"function"===typeof e?e.call(d,{name:"service",hash:{},data:f}):e))+'" role="button" tabindex="1'+a((e=null!=(e=c.index||f&&f.index)?e:g,"function"===typeof e?e.call(d,{name:"index",hash:{},data:f}):e))+'">\n                            <span class="fyre-source-'+a((e=null!=(e=c.service||(null!=b?b.service:b))?e:g,"function"===typeof e?e.call(d,{name:"service",
hash:{},data:f}):e))+'"></span>\n                            '+a((e=null!=(e=c.displayName||(null!=b?b.displayName:b))?e:g,"function"===typeof e?e.call(d,{name:"displayName",hash:{},data:f}):e))+"\n                        </li>\n"},5:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                        <li class="social-login" data-service="'+a((e=null!=(e=c.service||(null!=b?b.service:b))?e:g,"function"===typeof e?e.call(d,{name:"service",hash:{},data:f}):
e))+'" role="button" tabindex="2'+a((e=null!=(e=c.index||f&&f.index)?e:g,"function"===typeof e?e.call(d,{name:"index",hash:{},data:f}):e))+'">\n                            <span class="fyre-source-'+a((e=null!=(e=c.service||(null!=b?b.service:b))?e:g,"function"===typeof e?e.call(d,{name:"service",hash:{},data:f}):e))+'"></span>\n                            '+a((e=null!=(e=c.displayName||(null!=b?b.displayName:b))?e:g,"function"===typeof e?e.call(d,{name:"displayName",hash:{},data:f}):e))+"\n                        </li>\n"},
7:function(a,b,c,d,f){var e;return'                <ul class="fyre-social-list">\n'+(null!=(e=c.each.call(null!=b?b:{},null!=(e=null!=(e=null!=b?b.lfep2:b)?e.lfSocialOptions:e)?e.services:e,{name:"each",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+"                </ul>\n"},9:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=(e=null!=b?b.lfep2:b)?e.tosLink:e,{name:"if",hash:{},fn:a.program(10,f,0),inverse:a.noop,data:f}))?e:""},10:function(a,b,c,d,f){var e,g;
d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'                    <footer class="fyre-cp-tos">\n                        '+k((g=null!=(g=c.termsOfUseIntro||(null!=b?b.termsOfUseIntro:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUseIntro",hash:{},data:f}):g))+' <a target="_blank" href="'+k(a.lambda(null!=(e=null!=b?b.lfep2:b)?e.tosLink:e,b))+'" tabindex="31">'+k((g=null!=(g=c.termsOfUse||(null!=b?b.termsOfUse:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUse",hash:{},
data:f}):g))+"</a>\n                    </footer>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=(e=null!=(e=null!=b?b.lfep2:b)?e.lfSocialOptions:e)?e.services:e,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:""},useData:!0});goog.exportSymbol("fyre.sp.templates.engagev2",fyre.sp.templates.engagev2);fyre.client={};fyre.client.XpcClient=function(){};goog.addSingletonGetter(fyre.client.XpcClient);fyre.client.XpcClient.prototype.initXpc=function(a,b,c,d){var f,e=function(){d()?(g.abort(),g.dispose()):f=window.setTimeout(goog.bind(e,this),1E3)},g=new fyre.io.Iframe({child_page:a,success:function(a){window.clearTimeout(f);g.dispose();b(a)},failure:function(a){window.clearTimeout(f);g.dispose();c(a)}});g.send();goog.isFunction(d)&&e.call(this)};goog.window={};goog.window.DEFAULT_POPUP_HEIGHT=500;goog.window.DEFAULT_POPUP_WIDTH=690;goog.window.DEFAULT_POPUP_TARGET="google_popup";
goog.window.open=function(a,b,c){b||(b={});var d=c||window;c="undefined"!=typeof a.href?a.href:String(a);a=b.target||a.target;var f=[],e;for(e in b)switch(e){case "width":case "height":case "top":case "left":f.push(e+"="+b[e]);break;case "target":case "noreferrer":break;default:f.push(e+"="+(b[e]?1:0))}e=f.join(",");if(b.noreferrer){if(b=d.open("",a,e))goog.userAgent.IE&&-1!=c.indexOf(";")&&(c="'"+c.replace(/'/g,"%27")+"'"),b.opener=null,c=goog.string.htmlEscape(c),b.document.write('<META HTTP-EQUIV="refresh" content="0; url='+
c+'">'),b.document.close()}else b=d.open(c,a,e);return b};goog.window.openBlank=function(a,b,c){a=a?goog.string.htmlEscape(a):"";return goog.window.open('javascript:"'+encodeURI(a)+'"',b,c)};goog.window.popup=function(a,b){b||(b={});b.target=b.target||a.target||goog.window.DEFAULT_POPUP_TARGET;b.width=b.width||goog.window.DEFAULT_POPUP_WIDTH;b.height=b.height||goog.window.DEFAULT_POPUP_HEIGHT;var c=goog.window.open(a,b);if(!c)return!0;c.focus();return!1};fyre.controller.IframeController=function(a,b){fyre.controller.Controller.call(this,a,b)};goog.inherits(fyre.controller.IframeController,fyre.controller.Controller);fyre.controller.IframeController.prototype.initialize=function(a){this.view=a.view;this.url=a.url;this.xpcChildPage=a.xpcChildPage;goog.array.forEach(a.openOn||[],this.registerOpenEvent,this);goog.array.forEach(a.closeOn||[],this.registerCloseEvent,this);this.onClose=a.onClose;this.onOpen=a.onOpen;this.client=fyre.client.XpcClient.getInstance()};
...
fyre.controller.IframeController.prototype.parseIframeDirective_=function(a){a=a.split(fyre.controller.IframeController.DIRECTIVE_SEPARATOR);return{event:a[0],data:1<a.length?a[1]:null}};fyre.controller.IframeController.EVENT_MAP=fyre.controller.IframeController.prototype.EVENT_MAP={CLOSE:"Close"};fyre.controller.IframeController.DIRECTIVE_SEPARATOR="|";fyre.sp.templates.mobileloginv2="function"==typeof fyre.sp.templates.mobileloginv2?fyre.sp.templates.mobileloginv2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=b?b.localAuth:b,{name:"if",hash:{},fn:a.program(2,f,0),inverse:a.program(4,f,0),data:f}))?e:""},2:function(a,b,c,d,f){var e;return'                    <li class="fyre-cp-active">\n                        <a name="social" class="fyre-cp-mobile-tab">'+a.escapeExpression((e=null!=(e=
c.socialAccount||(null!=b?b.socialAccount:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"socialAccount",hash:{},data:f}):e))+"</a>\n                    </li>\n"},4:function(a,b,c,d,f){var e;return'                    <li class="fyre-cp-active fyre-cp-active-single">\n                        <a name="social" class="fyre-cp-mobile-tab">'+a.escapeExpression((e=null!=(e=c.socialAccount||(null!=b?b.socialAccount:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"socialAccount",
hash:{},data:f}):e))+"</a>\n                    </li>\n"},6:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(7,f,0),inverse:a.program(9,f,0),data:f}))?e:""},7:function(a,b,c,d,f){var e;return'                    <li>\n                        <a name="local" class="fyre-cp-mobile-tab">'+a.escapeExpression((e=null!=(e=c.livefyreAccount||(null!=b?b.livefyreAccount:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},
{name:"livefyreAccount",hash:{},data:f}):e))+"</a>\n                    </li>\n"},9:function(a,b,c,d,f){var e;return'                    <li class="fyre-cp-active fyre-cp-active-single">\n                        <a name="local" class="fyre-cp-mobile-tab">'+a.escapeExpression((e=null!=(e=c.livefyreAccount||(null!=b?b.livefyreAccount:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"livefyreAccount",hash:{},data:f}):e))+"</a>\n                    </li>\n"},11:function(a,b,c,d,f){return'                <section class="fyre-cp-mobile-tab-content fyre-cp-mobile-tab-social">\n                    '+
a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.engagev2",{name:"include",hash:{},data:f}))+"\n                </section>\n"},13:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(14,f,0),inverse:a.program(16,f,0),data:f}))?e:""},14:function(a,b,c,d,f){return'                <section class="fyre-cp-edit-tab-content fyre-cp-mobile-tab-local fyre-cp-hidden">\n                    '+
a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.localloginv2",{name:"include",hash:{},data:f}))+"\n                </section>\n"},16:function(a,b,c,d,f){return'                <section class="fyre-cp-edit-tab-content fyre-cp-mobile-tab-local">\n                    '+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.localloginv2",{name:"include",hash:{},data:f}))+"\n                </section>\n"},compiler:[7,
">= 4.0.0"],main:function(a,b,c,d,f){var e;d=null!=b?b:{};return'<div class="fyre-cp-login fyre-lfep2">\n    '+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <nav class="fyre-cp-mobile-nav">\n        <ul class="fyre-cp-mobile-tabs">\n'+(null!=(e=c["if"].call(d,null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.localAuth:b,{name:"if",
hash:{},fn:a.program(6,f,0),inverse:a.noop,data:f}))?e:"")+"        </ul>\n    </nav>\n    <section>\n"+(null!=(e=c["if"].call(d,null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(11,f,0),inverse:a.noop,data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.localAuth:b,{name:"if",hash:{},fn:a.program(13,f,0),inverse:a.noop,data:f}))?e:"")+"    </section>\n</div>"},useData:!0});goog.exportSymbol("fyre.sp.templates.mobileloginv2",fyre.sp.templates.mobileloginv2);fyre.sp.templates.login="function"==typeof fyre.sp.templates.login?fyre.sp.templates.login:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){return'<div class="fyre-cp-login fyre-lfep2">\n'},3:function(a,b,c,d,f){return'<div class="fyre-cp-login">\n'},5:function(a,b,c,d,f){var e;d=null!=b?b:{};return"        "+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n        <section class="fyre-cp-body">\n'+(null!=(e=
c["if"].call(d,null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(6,f,0),inverse:a.noop,data:f}))?e:"")+"\n"+(null!=(e=c["if"].call(d,null!=b?b.includeDivider:b,{name:"if",hash:{},fn:a.program(8,f,0),inverse:a.noop,data:f}))?e:"")+"\n"+(null!=(e=c["if"].call(d,null!=b?b.localAuth:b,{name:"if",hash:{},fn:a.program(10,f,0),inverse:a.noop,data:f}))?e:"")+"        </section>\n"+(null!=(e=c["if"].call(d,null!=(e=null!=b?b.lfep2:b)?e.tosLink:e,{name:"if",hash:{},fn:a.program(12,f,0),inverse:a.noop,
data:f}))?e:"")},6:function(a,b,c,d,f){return"                "+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.engagev2",{name:"include",hash:{},data:f}))+"\n"},8:function(a,b,c,d,f){return'                <div class="fyre-cp-divider">\n                    <span class="inner"></span>\n                </div>\n'},10:function(a,b,c,d,f){return"                "+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.localloginv2",
{name:"include",hash:{},data:f}))+"\n"},12:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'        <footer class="fyre-cp-tos">\n            '+k((g=null!=(g=c.termsOfUseIntro||(null!=b?b.termsOfUseIntro:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUseIntro",hash:{},data:f}):g))+' <a target="_blank" href="'+k(a.lambda(null!=(e=null!=b?b.lfep2:b)?e.tosLink:e,b))+'" tabindex="31" title="'+k((g=null!=(g=c.termsOfUseTitle||(null!=b?b.termsOfUseTitle:
b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUseTitle",hash:{},data:f}):g))+'" aria-label="'+k((g=null!=(g=c.termsOfUseAriaLabel||(null!=b?b.termsOfUseAriaLabel:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUseAriaLabel",hash:{},data:f}):g))+'" role="button">'+k((g=null!=(g=c.termsOfUse||(null!=b?b.termsOfUse:b))?g:h,"function"===typeof g?g.call(d,{name:"termsOfUse",hash:{},data:f}):g))+"</a>\n        </footer>\n"},14:function(a,b,c,d,f){var e;d=null!=b?b:{};return'        <header class="fyre-cp-modal-header">\n            Sign in with\n            <img src="'+
a.escapeExpression((c.media_url||b&&b.media_url||c.helperMissing).call(d,"images/default/logo.png",{name:"media_url",hash:{},data:f}))+'" align="right" alt="Livefyre" />\n        </header>\n        <section>\n'+(null!=(e=c["if"].call(d,null!=b?b.socialAuth:b,{name:"if",hash:{},fn:a.program(15,f,0),inverse:a.noop,data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.localAuth:b,{name:"if",hash:{},fn:a.program(17,f,0),inverse:a.noop,data:f}))?e:"")+"        </section>\n"},15:function(a,b,c,d,f){return"                "+
a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.engage",{name:"include",hash:{},data:f}))+"\n"},17:function(a,b,c,d,f){return"                "+a.escapeExpression((c.include||b&&b.include||c.helperMissing).call(null!=b?b:{},"fyre.sp.templates.locallogin",{name:"include",hash:{},data:f}))+"\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e;d=null!=b?b:{};return(null!=(e=c["if"].call(d,null!=b?b.lfep2:b,{name:"if",hash:{},fn:a.program(1,f,
0),inverse:a.program(3,f,0),data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.lfep2:b,{name:"if",hash:{},fn:a.program(5,f,0),inverse:a.program(14,f,0),data:f}))?e:"")+"</div>\n"},useData:!0});goog.exportSymbol("fyre.sp.templates.login",fyre.sp.templates.login);fyre.sp.templates.localloginv2="function"==typeof fyre.sp.templates.localloginv2?fyre.sp.templates.localloginv2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){return'        <footer class="fyre-cp-form-btns signin-view">\n'},3:function(a,b,c,d,f){return'        <footer class="fyre-cp-form-btns">\n'},5:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'            <div class="fyre-cp-createnew fyre-cp-createnew-mobile">\n                <input class="fyre-cp-form-submit-btn mobile-signin-button" type="submit" value="'+
a((e=null!=(e=c.signIn||(null!=b?b.signIn:b))?e:g,"function"===typeof e?e.call(d,{name:"signIn",hash:{},data:f}):e))+'" tabindex="3"/>\n                <a href="'+a((e=null!=(e=c.createAccountUrl||(null!=b?b.createAccountUrl:b))?e:g,"function"===typeof e?e.call(d,{name:"createAccountUrl",hash:{},data:f}):e))+'" class="fyre-cp-link-create" title="'+a((e=null!=(e=c.createANewAccount||(null!=b?b.createANewAccount:b))?e:g,"function"===typeof e?e.call(d,{name:"createANewAccount",hash:{},data:f}):e))+'">'+
a((e=null!=(e=c.createANewAccount||(null!=b?b.createANewAccount:b))?e:g,"function"===typeof e?e.call(d,{name:"createANewAccount",hash:{},data:f}):e))+"</a>\n            </div>\n"},7:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <a href="'+a((e=null!=(e=c.createAccountUrl||(null!=b?b.createAccountUrl:b))?e:g,"function"===typeof e?e.call(d,{name:"createAccountUrl",hash:{},data:f}):e))+'" class="fyre-cp-link-create" title="'+a((e=null!=(e=
c.createANewAccountTitle||(null!=b?b.createANewAccountTitle:b))?e:g,"function"===typeof e?e.call(d,{name:"createANewAccountTitle",hash:{},data:f}):e))+'" tabindex="5" aria-label="'+a((e=null!=(e=c.createANewAccountAriaLabel||(null!=b?b.createANewAccountAriaLabel:b))?e:g,"function"===typeof e?e.call(d,{name:"createANewAccountAriaLabel",hash:{},data:f}):e))+'" role="button">'+a((e=null!=(e=c.createANewAccount||(null!=b?b.createANewAccount:b))?e:g,"function"===typeof e?e.call(d,{name:"createANewAccount",
hash:{},data:f}):e))+"</a>\n"},9:function(a,b,c,d,f){var e;return'            <input class="fyre-cp-form-submit-btn" type="submit" value="'+a.escapeExpression((e=null!=(e=c.signIn||(null!=b?b.signIn:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"signIn",hash:{},data:f}):e))+'" tabindex="3"/>\n'},11:function(a,b,c,d,f){var e;return null!=(e=c["if"].call(null!=b?b:{},null!=b?b.tosLink:b,{name:"if",hash:{},fn:a.program(12,f,0),inverse:a.noop,data:f}))?e:""},12:function(a,b,c,
d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <footer class="fyre-cp-tos">\n                    '+a((e=null!=(e=c.termsOfUseIntro||(null!=b?b.termsOfUseIntro:b))?e:g,"function"===typeof e?e.call(d,{name:"termsOfUseIntro",hash:{},data:f}):e))+' <a target="_blank" href="'+a((e=null!=(e=c.tosLink||(null!=b?b.tosLink:b))?e:g,"function"===typeof e?e.call(d,{name:"tosLink",hash:{},data:f}):e))+'" tabindex="31">'+a((e=null!=(e=c.termsOfUse||(null!=b?b.termsOfUse:
b))?e:g,"function"===typeof e?e.call(d,{name:"termsOfUse",hash:{},data:f}):e))+"</a>\n                </footer>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'<div class="fyre-cp-local-login">\n    <form class="fyre-cp-form">\n        <header class="fyre-cp-form-header">'+k((g=null!=(g=c.signInWithEmail||(null!=b?b.signInWithEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"signInWithEmail",hash:{},data:f}):g))+'</header>\n\t\t<fieldset>\n    \t    <label for="username">'+
k((g=null!=(g=c.labelUsernameOrEmail||(null!=b?b.labelUsernameOrEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"labelUsernameOrEmail",hash:{},data:f}):g))+'</label>\n\t        <input type="text" name="username" class="fyre-cp-input-username" data-fyre-validate="required" tabindex="1"/>\n\t\t</fieldset>\n\t\t<fieldset>\n    \t    <label for="password">'+k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:f}):g))+'</label>\n\t        <input type="password" name="password" class="fyre-cp-input-password" data-fyre-validate="required" tabindex="2" autocomplete="off"/>\n\t\t</fieldset>\n\n'+
(null!=(e=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.program(3,f,0),data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(5,f,0),inverse:a.noop,data:f}))?e:"")+'            <div class="fyre-cp-form-btn-wrap">\n                <a href="'+k((g=null!=(g=c.forgotPwUrl||(null!=b?b.forgotPwUrl:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPwUrl",hash:{},data:f}):g))+'" class="fyre-cp-link-forgot" title="'+k((g=null!=
(g=c.forgotPasswordTitle||(null!=b?b.forgotPasswordTitle:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPasswordTitle",hash:{},data:f}):g))+'" tabindex="4" aria-label="'+k((g=null!=(g=c.forgotPasswordAriaLabel||(null!=b?b.forgotPasswordAriaLabel:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPasswordAriaLabel",hash:{},data:f}):g))+'" role="button">'+k((g=null!=(g=c.forgotPassword||(null!=b?b.forgotPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"forgotPassword",hash:{},data:f}):g))+
"</a>\n"+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(7,f,0),inverse:a.noop,data:f}))?e:"")+"            </div>\n"+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(9,f,0),inverse:a.noop,data:f}))?e:"")+"        </footer>\n"+(null!=(e=c["if"].call(d,null!=b?b.is_mobile:b,{name:"if",hash:{},fn:a.program(11,f,0),inverse:a.noop,data:f}))?e:"")+"    </form>\n</div>\n"},useData:!0});
goog.exportSymbol("fyre.sp.templates.localloginv2",fyre.sp.templates.localloginv2);fyre.sp.templates.headerv2="function"==typeof fyre.sp.templates.headerv2?fyre.sp.templates.headerv2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e;return'        <img src="'+a.escapeExpression((e=null!=(e=c.customerLogo||(null!=b?b.customerLogo:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"customerLogo",hash:{},data:f}):e))+'"/>\n'},3:function(a,b,c,d,f){return'        <img src="'+a.escapeExpression((c.media_url||b&&b.media_url||c.helperMissing).call(null!=b?b:
{},"images/default/logo.png",{name:"media_url",hash:{},data:f}))+'" alt="Livefyre" />\n'},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e;return'<header class="fyre-cp-modal-headers">\n    <div class="fyre-cp-modal-headers-wrap">\n'+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.customerLogo:b,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.program(3,f,0),data:f}))?e:"")+"    </div>\n</header>"},useData:!0});goog.exportSymbol("fyre.sp.templates.headerv2",fyre.sp.templates.headerv2);fyre.sp.templates.socialEngage="function"==typeof fyre.sp.templates.socialEngage?fyre.sp.templates.socialEngage:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){return""},useData:!0});goog.exportSymbol("fyre.sp.templates.socialEngage",fyre.sp.templates.socialEngage);fyre.sp.ui.Engage=function(a,b){fyre.ui.PopupView.call(this,a,b)};goog.inherits(fyre.sp.ui.Engage,fyre.ui.PopupView);fyre.sp.ui.Engage.CLASSES={LFEP2:"fyre-lfep2",FORGOT_LINK:"fyre-cp-link-forgot",CREATE_LINK:"fyre-cp-link-create",MOBILE_TAB:"fyre-cp-mobile-tab",MOBILE_TAB_CONTENT:"fyre-cp-mobile-tab-content",ACTIVE:"fyre-cp-active",INPUT_PW:"fyre-cp-input-password",INPUT_USERNAME:"fyre-cp-input-username",FORM:"fyre-cp-form"};
...
if(a.data&&"string"===typeof a.data&&navigator.userAgent.match(/MSIE [5-9]/))try{var f=JSON.parse(a.data);c.setAuthCookie(f.cookieData);c.setToken({data:"lfcp-token="+f.token})}catch(e){}});fyre.sp.ui.Engage.superClass_.initialize.call(this,a)};
...
includeDivider:fyre.sp.config.auth.SOCIAL&&fyre.sp.config.auth.LOCAL,customerLogo:fyre.sp.config.customerLogo,is_mobile:this.isMobile};if(4<fyre.sp.config.social_networks.services.length&&8>=fyre.sp.config.social_networks.services.length){var d=fyre.sp.config.social_networks.services,b=d.slice(0,4),d=d.slice(4,d.length);fyre.sp.config.social_networks.multiCol=!0;fyre.sp.config.social_networks.services.col1=b;fyre.sp.config.social_networks.services.col2=d}fyre.sp.config.lfep2&&(c.lfep2={lfSocialOptions:fyre.sp.config.social_networks,
tosLink:fyre.sp.config.tc,font:fyre.sp.config.font});b=this.getTranslations(this.options.opts);goog.object.extend(c,b);a=a(c);this.$el.html(a);this.rendered=!0;fyre.sp.config.auth.LOCAL&&(this.validator=new fyre.forms.validate(this.getFormEl()));fyre.sp.config.auth.SOCIAL&&"undefined"!==typeof janrain&&(janrain.ready=!0)}};
...
fyre.sp.ui.Engage.prototype.checkLoggedIn=function(a,b){var c="/api/v1.0/public/profile/";"object"===typeof fyre.sp.config.servers&&fyre.sp.config.servers.profile&&(c=fyre.sp.config.servers.profile+"/api/v1.0/public/profile/");var d=this;if("XDomainRequest"in window&&null!==window.XDomainRequest&&navigator.userAgent.match(/MSIE [5-9]/)){var f=new XDomainRequest;f.timeout=3E3;f.onload=function(){var b=new ActiveXObject("Microsoft.XMLDOM"),c=goog.json.unsafeParse(f.responseText);b.async=!1;a.call(d,
c)};f.onprogress=function(){};f.ontimeout=function(){};f.onerror=function(){b.call(d,"error 214")};c=c.replace("http://","https://");"http:"===window.location.protocol&&(c=c.replace("https://","http://"));f.open("get",c);f.send()}else(new fyre.io.Req({url:c,method:"GET",success:a.bind(this),failure:b.bind(this),withCredentials:!0})).send()};
...
d.ontimeout=function(){};d.onerror=function(){};var f=c.replace("http://","https://");"http:"===window.location.protocol&&(f=f.replace("https://","http://"));d.open("get",f+fyre.sp.config.JS_CONFIG+"/");d.send()}else(new fyre.io.Req({url:c+fyre.sp.config.JS_CONFIG+"/",success:function(a){b.configSuccess(b,a,c)},failure:function(a){},withCredentials:!0})).send();for(var e in a.events)this.messenger.subscribe(e,a.events[e])};
fyre.app.Base.prototype.configSuccess=function(a,b,c){function d(a){return"github"===a?"GitHub":a.charAt(0).toUpperCase()+a.substr(1).toLowerCase()}b=b.data;fyre.sp.config.servers.profile=b.servers.profile;fyre.sp.config.servers.assets=b.assets;fyre.sp.config.CDN_HOST=b.default_cdn;fyre.sp.config.PUBLIC_API_URL=fyre.sp.config.servers.profile+fyre.sp.config.API_PATH;fyre.sp.config.customer_domain=c;fyre.sp.config.privacy=b.privacy;c="v"+(fyre.sp.config.packageVersion||"0.0.0");var f="https://"+fyre.sp.config.CDN_HOST;
fyre.sp.config.MEDIA_PATH=[f,"libs/identity",c,"simple"].join("/");fyre.sp.config.auth=function(a){a=a||"social";return{SCHEMA:a,SOCIAL:goog.array.contains(["all","social"],a),LOCAL:goog.array.contains(["all","local"],a)}}(b.AUTH_SCHEMA);fyre.sp.config.social_networks=function(a){var b=[];if(a.length)for(var c=0;c<a.length;c++)b.push({displayName:d(a[c]),service:a[c]});return{services:b}}(b.social_networks||[]);fyre.sp.config.tld=b.tld;fyre.sp.config.lfep2=b.lfep2||!1;fyre.sp.config.customerLogo=
b.logo;fyre.sp.config.brand_color=b.brand_color||"#e86600";fyre.sp.config.tc=b.tc;fyre.sp.config.font=b.font;fyre.sp.config.csrftoken=b.csrftoken;fyre.sp.authController.loginByCookie(a.messenger);var e=fyre.util.browser.isMobile()?"mobile.css":"sp.css",e=[f,"libs/identity",c,"simple/css/default",e].join("/");fyre.sp.config.CDN_ASSET_PATH=[f,"libs/identity",c,"simple"].join("/")+"/";fyre.util.loadCSS(e);fyre.sp.i18n.getInstance().fetch(b.network,function(){a.ready()})};
fyre.app.Base.prototype.ready=function(){};fyre.app.Base.prototype.poll=function(){this.domReadyTimeout=setTimeout(goog.bind(this.checkReadyTimeOut,this),25)};fyre.app.Base.prototype.checkReadyTimeOut=function(){clearTimeout(this.domReadyTimeout);this.isReady()?this.messenger.trigger(fyre.sp.events.DOM_READY):this.poll()};fyre.app.Base.prototype.isReady=function(){return document.getElementById(this.opts.el)};
var SP_EVENTS={LOGIN_COMPLETE:"auth_login_complete",LOGIN_INCOMPLETE:"auth_login_incomplete",LOGOUT_COMPLETE:"auth_logout_complete"};fyre.app.LFEPAuthDelegate=function(a){a=a||{};var b=this.spObject=window.fyre.sp;this.engageApp=new b.app.Engage(a||{});this.profileApp=new b.app.Profile(a||{})};
...
a((e=null!=(e=c.forgotYourPassword||(null!=b?b.forgotYourPassword:b))?e:g,"function"===typeof e?e.call(d,{name:"forgotYourPassword",hash:{},data:f}):e))+"</header>\n            <p>\n                "+a((e=null!=(e=c.forgotYourPasswordInstructions||(null!=b?b.forgotYourPasswordInstructions:b))?e:g,"function"===typeof e?e.call(d,{name:"forgotYourPasswordInstructions",hash:{},data:f}):e))+'\n            </p>\n    \t\t<fieldset>\n    \t        <label for="username">'+a((e=null!=(e=c.labelUsernameOrEmail||
(null!=b?b.labelUsernameOrEmail:b))?e:g,"function"===typeof e?e.call(d,{name:"labelUsernameOrEmail",hash:{},data:f}):e))+' *</label>\n    \t        <input type="text" name="username" class="fyre-cp-input-username" data-fyre-validate="required" />\n    \t        <input type="hidden" name="resetUrl" value="'+a((e=null!=(e=c.resetUrl||(null!=b?b.resetUrl:b))?e:g,"function"===typeof e?e.call(d,{name:"resetUrl",hash:{},data:f}):e))+'" />\n    \t\t</fieldset>\n            <footer class="fyre-cp-form-btns">\n                <input type="button" class="fyre-cp-form-back-btn" value="'+
a((e=null!=(e=c.back||(null!=b?b.back:b))?e:g,"function"===typeof e?e.call(d,{name:"back",hash:{},data:f}):e))+'"></a>\n                <input type="submit" class="fyre-cp-form-submit-btn" value="'+a((e=null!=(e=c.reset||(null!=b?b.reset:b))?e:g,"function"===typeof e?e.call(d,{name:"reset",hash:{},data:f}):e))+'" />\n            </footer>\n        </form>\n    </section>\n</div>'},useData:!0});goog.exportSymbol("fyre.sp.templates.resetpasswordemailformv2",fyre.sp.templates.resetpasswordemailformv2);fyre.sp.templates.resetpasswordemailsuccessv2="function"==typeof fyre.sp.templates.resetpasswordemailsuccessv2?fyre.sp.templates.resetpasswordemailsuccessv2:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'<div class="fyre-lfep2">\n    '+a((c.include||b&&b.include||g).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-cp-one-column fyre-cp-reset-pw">\n        <p class="fyre-cp-reset-pw-success">\n            '+
a((e=null!=(e=c.emailSenttoResetPassword||(null!=b?b.emailSenttoResetPassword:b))?e:g,"function"===typeof e?e.call(d,{name:"emailSenttoResetPassword",hash:{},data:f}):e))+'\n        </p>\n        <div class="fyre-cp-form-btns">\n            <input type="button" value="'+a((e=null!=(e=c.formInputCloseButtonText||(null!=b?b.formInputCloseButtonText:b))?e:g,"function"===typeof e?e.call(d,{name:"formInputCloseButtonText",hash:{},data:f}):e))+'" class="fyre-cp-form-submit-btn" />\n        </div>\n    </section>\n</div>'},
...
fyre.sp.app.BrowserEngage.prototype.checkLoggedInIE=function(a,b){var c="/api/v1.0/public/profile/";"object"===typeof fyre.sp.config.servers&&fyre.sp.config.servers.profile&&(c=fyre.sp.config.servers.profile+"/api/v1.0/public/profile/");var d=this;if("XDomainRequest"in window&&null!==window.XDomainRequest&&navigator.userAgent.match(/MSIE [5-9]/)){var f=new XDomainRequest;f.timeout=3E3;f.onload=function(){var b=new ActiveXObject("Microsoft.XMLDOM"),c=goog.json.unsafeParse(f.responseText);b.async=!1;
a.call(d,c)};f.onprogress=function(){};f.ontimeout=function(){};f.onerror=function(){b.call(d,"error 214")};c=c.replace("http://","https://");"http:"===window.location.protocol&&(c=c.replace("https://","http://"));f.open("get",c);f.send()}};
...
1];b.parentNode.insertBefore(a,b)}a=new fyre.sp.ui.Iframe(this.messenger,{style:{height:"366px",width:this.getIframeWidth_()},el:this.opts.el});b=new fyre.sp.controller.EngageIframeController(this.messenger,{url:goog.partial(function(a){var b=new goog.Uri(fyre.sp.config.servers.profile+"/pages/auth/engage/"),f=new goog.Uri.QueryData;f.extend(a);b.setQueryData(goog.Uri.QueryData.createFromMap(f));return b.toString()},this.opts),openOn:[fyre.sp.events.ENGAGE_AUTH_INIT],onClose:fyre.sp.events.LOGIN_BY_COOKIE,
...
fyre.sp.app.BrowserEngage.prototype.ieInitUtil_=function(){var a=new fyre.sp.ui.Iframe(this.messenger,{style:{height:"340px",width:"487px"},el:this.opts.el});this.resetPwIframeController=new fyre.sp.controller.UtilIframeController(this.messenger,{url:goog.partial(function(a){var b=new goog.Uri(fyre.sp.config.servers.profile+"/pages/util/reset_password/"),f=new goog.Uri.QueryData;a.next=fyre.util.base64.encodeString(window.location.href);f.extend(a);b.setQueryData(goog.Uri.QueryData.createFromMap(f));
...
"/pages/profile/edit/password/"),f=new goog.Uri.QueryData;f.extend(a);b.setQueryData(goog.Uri.QueryData.createFromMap(f));return b.toString()},this,this.opts),onClose:fyre.sp.events.LOGIN_BY_COOKIE,openOn:[fyre.sp.events.PW_EDIT_INIT],view:a});this.editPasswordWidget=new fyre.sp.widget.IframeWidget(this.messenger,{iframeController:b,iframeView:a,viewDecorator:fyre.ui.Dialog.getInstance(),attrs:{name:"edit-password"}});a=new fyre.sp.ui.Iframe(this.messenger,{style:{height:"598px",width:"572px"},el:this.opts.el});
b=new fyre.sp.controller.ProfileIframeController(this.messenger,{url:goog.bind(function(a){a.is_ie=!0;var b=new goog.Uri(fyre.sp.config.servers.profile+"/pages/profile/edit"),f=new goog.Uri.QueryData;f.extend(a);b.setQueryData(goog.Uri.QueryData.createFromMap(f));return b.toString()},this,this.opts),onClose:fyre.sp.events.LOGIN_BY_COOKIE,openOn:[fyre.sp.events.PROFILE_EDIT_INIT],view:a});this.editProfileWidget=new fyre.sp.widget.IframeWidget(this.messenger,{iframeController:b,iframeView:a,viewDecorator:fyre.ui.Dialog.getInstance(),
attrs:{name:"edit-profile"}});b=new fyre.sp.ui.Iframe(this.messenger,{style:{height:"598px",width:"572px"},el:this.opts.el});a=new fyre.sp.controller.ProfileIframeController(this.messenger,{url:goog.bind(function(a){a.is_ie=!0;var b=new goog.Uri(fyre.sp.config.servers.profile+"/pages/profile/"),f=new goog.Uri.QueryData;f.extend(a);b.setQueryData(goog.Uri.QueryData.createFromMap(f));return b.toString()},this,this.opts),onClose:fyre.sp.events.LOGIN_BY_COOKIE,openOn:[fyre.sp.events.PROFILE_GET_INIT],
...
fyre.sp.ui.ProfileBase.prototype.getLikeCount=function(){return this.$el.getByClass("fyre-profile-user-likes")};fyre.sp.ui.ProfileBase.prototype.closeInternal=function(){fyre.sp.ui.ProfileBase.superClass_.closeInternal.call(this);this.model.set(this.model.defaults)};fyre.sp.templates.viewprofilev2="function"==typeof fyre.sp.templates.viewprofilev2?fyre.sp.templates.viewprofilev2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'        <img src="'+a((e=null!=(e=c.avatar||(null!=b?b.avatar:b))?e:g,"function"===typeof e?e.call(d,{name:"avatar",hash:{},data:f}):e))+'" class="fyre-profile-avatar" alt="'+a((e=null!=(e=c.username||(null!=b?b.username:b))?e:g,"function"===typeof e?e.call(d,{name:"username",
hash:{},data:f}):e))+'" />\n'},3:function(a,b,c,d,f){var e;d=null!=b?b:{};return'        <aside class="fyre-profile-bio">\n'+(null!=(e=c["if"].call(d,null!=b?b.currentLocation:b,{name:"if",hash:{},fn:a.program(4,f,0),inverse:a.noop,data:f}))?e:"")+'            <p class="fyre-profile-bio-text">\n                '+a.escapeExpression((c.partial_text||b&&b.partial_text||c.helperMissing).call(d,null!=b?b.aboutMe:b,{name:"partial_text",hash:{},data:f}))+"\n            </p>\n        </aside>\n"},4:function(a,
b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'            <span class="fyre-profile-location-pin"></span>\n            <strong>'+a((e=null!=(e=c.displayName||(null!=b?b.displayName:b))?e:g,"function"===typeof e?e.call(d,{name:"displayName",hash:{},data:f}):e))+" "+a((e=null!=(e=c.locationIsFrom||(null!=b?b.locationIsFrom:b))?e:g,"function"===typeof e?e.call(d,{name:"locationIsFrom",hash:{},data:f}):e))+" "+a((e=null!=(e=c.currentLocation||(null!=b?b.currentLocation:
b))?e:g,"function"===typeof e?e.call(d,{name:"currentLocation",hash:{},data:f}):e))+"</strong>\n"},6:function(a,b,c,d,f,e,g){var h;return'            <div class="fyre-profile-comment-wrapper">\n'+(null!=(h=c.each.call(null!=b?b:{},null!=(h=null!=b?b.comments:b)?h.content:h,{name:"each",hash:{},fn:a.program(7,f,0,e,g),inverse:a.noop,data:f}))?h:"")+"            </div>\n"},7:function(a,b,c,d,f,e,g){var h,k;d=null!=b?b:{};e=c.helperMissing;var l=a.escapeExpression;a=a.lambda;return'                <div class="fyre-profile-comment">\n                    <div class="fyre-profile-comment-text">\n                        '+
l((c.partial_text||b&&b.partial_text||e).call(d,null!=(h=null!=b?b.content:b)?h.bodyHtml:h,{name:"partial_text",hash:{},data:f}))+'\n                    </div>\n                    <div class="fyre-profile-comment-footer">\n                        '+l(a(null!=g[1]?g[1].posted:g[1],b))+" "+l(a(null!=(h=null!=(h=null!=b?b.content:b)?h.createdAt:h)?h.calculated_time:h,b))+" "+l(a(null!=g[1]?g[1].on:g[1],b))+' <a href="'+l(a(null!=(h=null!=b?b.collection:b)?h.url:h,b))+"#lf-content="+l((k=null!=(k=c.collectionId||
(null!=b?b.collectionId:b))?k:e,"function"===typeof k?k.call(d,{name:"collectionId",hash:{},data:f}):k))+":"+l(a(null!=(h=null!=b?b.content:b)?h.id:h,b))+'" target="_blank">'+l(a(null!=(h=null!=b?b.collection:b)?h.title:h,b))+"</a>\n                    </div>\n                </div>\n"},9:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'            <div class="fyre-profile-comment">\n                <div class="fyre-profile-comment-text">\n                    <p>'+
a((e=null!=(e=c.username||(null!=b?b.username:b))?e:g,"function"===typeof e?e.call(d,{name:"username",hash:{},data:f}):e))+" "+a((e=null!=(e=c.hasNotLeftAnyComments||(null!=b?b.hasNotLeftAnyComments:b))?e:g,"function"===typeof e?e.call(d,{name:"hasNotLeftAnyComments",hash:{},data:f}):e))+".</p>\n                </div>\n            </div>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f,e,g){var h,k;d=null!=b?b:{};var l=c.helperMissing,m=a.escapeExpression;return'\x3c!-- view profile template --\x3e\n<div class="fyre-profile fyre-lfep2">\n    <span class="fyre-cp-back-button"></span>\n    '+
m((c.include||b&&b.include||l).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-profile-section">\n'+(null!=(h=c["if"].call(d,null!=b?b.avatar:b,{name:"if",hash:{},fn:a.program(1,f,0,e,g),inverse:a.noop,data:f}))?h:"")+'        <h2 class="fyre-profile-displayname">\n            <span>'+m((k=null!=(k=c.displayName||(null!=b?b.displayName:b))?k:l,"function"===typeof k?k.call(d,{name:"displayName",hash:{},data:f}):k))+'</span>\n            <img class="fyre-loader" src="'+
m((c.media_url||b&&b.media_url||l).call(d,"images/default/loader.gif",{name:"media_url",hash:{},data:f}))+'" alt="'+m((k=null!=(k=c.labelLoading||(null!=b?b.labelLoading:b))?k:l,"function"===typeof k?k.call(d,{name:"labelLoading",hash:{},data:f}):k))+'" />\n        </h2>\n        <p class="fyre-profile-user-comments">\n            <span>'+m((c["default"]||b&&b["default"]||l).call(d,null!=(h=null!=(h=null!=b?b.comments:b)?h.stats:h)?h.content:h,0,{name:"default",hash:{},data:f}))+"</span> "+m((k=null!=
(k=c.labelComments||(null!=b?b.labelComments:b))?k:l,"function"===typeof k?k.call(d,{name:"labelComments",hash:{},data:f}):k))+'\n        </p>\n        <p class="fyre-profile-user-likes">\n            <span>'+m((c["default"]||b&&b["default"]||l).call(d,null!=(h=null!=(h=null!=b?b.comments:b)?h.stats:h)?h.likes:h,0,{name:"default",hash:{},data:f}))+"</span> "+m((k=null!=(k=c.labelLikes||(null!=b?b.labelLikes:b))?k:l,"function"===typeof k?k.call(d,{name:"labelLikes",hash:{},data:f}):k))+'\n        </p>\n    </section>\n    <article class="fyre-profile-body">\n'+
(null!=(h=c["if"].call(d,null!=b?b.aboutMe:b,{name:"if",hash:{},fn:a.program(3,f,0,e,g),inverse:a.noop,data:f}))?h:"")+'        <div class="fyre-profile-comments-header">'+m((k=null!=(k=c.recentComments||(null!=b?b.recentComments:b))?k:l,"function"===typeof k?k.call(d,{name:"recentComments",hash:{},data:f}):k))+"</div>\n"+(null!=(h=c["if"].call(d,null!=(h=null!=b?b.comments:b)?h.content:h,{name:"if",hash:{},fn:a.program(6,f,0,e,g),inverse:a.program(9,f,0,e,g),data:f}))?h:"")+'    </article>\n    <footer class="fyre-profile-footer">\n        <span class="fyre-powered-by">'+
m((k=null!=(k=c.poweredBy||(null!=b?b.poweredBy:b))?k:l,"function"===typeof k?k.call(d,{name:"poweredBy",hash:{},data:f}):k))+"</span>\n    </footer>\n</div>\n"},useData:!0,useDepths:!0});goog.exportSymbol("fyre.sp.templates.viewprofilev2",fyre.sp.templates.viewprofilev2);fyre.sp.ui.ProfileView=function(a,b){fyre.sp.ui.ProfileBase.call(this,a,b)};goog.inherits(fyre.sp.ui.ProfileView,fyre.sp.ui.ProfileBase);fyre.sp.ui.ProfileView.CLASSES={BACK_BTN:"fyre-cp-back-button",MORE_LINK:"fyre-profile-more-link"};
...
fyre.sp.client.ProfileClient.prototype.getProfile=function(a,b,c,d){var f=null,e="/api/v1.0/public/profile/";"object"===typeof fyre.sp.config.servers&&fyre.sp.config.servers.profile&&(e=fyre.sp.config.servers.profile+"/api/v1.0/public/profile/");var g=this;navigator.userAgent.match(/MSIE [5-9]/)&&d?(a=new XMLHttpRequest,a.addEventListener("load",function(){var a=goog.json.unsafeParse(this.responseText);b.call(g,a)}),a.addEventListener("error",c),a.addEventListener("abort",c),a.open("GET",e),a.send()):
(c=new fyre.io.XDR({url:e,success:b,failure:c}),goog.isString(a)&&(f={id:a}),c.send(f))};
fyre.sp.client.ProfileClient.baseProfile_=function(a){return function(b,c,d){var f=new goog.net.IframeIo;goog.events.listen(f,goog.net.EventType.COMPLETE,function(a){a=a.target;var b=a.getResponseJson();a.isSuccess()?b.code&&413===parseInt(b.code,10)?d(b):c(b):d(b)});if(!b.ownerDocument.querySelector("input[name=csrfmiddlewaretoken]")){var e=goog.dom.createDom(goog.dom.TagName.INPUT);e.setAttribute("type","hidden");e.setAttribute("name","csrfmiddlewaretoken");e.setAttribute("value",fyre.sp.config.csrftoken);
goog.dom.appendChild(b,e)}f.sendFromForm(b,fyre.sp.config.servers.profile+a)}};fyre.sp.client.ProfileClient.prototype.editProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/edit/");fyre.sp.client.ProfileClient.prototype.createProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/create/");fyre.sp.client.ProfileClient.prototype.completeProfile=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/complete/");
fyre.sp.client.ProfileClient.prototype.privacyProfileAccess=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/privacy/access/");fyre.sp.client.ProfileClient.prototype.privacyProfileDelete=fyre.sp.client.ProfileClient.baseProfile_("/api/v1.0/public/profile/privacy/delete/");
...
fyre.sp.controller.ProfileController.prototype.initialize=function(a){this.subscribe(fyre.sp.events.PROFILE_COMPLETE_INIT,this.handleGetCompleteProfile);this.subscribe(fyre.sp.events.PROFILE_COMPLETE_SUBMIT,this.handleCompleteProfile);this.subscribe(fyre.sp.events.PROFILE_GET_INIT,this.handleGetProfile);this.subscribe(fyre.sp.events.PROFILE_EDIT_INIT,this.handleGetEditProfile);this.subscribe(fyre.sp.events.PROFILE_EDIT_SUBMIT,this.handleEditProfile);this.subscribe(fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT,
this.handlePrivacyProfileAccess);this.subscribe(fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT,this.handlePrivacyProfileDelete);this.subscribe(fyre.sp.events.PROFILE_CREATE_SUBMIT,this.handleCreateProfile);this.model=a.model||new fyre.sp.model.Profile;this.client=a.profileClient||new fyre.sp.client.ProfileClient(this.messenger);this.adapter=fyre.sp.client.ProfileAdapter.getInstance();this.configureLogging("fyre.sp.controller.ProfileController")};
fyre.sp.controller.ProfileController.prototype.handleGetCompleteProfile=function(a){this.client.getCompleteProfile(a,goog.bind(this.handleGetCompleteProfileSuccess,this),goog.bind(this.handleGetCompleteProfileFailure,this))};
...
fyre.sp.controller.ProfileController.prototype.handleGetEditProfileFailure=function(a){a=this.adapter.adaptGetFailure(a);this.messenger.trigger(fyre.sp.events.PROFILE_EDIT_INIT_FAILURE,a)};fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileAccess=function(a){this.client.privacyProfileAccess(a,goog.bind(this.handlePrivacyProfileAccessSuccess,this),goog.bind(this.handlePrivacyProfileAccessFailure,this))};
fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileAccessSuccess=function(a){this.isSuccess(a)?this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_SUCCESS,a.data):this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_FAILURE,a)};fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileAccessFailure=function(a){data.code&&this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_FAILURE,a)};
fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileDelete=function(a){this.client.privacyProfileDelete(a,goog.bind(this.handlePrivacyProfileDeleteSuccess,this),goog.bind(this.handlePrivacyProfileDeleteFailure,this))};
fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileDeleteSuccess=function(a){this.isSuccess(a)?this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_SUCCESS,a.data):this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_FAILURE,a)};fyre.sp.controller.ProfileController.prototype.handlePrivacyProfileDeleteFailure=function(a){data.code&&this.messenger.trigger(fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_FAILURE,a)};
...
fyre.sp.widget.ProfileWidgetBase.prototype.initialize=function(a){fyre.sp.widget.ProfileWidgetBase.superClass_.initialize.call(this,a);this.profile=a.profile||new fyre.sp.model.Profile;this.client=a.profileClient||new fyre.sp.client.ProfileClient(this.messenger,{});this.controller=a.profileController||new fyre.sp.controller.ProfileController(this.messenger,{profileClient:this.client});this.view=this.getView(a);a.viewDecorator&&a.viewDecorator.decorate(this.view)};fyre.sp.widget.ProfileWidget=function(a,b){fyre.sp.widget.ProfileWidgetBase.call(this,a,b)};goog.inherits(fyre.sp.widget.ProfileWidget,fyre.sp.widget.ProfileWidgetBase);fyre.sp.widget.ProfileWidget.prototype.getView=function(a){this.profile=a.profile||new fyre.sp.model.Profile;return new fyre.sp.ui.ProfileView(this.messenger,{model:this.profile,el:a.el})};fyre.sp.templates.completeprofilev2="function"==typeof fyre.sp.templates.completeprofilev2?fyre.sp.templates.completeprofilev2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <li class="fyre-cp-profile-avatar">\n                    <fieldset>\n                        <label for="avatar">\n                            <img src="'+a((e=null!=(e=c.avatar||(null!=b?b.avatar:b))?e:g,"function"===typeof e?e.call(d,
{name:"avatar",hash:{},data:f}):e))+'" />\n                            <a class="fyre-cp-profile-avatar-change">'+a((e=null!=(e=c.changeAvatar||(null!=b?b.changeAvatar:b))?e:g,"function"===typeof e?e.call(d,{name:"changeAvatar",hash:{},data:f}):e))+'</a>\n                        </label>\n                        <div class="fyre-cp-profile-avatar-wrapper fyre-cp-hidden">\n                            <label for="avatar">'+a((e=null!=(e=c.labelAvatar||(null!=b?b.labelAvatar:b))?e:g,"function"===typeof e?
e.call(d,{name:"labelAvatar",hash:{},data:f}):e))+" ("+a((e=null!=(e=c.fileSizeLimit||(null!=b?b.fileSizeLimit:b))?e:g,"function"===typeof e?e.call(d,{name:"fileSizeLimit",hash:{},data:f}):e))+')</label>\n                            <div class="fyre-cp-file-picker">\n                                <div class="fyre-cp-file-picker">\n                                    <span>'+a((e=null!=(e=c.chooseFile||(null!=b?b.chooseFile:b))?e:g,"function"===typeof e?e.call(d,{name:"chooseFile",hash:{},data:f}):
e))+'</span>\n                                    <input type="file" name="image" class="fyre-cp-input-image" data-fyre-validate="fileType-image fileSize-1500000" size="16" />\n                                </div>\n                            </div>\n                            <span class="fyre-avatar-filename"></span>\n                        </div>\n                    </fieldset>\n                </li>\n'},3:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;
return'                    <label for="terms">\n                        '+a((e=null!=(e=c.termsAndConditionsIntro||(null!=b?b.termsAndConditionsIntro:b))?e:g,"function"===typeof e?e.call(d,{name:"termsAndConditionsIntro",hash:{},data:f}):e))+' <a href="'+a((e=null!=(e=c.tosLink||(null!=b?b.tosLink:b))?e:g,"function"===typeof e?e.call(d,{name:"tosLink",hash:{},data:f}):e))+'">'+a((e=null!=(e=c.termsAndConditions||(null!=b?b.termsAndConditions:b))?e:g,"function"===typeof e?e.call(d,{name:"termsAndConditions",
hash:{},data:f}):e))+"</a>\n                    </label>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'<div class="fyre-lfep2">\n    <span class="fyre-cp-back-button"></span>\n    '+k((c.include||b&&b.include||h).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-cp-two-column fyre-cp-profile-create">\n        <form class="fyre-cp-form" enctype="multipart/form-data" method="post">\n            <input type="hidden" name="token" value="'+
k((g=null!=(g=c.token||(null!=b?b.token:b))?g:h,"function"===typeof g?g.call(d,{name:"token",hash:{},data:f}):g))+'" />\n            <ul>\n                <li>\n                    <fieldset>\n                        <label for="username">'+k((g=null!=(g=c.labelUsername||(null!=b?b.labelUsername:b))?g:h,"function"===typeof g?g.call(d,{name:"labelUsername",hash:{},data:f}):g))+' *</label>\n                        <input type="text" name="displayName" class="fyre-cp-input-displayname" value="'+k((g=
null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" data-fyre-validate="required" />\n                    </fieldset>\n                </li>\n'+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:"")+'                <li>\n                    <fieldset>\n                        <label for="email">'+k((g=null!=(g=c.labelEmail||(null!=b?b.labelEmail:b))?g:h,
"function"===typeof g?g.call(d,{name:"labelEmail",hash:{},data:f}):g))+' *</label>\n                        <input type="text" name="email" class="fyre-cp-input-email" value="'+k((g=null!=(g=c.email||(null!=b?b.email:b))?g:h,"function"===typeof g?g.call(d,{name:"email",hash:{},data:f}):g))+'" data-fyre-validate="required email" />\n                    </fieldset>\n                </li>\n                <li class="fyre-cp-profile-confirm">\n'+(null!=(e=c["if"].call(d,null!=b?b.tosLink:b,{name:"if",
hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+'                    <div class="fyre-cp-form-btns">\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="'+k((g=null!=(g=c.create||(null!=b?b.create:b))?g:h,"function"===typeof g?g.call(d,{name:"create",hash:{},data:f}):g))+'" />\n                    </div>\n                </li>\n            </ul>\n        </form>\n    </section>\n</div>'},useData:!0});
...
hash:{},data:f}):e))+'" />\n'},3:function(a,b,c,d,f){return'                <a name="passwords" class="fyre-cp-edit-tab">Password</a>\n'},5:function(a,b,c,d,f){return'                    <li>\n                        <label for="image">Avatar</label>\n                        <input type="file" name="image" class="fyre-cp-input-image" />\n                    </li>\n'},7:function(a,b,c,d,f){var e;d=a.lambda;var g=a.escapeExpression;return'                                <option value="'+g(d(null!=b?
b.name:b,b))+'" '+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.selected:b,{name:"if",hash:{},fn:a.program(8,f,0),inverse:a.noop,data:f}))?e:"")+">"+g(d(null!=b?b.name:b,b))+"</option>\n"},8:function(a,b,c,d,f){return'selected="selected"'},10:function(a,b,c,d,f){return'checked="checked"'},12:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-passwords fyre-cp-hidden">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-passwords">\n                <input type="hidden" name="id" value="'+
a((e=null!=(e=c.id||(null!=b?b.id:b))?e:g,"function"===typeof e?e.call(d,{name:"id",hash:{},data:f}):e))+'" />\n                <input type="hidden" name="displayName" value="'+a((e=null!=(e=c.displayName||(null!=b?b.displayName:b))?e:g,"function"===typeof e?e.call(d,{name:"displayName",hash:{},data:f}):e))+'" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="passwords" />\n                <ul class="fyre-cp-edit-form-profile">\n                    <li>\n                        <label for="password_old">Old Password *</label>\n                        <input type="password" name="password_old" class="fyre-cp-input-password_old" data-fyre-validate="required" autocomplete="off"/>\n                    </li>\n                    <li>\n                        <label for="password">New Password *</label>\n                        <input type="password" name="password" class="fyre-cp-input-password" data-fyre-validate="required" autocomplete="off"/>\n                    </li>\n                    <li>\n                        <label for="password_verify">New Password *</label>\n                        <input type="password" name="password_verify" class="fyre-cp-input-password_verify" data-fyre-validate="required" autocomplete="off"/>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Close" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Cancel" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="Save" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n'},
compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'\x3c!-- edit profile template --\x3e\n<div class="fyre-profile">\n    <span class="fyre-cp-back-button"></span>\n    <header class="fyre-cp-modal-header">\n        <img src="'+k((c.media_url||b&&b.media_url||h).call(d,"images/default/logo.png",{name:"media_url",hash:{},data:f}))+'" align="right" alt="Livefyre" />\n    </header>\n    <section class="fyre-profile-section">\n'+(null!=
(e=c["if"].call(d,null!=b?b.avatar:b,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:"")+'        <h2 class="fyre-profile-displayname">\n            <span>'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'</span>\n            <a href="#" class="fyre-profile-edit-link"></a>\n            <img class="fyre-loader" src="'+k((c.media_url||b&&b.media_url||h).call(d,"images/default/loader.gif",{name:"media_url",
hash:{},data:f}))+'" alt="Loading" />\n        </h2>\n        <input type="text" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-input-displayname fyre-cp-hidden" />\n        <p class="fyre-profile-user-comments">\n            <span>'+k((c["default"]||b&&b["default"]||h).call(d,null!=(e=null!=b?b.comments:b)?e.user_comment_count:e,0,{name:"default",hash:{},data:f}))+'</span> Comments\n        </p>\n        <p class="fyre-profile-user-likes">\n            <span>'+
k((c["default"]||b&&b["default"]||h).call(d,null!=(e=null!=b?b.comments:b)?e.user_liked_count:e,0,{name:"default",hash:{},data:f}))+'</span> Likes\n        </p>\n    </section>\n    <nav class="fyre-cp-edit-nav">\n        <ul class="fyre-cp-edit-tabs">\n            <li class="fyre-cp-active">\n                <a name="profile" class="fyre-cp-edit-tab">Profile</a>\n            </li>\n            <li>\n                <a name="notifications" class="fyre-cp-edit-tab">Notifications</a>\n            </li>\n            <li>\n'+
(null!=(e=c["if"].call(d,null!=b?b.showPassword:b,{name:"if",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+'            </li>\n        </ul>\n    </nav>\n    <section class="fyre-cp-edit">\n        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-profile">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-profile">\n                <input type="hidden" name="id" value="'+k((g=null!=(g=c.id||(null!=b?b.id:
b))?g:h,"function"===typeof g?g.call(d,{name:"id",hash:{},data:f}):g))+'" />\n                <input type="hidden" name="displayName" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="profile" />\n                <ul class="fyre-cp-edit-form-profile">\n'+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",
hash:{},fn:a.program(5,f,0),inverse:a.noop,data:f}))?e:"")+'                    <li>\n                        <label for="email">Email address *</label>\n                        <input type="text" name="email" value="'+k((g=null!=(g=c.email||(null!=b?b.email:b))?g:h,"function"===typeof g?g.call(d,{name:"email",hash:{},data:f}):g))+'" class="fyre-cp-input-email" data-fyre-validate="email" />\n                    </li>\n                    <li>\n                        <label for="givenName">First name</label>\n                        <input type="text" name="givenName" value="'+
k((g=null!=(g=c.givenName||(null!=b?b.givenName:b))?g:h,"function"===typeof g?g.call(d,{name:"givenName",hash:{},data:f}):g))+'" class="fyre-cp-input-givenName" />\n                    </li>\n                    <li>\n                        <label for="familyName">Last name</label>\n                        <input type="text" name="familyName" value="'+k((g=null!=(g=c.familyName||(null!=b?b.familyName:b))?g:h,"function"===typeof g?g.call(d,{name:"familyName",hash:{},data:f}):g))+'" class="fyre-cp-input-familyName" />\n                    </li>\n                    <li>\n                        <label for="currentLocation">Location</label>\n                        <input type="text" name="currentLocation" value="'+
k((g=null!=(g=c.currentLocation||(null!=b?b.currentLocation:b))?g:h,"function"===typeof g?g.call(d,{name:"currentLocation",hash:{},data:f}):g))+'" class="fyre-cp-input-currentLocation" />\n                    </li>\n                    <li class="fyre-cp-edit-bio">\n                        <label for="aboutMe">Bio</label>\n                        <textarea name="aboutMe" class="fyre-input-aboutMe" fyre-validate="maxlength-500" maxlength="500">'+k((g=null!=(g=c.aboutMe||(null!=b?b.aboutMe:b))?g:h,
"function"===typeof g?g.call(d,{name:"aboutMe",hash:{},data:f}):g))+'</textarea>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Close" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Cancel" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="Save" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-notifications fyre-cp-hidden">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-notifications">\n                <input type="hidden" name="id" value="'+
k((g=null!=(g=c.id||(null!=b?b.id:b))?g:h,"function"===typeof g?g.call(d,{name:"id",hash:{},data:f}):g))+'" />\n                <input type="hidden" name="displayName" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="notifications" />\n                <ul class="fyre-cp-edit-form-notifications">\n                    <li>\n                        <label for="email_comments">Email comments in conversations I follow</label>\n                        <select name="email_comments"class="fyre-cp-input-email_comments">\n'+
(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.comments:e,{name:"each",hash:{},fn:a.program(7,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="email_likes">Email when someone likes my comment</label>\n                        <select name="email_likes" class="fyre-cp-input-email_likes">\n'+(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.likes:e,{name:"each",
hash:{},fn:a.program(7,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="email_replies">Email when someone replies to me</label>\n                        <select name="email_replies" class="fyre-cp-input-email_replies">\n'+(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.replies:e,{name:"each",hash:{},fn:a.program(7,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="auto_follow">Automatically follow conversations I join</label>\n                        <input type="checkbox" name="auto_follow" class="fyre-cp-input-auto_follow" value="true" '+
(null!=(e=c["if"].call(d,null!=b?b.auto_follow:b,{name:"if",hash:{},fn:a.program(10,f,0),inverse:a.noop,data:f}))?e:"")+' />\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Close" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="Cancel" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="Save" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n'+
(null!=(e=c["if"].call(d,null!=b?b.showPassword:b,{name:"if",hash:{},fn:a.program(12,f,0),inverse:a.noop,data:f}))?e:"")+"    </section>\n</div>\n"},useData:!0});goog.exportSymbol("fyre.sp.templates.editprofile",fyre.sp.templates.editprofile);fyre.sp.ui.ProfileFormBase=function(a,b){fyre.sp.ui.ProfileBase.call(this,a,b)};goog.inherits(fyre.sp.ui.ProfileFormBase,fyre.sp.ui.ProfileBase);fyre.sp.ui.ProfileFormBase.prototype.EVENTS={};fyre.sp.ui.ProfileFormBase.prototype.getEvent=function(a){return this.EVENTS[a]};fyre.sp.ui.ProfileFormBase.CLASSES={AVATAR_FILENAME_CONTAINER:"fyre-avatar-filename",AVATAR_UPLOAD_BTN:"fyre-cp-input-image",BACK_BTN:"fyre-cp-back-button",CANCEL_BTN:"fyre-cp-form-cancel-btn",FORM:"fyre-cp-form",REAL_TIME:"fyre-real-time"};
...
fyre.sp.ui.ProfileFormBase.prototype.handleFormSubmit=function(a){a.preventDefault();this.validator.run()&&(a=this.getForm(),this.messenger.trigger(this.getEvent("form-submit"),a.element))};fyre.sp.ui.ProfileFormBase.prototype.privacyFormSubmit=function(a,b){a.preventDefault();this.messenger.trigger(b,this.getPrivacyForm().element)};fyre.sp.ui.ProfileFormBase.prototype.handleFormErrors=function(a){a=this.prepareErrors(a);this.validator.writeErrorsToDom(a)};
fyre.sp.ui.ProfileFormBase.prototype.handleInputKeyUp=function(a){a.preventDefault();this.validator.run(a.target.name)};fyre.sp.ui.ProfileFormBase.prototype.prepareErrors=function(a){var b,c=[],d=this.getForm();goog.object.every(a.errors,function(b,c){var d=b[0].toLowerCase().replace(/\W/g,"");this.model.get(d)&&(a.errors[c]=[this.model.get(d)])},this);goog.object.forEach(a.errors,function(a,e){b=d.getByClass("fyre-cp-input-"+e.toLowerCase());c.push([b,a[0]])});return c};
fyre.sp.ui.ProfileFormBase.prototype.handleFormCancel=function(a){a.preventDefault();this.close()};fyre.sp.ui.ProfileFormBase.prototype.handleFormSubmitSuccess=function(){this.close()};
fyre.sp.ui.ProfileFormBase.prototype.registerControls=function(){var a=goog.events.EventType;this.registerImageFileControl();this.registerControl(this.getForm(),a.SUBMIT,this.handleFormSubmit);this.registerControl(this.getCancelButton(),a.CLICK,this.handleFormCancel);this.registerControl(this.getRealTimeValidation().all(),a.KEYUP,this.handleInputKeyUp);this.validator=new fyre.forms.validate(this.getForm())};
...
fyre.sp.app.ProfileBase.prototype.viewProfile=function(a){this.messenger.trigger(fyre.sp.events.PROFILE_GET_INIT,a)};fyre.sp.app.ProfileBase.AUTH_TYPES=fyre.sp.app.ProfileBase.prototype.AUTH_TYPES={REDIRECT:"redirect",WINDOW:"window"};fyre.sp.app.ProfileBase.prototype.setAuthType=function(a){var b=fyre.sp.app.ProfileBase.AUTH_TYPES;return goog.object.some(b,function(b){return b===a})?a:b.REDIRECT};fyre.sp.templates.createprofilev2="function"==typeof fyre.sp.templates.createprofilev2?fyre.sp.templates.createprofilev2:fyre.lib.Handlebars.template({1:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <li class="fyre-cp-profile-avatar">\n                    <fieldset>\n                        <label for="image">'+a((e=null!=(e=c.labelAvatar||(null!=b?b.labelAvatar:b))?e:g,"function"===typeof e?e.call(d,{name:"labelAvatar",hash:{},data:f}):
e))+" ("+a((e=null!=(e=c.fileSizeLimit||(null!=b?b.fileSizeLimit:b))?e:g,"function"===typeof e?e.call(d,{name:"fileSizeLimit",hash:{},data:f}):e))+')</label>\n                        <div class="fyre-cp-file-picker">\n                            <span>'+a((e=null!=(e=c.chooseFile||(null!=b?b.chooseFile:b))?e:g,"function"===typeof e?e.call(d,{name:"chooseFile",hash:{},data:f}):e))+'</span>\n                            <input type="file" name="image" class="fyre-cp-input-image" data-fyre-validate="fileType-image fileSize-1500000" size="16" />\n                        </div>\n                        <span class="fyre-avatar-filename"></span>\n                    </fieldset>\n                </li>\n'},
3:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                    <label for="terms">\n                        '+a((e=null!=(e=c.termsAndConditionsIntro||(null!=b?b.termsAndConditionsIntro:b))?e:g,"function"===typeof e?e.call(d,{name:"termsAndConditionsIntro",hash:{},data:f}):e))+' <a target="_blank" href="'+a((e=null!=(e=c.tosLink||(null!=b?b.tosLink:b))?e:g,"function"===typeof e?e.call(d,{name:"tosLink",hash:{},data:f}):e))+'">'+a((e=null!=(e=c.termsAndConditions||
(null!=b?b.termsAndConditions:b))?e:g,"function"===typeof e?e.call(d,{name:"termsAndConditions",hash:{},data:f}):e))+"</a>\n                    </label>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'<div class="fyre-lfep2">\n    <span class="fyre-cp-back-button"></span>\n    '+k((c.include||b&&b.include||h).call(d,"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-cp-two-column fyre-cp-profile-create">\n        <form class="fyre-cp-form" enctype="multipart/form-data" method="post">\n            <input type="hidden" name="redirect_url" value="'+
k((g=null!=(g=c.redirect_url||(null!=b?b.redirect_url:b))?g:h,"function"===typeof g?g.call(d,{name:"redirect_url",hash:{},data:f}):g))+'" />\n            <div class="fyre-cp-form-header">'+k((g=null!=(g=c.createANewAccount||(null!=b?b.createANewAccount:b))?g:h,"function"===typeof g?g.call(d,{name:"createANewAccount",hash:{},data:f}):g))+'</div>\n            <ul>\n                <li>\n                    <fieldset>\n                        <label for="username">'+k((g=null!=(g=c.labelUsername||(null!=
b?b.labelUsername:b))?g:h,"function"===typeof g?g.call(d,{name:"labelUsername",hash:{},data:f}):g))+' *</label>\n                        <input type="text" class="fyre-cp-input-displayname" name="displayName" id="fyreDisplayName" data-fyre-validate="required" />\n                    </fieldset>\n                </li>\n'+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:"")+'                <li>\n                    <fieldset>\n                        <label for="password">'+
k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:f}):g))+' *</label>\n                        <input type="password" name="password" id="fyrePassword" class="fyre-cp-input-password fyre-real-time" data-fyre-validate="required password-fyreDisplayName" autocomplete="off" />\n                    </fieldset>\n                </li>\n                <li>\n                    <fieldset>\n                        <label for="password_dup">'+
k((g=null!=(g=c.labelConfirmPassword||(null!=b?b.labelConfirmPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelConfirmPassword",hash:{},data:f}):g))+' *</label>\n                        <input type="password" name="password_dup" class="fyre-cp-input-password_dup" data-fyre-validate="required matches-'+k((g=null!=(g=c.labelPassword||(null!=b?b.labelPassword:b))?g:h,"function"===typeof g?g.call(d,{name:"labelPassword",hash:{},data:f}):g))+'-fyrePassword" autocomplete="off" />\n                    </fieldset>\n                </li>\n                <li>\n                    <fieldset>\n                        <label for="email">'+
k((g=null!=(g=c.labelEmail||(null!=b?b.labelEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"labelEmail",hash:{},data:f}):g))+' *</label>\n                        <input type="text" name="email" class="fyre-cp-input-email" data-fyre-validate="required email" />\n                    </fieldset>\n                </li>\n                <li class="fyre-cp-profile-confirm">\n'+(null!=(e=c["if"].call(d,null!=b?b.tosLink:b,{name:"if",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+'                    <div class="fyre-cp-form-btns">\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="'+
k((g=null!=(g=c.signUp||(null!=b?b.signUp:b))?g:h,"function"===typeof g?g.call(d,{name:"signUp",hash:{},data:f}):g))+'" />\n                    </div>\n                </li>\n            </ul>\n        </form>\n    </section>\n</div>\n'},useData:!0});goog.exportSymbol("fyre.sp.templates.createprofilev2",fyre.sp.templates.createprofilev2);fyre.sp.templates.safarioverlay="function"==typeof fyre.sp.templates.safarioverlay?fyre.sp.templates.safarioverlay:fyre.lib.Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){return'<div class="fyre-overlay">\n  <div class="fyre-overlay-inner">\n    <div class="fyre-overlay-title">\n      Safari User\n    </div>\n    <p>\n      Safari requires that third party cookies be enabled in your browser to create new accounts.\n    </p>\n    <p>\n      <a class="fyre-overlay-link" href="http://answers.livefyre.com/developers/reference/safari-cookies/" target="_blank">Click here</a> to be redirected to the Livefyre site for more information on how to enable third party cookies.\n    </p>\n    <button class="fyre-overlay-close">OK</button>\n  </div>\n</div>'},
...
hash:{},data:f}):e))+'" />\n'},3:function(a,b,c,d,f){var e;return'            <li>\n                <a name="passwords" class="fyre-cp-edit-tab">'+a.escapeExpression((e=null!=(e=c.labelPassword||(null!=b?b.labelPassword:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"labelPassword",hash:{},data:f}):e))+"</a>\n            </li>\n"},5:function(a,b,c,d,f){var e;return'            <li>\n                <a name="privacy" class="fyre-cp-edit-tab">'+a.escapeExpression((e=null!=(e=
c.labelPrivacy||(null!=b?b.labelPrivacy:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"labelPrivacy",hash:{},data:f}):e))+"</a>\n            </li>\n"},7:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;return'                <div class="fyre-cp-profile-avatar">\n                    <fieldset>\n                        <label for="image">'+a((e=null!=(e=c.labelAvatar||(null!=b?b.labelAvatar:b))?e:g,"function"===typeof e?e.call(d,{name:"labelAvatar",
hash:{},data:f}):e))+" ("+a((e=null!=(e=c.fileSizeLimit||(null!=b?b.fileSizeLimit:b))?e:g,"function"===typeof e?e.call(d,{name:"fileSizeLimit",hash:{},data:f}):e))+')</label>\n                        <div class="fyre-cp-file-picker">\n                            <span>'+a((e=null!=(e=c.chooseFile||(null!=b?b.chooseFile:b))?e:g,"function"===typeof e?e.call(d,{name:"chooseFile",hash:{},data:f}):e))+'</span>\n                            <input type="file" name="image" class="fyre-cp-input-image" data-fyre-validate="fileType-image fileSize-1500000" size="16" />\n                        </div>\n                        <span class="fyre-avatar-filename"></span>\n                    </fieldset>\n                </div>\n'},
9:function(a,b,c,d,f){var e;d=a.lambda;var g=a.escapeExpression;return'                                <option value="'+g(d(null!=b?b.name:b,b))+'" '+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.selected:b,{name:"if",hash:{},fn:a.program(10,f,0),inverse:a.noop,data:f}))?e:"")+">"+g(d(null!=b?b.name:b,b))+"</option>\n"},10:function(a,b,c,d,f){return'selected="selected"'},12:function(a,b,c,d,f){return'checked="checked"'},14:function(a,b,c,d,f){var e;d=null!=b?b:{};var g=c.helperMissing;a=a.escapeExpression;
return'        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-passwords fyre-cp-hidden">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-passwords">\n                <input type="hidden" name="id" value="'+a((e=null!=(e=c.id||(null!=b?b.id:b))?e:g,"function"===typeof e?e.call(d,{name:"id",hash:{},data:f}):e))+'" />\n                <input type="hidden" name="displayName" value="'+a((e=null!=(e=c.displayName||(null!=
b?b.displayName:b))?e:g,"function"===typeof e?e.call(d,{name:"displayName",hash:{},data:f}):e))+'" id="fyreDisplayName" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="passwords" />\n                <ul class="fyre-cp-edit-form-profile">\n                    <li>\n                        <fieldset>\n                            <label for="password_old">'+a((e=null!=(e=c.oldPassword||(null!=b?b.oldPassword:b))?e:g,"function"===typeof e?e.call(d,
{name:"oldPassword",hash:{},data:f}):e))+' *</label>\n                            <input type="password" name="password_old" class="fyre-cp-input-password_old" data-fyre-validate="required" autocomplete="off"/>\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="password">'+a((e=null!=(e=c.newPassword||(null!=b?b.newPassword:b))?e:g,"function"===typeof e?e.call(d,{name:"newPassword",
hash:{},data:f}):e))+' *</label>\n                            <input type="password" name="password" class="fyre-cp-input-password fyre-real-time" data-fyre-validate="required password-fyreDisplayName" autocomplete="off"/>\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="password_verify">'+a((e=null!=(e=c.verifyPassword||(null!=b?b.verifyPassword:b))?e:g,"function"===typeof e?e.call(d,
{name:"verifyPassword",hash:{},data:f}):e))+' *</label>\n                            <input type="password" name="password_verify" class="fyre-cp-input-password_verify" data-fyre-validate="required" autocomplete="off"/>\n                        </fieldset>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+
a((e=null!=(e=c.formInputCloseButtonText||(null!=b?b.formInputCloseButtonText:b))?e:g,"function"===typeof e?e.call(d,{name:"formInputCloseButtonText",hash:{},data:f}):e))+'" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+a((e=null!=(e=c.formInputCancelButtonText||(null!=b?b.formInputCancelButtonText:b))?e:g,"function"===typeof e?e.call(d,
{name:"formInputCancelButtonText",hash:{},data:f}):e))+'" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="'+a((e=null!=(e=c.formInputSaveButtonText||(null!=b?b.formInputSaveButtonText:b))?e:g,"function"===typeof e?e.call(d,{name:"formInputSaveButtonText",hash:{},data:f}):e))+'" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n'},16:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;
return'        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-privacy fyre-cp-hidden">\n            <div class="privacy-form-wrapper">\n'+(null!=(e=c["if"].call(d,null!=b?b.privacyHeader:b,{name:"if",hash:{},fn:a.program(17,f,0),inverse:a.noop,data:f}))?e:"")+'                <div>\n                    <form class="privacy-form" enctype="mutipart/form-data" method="post">\n                        <div class="privacy-action-wrapper">\n                            <p class="privacy-action-title">Request My Data</p>\n                            <p class="privacy-action-desc">Request a report of all data for this account. Sends a report to the email address on file.</p>\n                            <div class="privacy-radio-wrapper">\n                                <input class="privacy-radio" name="privacy-request-type" type="radio" value="'+
k((g=null!=(g=c.requestTypeAccess||(null!=b?b.requestTypeAccess:b))?g:h,"function"===typeof g?g.call(d,{name:"requestTypeAccess",hash:{},data:f}):g))+'"/><label>Request My Data</label>\n                            </div>\n                        </div>\n                        <div class="privacy-action-wrapper">\n                            <p class="privacy-action-title">Delete My Account</p>\n                            <p class="privacy-action-desc">Delete your account and all content created by that account. This cannot be undone.</p>\n                            <div class="privacy-radio-wrapper">\n                                <input class="privacy-radio" name="privacy-request-type" type="radio" value="'+
k((g=null!=(g=c.requestTypeDelete||(null!=b?b.requestTypeDelete:b))?g:h,"function"===typeof g?g.call(d,{name:"requestTypeDelete",hash:{},data:f}):g))+'"/><label>Delete My Account and All Content</label>\n                            </div>\n                         </div>\n                        <div class="privacy-button-set privacy-main-button-set">\n'+(null!=(e=c["if"].call(d,null!=b?b.showRecaptcha:b,{name:"if",hash:{},fn:a.program(19,f,0),inverse:a.program(21,f,0),data:f}))?e:"")+"                        </div>\n                    </form>\n                </div>\n"+
(null!=(e=c["if"].call(d,null!=b?b.privacyFooter:b,{name:"if",hash:{},fn:a.program(23,f,0),inverse:a.noop,data:f}))?e:"")+'             </div>\n            <div class="privacy-result-wrapper fyre-cp-hidden">\n                <div class="privacy-error fyre-cp-hidden">\n                    <div class="privacy-error-message">\n                        <p class="error-description">Error: Your request did not complete.</p>\n                        <p class="error-description">If you already submitted this request, you must wait until the last request completes, or at least up to 48 hours. Your previous request generated a link that you can check for updated information.</p>\n                        <p class="error-description">If you did not previously submit a request or it has been more than 48 hours, contact <a href="mailto:prioritysupport@livefyre.com">prioritysupport@livefyre.com</a> for assistance.</p>\n                    </div>\n                    <div class="privacy-button-set">\n                        <a class="privacy-error-close privacy-button primary-button">Return to Privacy Settings</a>\n                    </div>\n                </div>\n                <div class="privacy-access-result privacy-result fyre-cp-hidden">\n                    <div>\n                        <p class="success-header">Request Successful</p>\n                        <p class="success-message">We received your request. Your request ID is <b class="access-request-id"></b>.</p>\n                        <p class="success-message">We will send a link to view the status of your request to the email for this account. You can also see the report <a target="_blank" class="access-report-page-url report-url">here</a>.</p>\n                        <p class="success-message">Save the request ID and report link for your records. Depending on the amount of information contained in your account, your report should complete within an hour.</p>\n                    </div>\n                    <div class="privacy-button-set">\n                        <a class="privacy-access-result-close privacy-button primary-button">Return to Privacy Settings</a>\n                    </div>\n                </div>\n                <div class="privacy-delete-result privacy-result fyre-cp-hidden">\n                    <div>\n                        <p class="success-header">Request Successful</p>\n                        <p class="success-message">We received your request to delete your acount. Your request ID is <b class="delete-request-id"></b>.</p>\n                        <p class="success-message">We will send a link to view the status of your request to the email for this account. You can also see the report <a target="_blank" class="delete-report-page-url report-url">here</a>.</p>\n                        <p class="success-message">Save the request ID and report link for your records. Depending on the amount of information contained in your account, your report should complete within an hour.</p>\n                        <div class="delete-result-warning">\n                            <p class="warning-header">NOTICE!</p>\n                            <p class="warning-message">Once your account has been deleted, you will not be able to access this screen. Make sure to save the link above for future reference.</p>\n                        </div>\n                    </div>\n                    <div class="privacy-button-set">\n                        <a class="privacy-delete-result-close privacy-button primary-button">Close</a>\n                    </div>\n                </div>\n            </div>\n             <div class="privacy-delete-confirmation fyre-cp-hidden">\n                <p class="confirmation-label">Are you sure you want to delete this account?</p>\n                <p class="confirmation-warning">This action cannot be undone.</p>\n                <div class="privacy-button-set">\n                    <input class="privacy-delete-confirm privacy-button primary-button" type="submit" value="Confirm"/>\n                    <input class="privacy-delete-cancel privacy-button secondary-button" type="submit" value="Cancel"/>\n                </div>\n            </div>\n        </section>\n'},
17:function(a,b,c,d,f){var e;return'                <div class="privacy-header">\n                    <p>'+a.escapeExpression((e=null!=(e=c.privacyHeader||(null!=b?b.privacyHeader:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"privacyHeader",hash:{},data:f}):e))+"</p>\n                </div>\n"},19:function(a,b,c,d,f){var e;return'                            <div class="g-recaptcha"></div>\n                            <div>\n                                <input id="'+a.escapeExpression((e=
null!=(e=c.privacySubmitButtonId||(null!=b?b.privacySubmitButtonId:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"privacySubmitButtonId",hash:{},data:f}):e))+'" disabled type="submit" class="privacy-button primary-button" value="Submit" />\n                                <input type="submit" class="privacy-form-cancel privacy-button secondary-button" value="Cancel" />\n                            </div>\n'},21:function(a,b,c,d,f){var e;return'                            <div>\n                                <input id="'+
a.escapeExpression((e=null!=(e=c.privacySubmitButtonId||(null!=b?b.privacySubmitButtonId:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"privacySubmitButtonId",hash:{},data:f}):e))+'" type="submit" class="privacy-button primary-button" value="Submit" />\n                                <input type="submit" class="privacy-form-cancel privacy-button secondary-button" value="Cancel" />\n                            </div>\n'},23:function(a,b,c,d,f){var e;return'                <div class="privacy-footer">\n                    <p>'+
a.escapeExpression((e=null!=(e=c.privacyFooter||(null!=b?b.privacyFooter:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"privacyFooter",hash:{},data:f}):e))+"</p>\n                </div>\n"},compiler:[7,">= 4.0.0"],main:function(a,b,c,d,f){var e,g;d=null!=b?b:{};var h=c.helperMissing,k=a.escapeExpression;return'\x3c!-- edit profile template --\x3e\n<div class="fyre-profile fyre-lfep2">\n    <span class="fyre-cp-back-button"></span>\n    '+k((c.include||b&&b.include||h).call(d,
"fyre.sp.templates.headerv2",{name:"include",hash:{},data:f}))+'\n    <section class="fyre-profile-section">\n'+(null!=(e=c["if"].call(d,null!=b?b.avatar:b,{name:"if",hash:{},fn:a.program(1,f,0),inverse:a.noop,data:f}))?e:"")+'        <h2 class="fyre-profile-displayname">\n            <span>'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'</span>\n            <a href="#" class="fyre-profile-edit-link"></a>\n            <img class="fyre-loader" src="'+
k((c.media_url||b&&b.media_url||h).call(d,"images/default/loader.gif",{name:"media_url",hash:{},data:f}))+'" alt="Loading" />\n        </h2>\n        <input type="text" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-input-displayname fyre-cp-hidden" />\n        <p class="fyre-profile-user-comments">\n            <span>'+k((c["default"]||b&&b["default"]||h).call(d,null!=(e=null!=(e=null!=
b?b.comments:b)?e.stats:e)?e.content:e,0,{name:"default",hash:{},data:f}))+"</span> "+k((g=null!=(g=c.labelComments||(null!=b?b.labelComments:b))?g:h,"function"===typeof g?g.call(d,{name:"labelComments",hash:{},data:f}):g))+'\n        </p>\n        <p class="fyre-profile-user-likes">\n            <span>'+k((c["default"]||b&&b["default"]||h).call(d,null!=(e=null!=(e=null!=b?b.comments:b)?e.stats:e)?e.likes:e,0,{name:"default",hash:{},data:f}))+"</span> "+k((g=null!=(g=c.labelLikes||(null!=b?b.labelLikes:
b))?g:h,"function"===typeof g?g.call(d,{name:"labelLikes",hash:{},data:f}):g))+'\n        </p>\n    </section>\n    <nav class="fyre-cp-edit-nav">\n        <ul class="fyre-cp-edit-tabs">\n            <li class="fyre-cp-active">\n                <a name="profile" class="fyre-cp-edit-tab">'+k((g=null!=(g=c.labelProfile||(null!=b?b.labelProfile:b))?g:h,"function"===typeof g?g.call(d,{name:"labelProfile",hash:{},data:f}):g))+'</a>\n            </li>\n            <li>\n                <a name="notifications" class="fyre-cp-edit-tab">'+
k((g=null!=(g=c.labelNotifications||(null!=b?b.labelNotifications:b))?g:h,"function"===typeof g?g.call(d,{name:"labelNotifications",hash:{},data:f}):g))+"</a>\n            </li>\n"+(null!=(e=c["if"].call(d,null!=b?b.showPassword:b,{name:"if",hash:{},fn:a.program(3,f,0),inverse:a.noop,data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.showPrivacy:b,{name:"if",hash:{},fn:a.program(5,f,0),inverse:a.noop,data:f}))?e:"")+'        </ul>\n    </nav>\n    <section class="fyre-cp-edit">\n        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-profile">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-profile">\n                <input type="hidden" name="id" value="'+
k((g=null!=(g=c.id||(null!=b?b.id:b))?g:h,"function"===typeof g?g.call(d,{name:"id",hash:{},data:f}):g))+'" />\n                <input type="hidden" name="displayName" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="profile" />\n\n'+(null!=(e=c.unless.call(d,null!=b?b.is_mobile:b,{name:"unless",hash:{},
fn:a.program(7,f,0),inverse:a.noop,data:f}))?e:"")+'\n                <ul class="fyre-cp-edit-form-profile">\n                    <li>\n                        <fieldset>\n                            <label for="givenName">'+k((g=null!=(g=c.firstName||(null!=b?b.firstName:b))?g:h,"function"===typeof g?g.call(d,{name:"firstName",hash:{},data:f}):g))+'</label>\n                            <input type="text" name="givenName" value="'+k((g=null!=(g=c.givenName||(null!=b?b.givenName:b))?g:h,"function"===
typeof g?g.call(d,{name:"givenName",hash:{},data:f}):g))+'" class="fyre-cp-input-givenName" />\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="familyName">'+k((g=null!=(g=c.lastName||(null!=b?b.lastName:b))?g:h,"function"===typeof g?g.call(d,{name:"lastName",hash:{},data:f}):g))+'</label>\n                            <input type="text" name="familyName" value="'+k((g=null!=(g=c.familyName||
(null!=b?b.familyName:b))?g:h,"function"===typeof g?g.call(d,{name:"familyName",hash:{},data:f}):g))+'" class="fyre-cp-input-familyName" />\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="email">'+k((g=null!=(g=c.labelEmail||(null!=b?b.labelEmail:b))?g:h,"function"===typeof g?g.call(d,{name:"labelEmail",hash:{},data:f}):g))+' *</label>\n                            <input type="text" name="email" value="'+
k((g=null!=(g=c.email||(null!=b?b.email:b))?g:h,"function"===typeof g?g.call(d,{name:"email",hash:{},data:f}):g))+'" class="fyre-cp-input-email" data-fyre-validate="email" />\n                        </fieldset>\n                    </li>\n                    <li>\n                        <fieldset>\n                            <label for="currentLocation">'+k((g=null!=(g=c.location||(null!=b?b.location:b))?g:h,"function"===typeof g?g.call(d,{name:"location",hash:{},data:f}):g))+'</label>\n                            <input type="text" name="currentLocation" value="'+
k((g=null!=(g=c.currentLocation||(null!=b?b.currentLocation:b))?g:h,"function"===typeof g?g.call(d,{name:"currentLocation",hash:{},data:f}):g))+'" class="fyre-cp-input-currentLocation" />\n                        </fieldset>\n                    </li>\n                    <li class="fyre-cp-edit-bio">\n                        <fieldset>\n                            <label for="aboutMe">'+k((g=null!=(g=c.bio||(null!=b?b.bio:b))?g:h,"function"===typeof g?g.call(d,{name:"bio",hash:{},data:f}):g))+'</label>\n                            <textarea name="aboutMe" class="fyre-input-aboutMe" fyre-validate="maxlength-500" maxlength="500">'+
(null!=(e=(g=null!=(g=c.aboutMe||(null!=b?b.aboutMe:b))?g:h,"function"===typeof g?g.call(d,{name:"aboutMe",hash:{},data:f}):g))?e:"")+'</textarea>\n                        </fieldset>\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+
k((g=null!=(g=c.formInputCloseButtonText||(null!=b?b.formInputCloseButtonText:b))?g:h,"function"===typeof g?g.call(d,{name:"formInputCloseButtonText",hash:{},data:f}):g))+'" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+k((g=null!=(g=c.formInputCancelButtonText||(null!=b?b.formInputCancelButtonText:b))?g:h,"function"===typeof g?g.call(d,
{name:"formInputCancelButtonText",hash:{},data:f}):g))+'" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="'+k((g=null!=(g=c.formInputSaveButtonText||(null!=b?b.formInputSaveButtonText:b))?g:h,"function"===typeof g?g.call(d,{name:"formInputSaveButtonText",hash:{},data:f}):g))+'" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n        <section class="fyre-cp-edit-tab-content fyre-cp-edit-tab-notifications fyre-cp-hidden">\n            <form class="fyre-cp-form fyre-cp-edit-form" enctype="multipart/form-data" method="post" name="fyre-cp-form-notifications">\n                <input type="hidden" name="id" value="'+
k((g=null!=(g=c.id||(null!=b?b.id:b))?g:h,"function"===typeof g?g.call(d,{name:"id",hash:{},data:f}):g))+'" />\n                <input type="hidden" name="displayName" value="'+k((g=null!=(g=c.displayName||(null!=b?b.displayName:b))?g:h,"function"===typeof g?g.call(d,{name:"displayName",hash:{},data:f}):g))+'" class="fyre-cp-edit-form-displayname" />\n                <input type="hidden" name="form_type" value="notifications" />\n                <ul class="fyre-cp-edit-form-notifications">\n                    <li>\n                        <label for="email_comments">'+
k((g=null!=(g=c.emailCommentsIFollow||(null!=b?b.emailCommentsIFollow:b))?g:h,"function"===typeof g?g.call(d,{name:"emailCommentsIFollow",hash:{},data:f}):g))+'</label>\n                        <select name="email_comments"class="fyre-cp-input-email_comments">\n'+(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.comments:e,{name:"each",hash:{},fn:a.program(9,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="email_likes">'+
k((g=null!=(g=c.emailWhenSomeoneLikes||(null!=b?b.emailWhenSomeoneLikes:b))?g:h,"function"===typeof g?g.call(d,{name:"emailWhenSomeoneLikes",hash:{},data:f}):g))+'</label>\n                        <select name="email_likes" class="fyre-cp-input-email_likes">\n'+(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.likes:e,{name:"each",hash:{},fn:a.program(9,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="email_replies">'+
k((g=null!=(g=c.emailWhenSomeoneReplies||(null!=b?b.emailWhenSomeoneReplies:b))?g:h,"function"===typeof g?g.call(d,{name:"emailWhenSomeoneReplies",hash:{},data:f}):g))+'</label>\n                        <select name="email_replies" class="fyre-cp-input-email_replies">\n'+(null!=(e=c.each.call(d,null!=(e=null!=b?b.email_notifications:b)?e.replies:e,{name:"each",hash:{},fn:a.program(9,f,0),inverse:a.noop,data:f}))?e:"")+'                        </select>\n                    </li>\n                    <li>\n                        <label for="auto_follow">'+
k((g=null!=(g=c.automaticallyFollowConversations||(null!=b?b.automaticallyFollowConversations:b))?g:h,"function"===typeof g?g.call(d,{name:"automaticallyFollowConversations",hash:{},data:f}):g))+'</label>\n                        <input type="checkbox" name="auto_follow" class="fyre-cp-input-auto_follow" value="true" '+(null!=(e=c["if"].call(d,null!=b?b.auto_follow:b,{name:"if",hash:{},fn:a.program(12,f,0),inverse:a.noop,data:f}))?e:"")+' />\n                    </li>\n                </ul>\n                <footer class="fyre-cp-edit-form-footer">\n                    <div class="fyre-cp-edit-close-wrapper fyre-cp-form-btns">\n                        <span class="fyre-cp-edit-save-msg"></span>\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+
k((g=null!=(g=c.formInputCloseButtonText||(null!=b?b.formInputCloseButtonText:b))?g:h,"function"===typeof g?g.call(d,{name:"formInputCloseButtonText",hash:{},data:f}):g))+'" />\n                    </div>\n                    <div class="fyre-cp-edit-save-wrapper fyre-cp-form-btns fyre-cp-hidden">\n                        <input type="submit" class="fyre-cp-form-cancel-btn" value="'+k((g=null!=(g=c.formInputCancelButtonText||(null!=b?b.formInputCancelButtonText:b))?g:h,"function"===typeof g?g.call(d,
{name:"formInputCancelButtonText",hash:{},data:f}):g))+'" />\n                        <input type="submit" class="fyre-cp-form-submit-btn" value="'+k((g=null!=(g=c.formInputSaveButtonText||(null!=b?b.formInputSaveButtonText:b))?g:h,"function"===typeof g?g.call(d,{name:"formInputSaveButtonText",hash:{},data:f}):g))+'" />\n                    </div>\n                </footer>\n            </form>\n        </section>\n'+(null!=(e=c["if"].call(d,null!=b?b.showPassword:b,{name:"if",hash:{},fn:a.program(14,
f,0),inverse:a.noop,data:f}))?e:"")+(null!=(e=c["if"].call(d,null!=b?b.showPrivacy:b,{name:"if",hash:{},fn:a.program(16,f,0),inverse:a.noop,data:f}))?e:"")+"    </section>\n</div>\n"},useData:!0});goog.exportSymbol("fyre.sp.templates.editprofilev2",fyre.sp.templates.editprofilev2);fyre.sp.ui.EditProfileView=function(a,b){fyre.sp.ui.ProfileFormBase.call(this,a,b)};goog.inherits(fyre.sp.ui.EditProfileView,fyre.sp.ui.ProfileFormBase);
...
SAVE_WRAPPER:"fyre-cp-edit-save-wrapper",SAVE_MSG:"fyre-cp-edit-save-msg",TAB_CONTENT:"fyre-cp-edit-tab-content",AVATAR_FILENAME:"fyre-avatar-filename",PRIVACY_FORM:"privacy-form",PRAVACY_RADIO:"privacy-radio",PRIVACY_FORM_CANCEL:"privacy-form-cancel",PRIVACY_DELETE_CONFIRM:"privacy-delete-confirm",PRIVACY_DELETE_CANCEL:"privacy-delete-cancel",PRIVACY_DELETE_CONFIRMATION:"privacy-delete-confirmation",PRIVACY_RESULT_WRAPPER:"privacy-result-wrapper",PRIVACY_ACCESS_RESULT:"privacy-access-result",PRIVACY_DELETE_RESULT:"privacy-delete-result",
PRIVACY_ERROR:"privacy-error",PRIVACY_FORM_WRAPPER:"privacy-form-wrapper",PRIVACY_ACCESS_REQUEST_ID:"access-request-id",PRIVACY_ACCESS_REPORT_PAGE_URL:"access-report-page-url",PRIVACY_DELETE_REQUEST_ID:"delete-request-id",PRIVACY_DELETE_REPORT_PAGE_URL:"delete-report-page-url",PRIVACY_ACCESS_RESULT_CLOSE:"privacy-access-result-close",PRIVACY_ERROR_CLOSE:"privacy-error-close",PRIVACY_DELETE_RESULT_CLOSE:"privacy-delete-result-close",RECAPTCHA_CONTAINER:"g-recaptcha"};
fyre.sp.ui.EditProfileView.prototype.EVENTS={"form-init":fyre.sp.events.PROFILE_EDIT_INIT,"form-init-complete":fyre.sp.events.PROFILE_EDIT_INIT_SUCCESS,"form-init-failure":fyre.sp.events.PROFILE_EDIT_INIT_FAILURE,"form-submit":fyre.sp.events.PROFILE_EDIT_SUBMIT,"form-submit-complete":fyre.sp.events.PROFILE_EDIT_SUBMIT_SUCCESS,"form-submit-failure":fyre.sp.events.PROFILE_EDIT_SUBMIT_FAILURE,"privacy-access-form-submit":fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT,"privacy-access-form-submit-success":fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_SUCCESS,
"privacy-access-form-submit-failure":fyre.sp.events.PRIVACY_PROFILE_ACCESS_SUBMIT_FAILURE,"privacy-delete-form-submit":fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT,"privacy-delete-form-submit-success":fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_SUCCESS,"privacy-delete-form-submit-failure":fyre.sp.events.PRIVACY_PROFILE_DELETE_SUBMIT_FAILURE,"auth-logout-complete":fyre.sp.events.AUTH_LOGOUT_COMPLETE,"form-avatar-submit-failure":"form-avatar-submit-failure"};
fyre.sp.ui.EditProfileView.REQUEST_TYPES={ACCESS:"access",DELETE:"delete"};fyre.sp.ui.EditProfileView.PRIVACY_SUBMIT_BUTTON_ID="privacy-form-submit-button";
fyre.sp.ui.EditProfileView.prototype.initialize=function(a){fyre.sp.ui.EditProfileView.superClass_.initialize.call(this,a);this.subscribe(this.getEvent("form-init"),this.open);this.subscribe(this.getEvent("form-init-complete"),this.handleGetComplete);this.subscribe(this.getEvent("form-init-failure"),this.handleGetFailure);this.subscribe(this.getEvent("form-submit-complete"),this.handleFormSubmitSuccess);this.subscribe(this.getEvent("form-submit-failure"),this.handleFormErrors);this.subscribe(this.getEvent("privacy-access-form-submit-success"),
this.handlePrivacyProfileAccessSuccess);this.subscribe(this.getEvent("privacy-access-form-submit-failure"),this.handlePrivacyProfileAccessFailure);this.subscribe(this.getEvent("privacy-delete-form-submit-success"),this.handlePrivacyProfileDeleteSuccess);this.subscribe(this.getEvent("privacy-delete-form-submit-failure"),this.handlePrivacyProfileDeleteFailure);this.subscribe("form-avatar-submit-failure",this.handleAvatarSubmitError);fyre.messenger.base.subscribe(this.getEvent("auth-logout-complete"),
this.close,this)};fyre.sp.ui.EditProfileView.prototype.handleAvatarSubmitError=function(){var a=this.$el.findElementByClass(fyre.sp.ui.EditProfileView.CLASSES.AVATAR_FILENAME);this.validator.addError(a,this.getTranslations().avatarImageExceedSize)};
fyre.sp.ui.EditProfileView.prototype.renderSafe=function(){var a=this.model.toJSON(),b=fyre.sp.model.Profile.ATTRIBUTES,c=fyre.sp.ui.EditProfileView.CLASSES,d=fyre.sp.templates.editprofilev2,f=fyre.sp.ui.EditProfileView.REQUEST_TYPES,e=fyre.sp.config.privacy,g=e.recaptcha;a.is_mobile=this.isMobile;a.showPassword=fyre.sp.config.auth.LOCAL&&a[b.HAS_PASSWORD];a.showPrivacy=e.enabled;a.privacyHeader=e.header;a.privacyFooter=e.footer;a.showRecaptcha=g.enabled;a.privacySubmitButtonId=fyre.sp.ui.EditProfileView.PRIVACY_SUBMIT_BUTTON_ID;
a.requestTypeAccess=f.ACCESS;a.requestTypeDelete=f.DELETE;fyre.sp.config.lfep2&&(a.customerLogo=fyre.sp.config.customerLogo,b=this.getTranslations(this.opts),goog.object.extend(a,b));this.$el.html(d(a));this.active_tab=this.$el.findElementByClass(c.EDIT_PROFILE_TAB);this.toggleDisableForm(!0);this.getLoader().show("inline");this.getCommentCount().hide();this.getLikeCount().hide();fyre.sp.config.lfep2&&document.body&&(document.body.className+=" fyre-sp-edit-profile-view",fyre.util.appendCSS(fyre.sp.templates.css({brandColor:fyre.sp.config.brand_color,
brandFont:fyre.sp.config.font})));if(e.enabled&&g.enabled){var h=this.$el.findElementByClass(c.RECAPTCHA_CONTAINER);window.recaptchaOnloadCallback=function(){h.html("");var a=document.createElement("div");grecaptcha.render(a,{sitekey:g.siteKey,callback:function(){document.getElementById(fyre.sp.ui.EditProfileView.PRIVACY_SUBMIT_BUTTON_ID).removeAttribute("disabled")}});h.html(a.innerHTML)};fyre.util.loadScript("https://www.google.com/recaptcha/api.js?onload=recaptchaOnloadCallback&render=explicit",
window.document,{async:!0,defer:!0})}};fyre.sp.ui.EditProfileView.prototype.getForm=function(){return this.active_tab.getByClass(fyre.sp.ui.EditProfileView.CLASSES.FORM)};fyre.sp.ui.EditProfileView.prototype.getPrivacyCancelButton=function(){return this.$el.getByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_FORM_CANCEL)};fyre.sp.ui.EditProfileView.prototype.getPrivacyForm=function(){return this.$el.getByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_FORM)};
fyre.sp.ui.EditProfileView.prototype.getPrivacyDeleteCancelButton=function(){return this.$el.getByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_DELETE_CANCEL)};fyre.sp.ui.EditProfileView.prototype.getPrivacyDeleteConfirmButton=function(){return this.$el.getByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_DELETE_CONFIRM)};fyre.sp.ui.EditProfileView.prototype.getPrivacyAccessResultCloseButton=function(){return this.$el.findElementByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_ACCESS_RESULT_CLOSE)};
fyre.sp.ui.EditProfileView.prototype.getPrivacyDeleteResultCloseButton=function(){return this.$el.findElementByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_DELETE_RESULT_CLOSE)};fyre.sp.ui.EditProfileView.prototype.getPrivacyErrorCloseButton=function(){return this.$el.findElementByClass(fyre.sp.ui.EditProfileView.CLASSES.PRIVACY_ERROR_CLOSE)};fyre.sp.ui.EditProfileView.prototype.getForms=function(){return this.$el.findElementsByClass(fyre.sp.ui.EditProfileView.CLASSES.FORM)};
...
fyre.sp.ui.EditProfileView.prototype.handleInputsChanged=function(a){if(a.currentTarget.type!==goog.events.EventType.SUBMIT){var b=fyre.sp.ui.EditProfileView.CLASSES;a.preventDefault();(a=this.active_tab.findElementByClass(b.CLOSE_WRAPPER))&&a.addClass(b.HIDDEN);(a=this.active_tab.findElementByClass(b.SAVE_WRAPPER))&&a.removeClass(b.HIDDEN)}};
...
fyre.sp.ui.EditProfileView.prototype.privacyFormSubmit=function(a,b){a.preventDefault();var c=fyre.sp.ui.EditProfileView.CLASSES,d=goog.array.find(this.$el.getNByClass(c.PRAVACY_RADIO),function(a){return a.element.checked});if(d){var f=fyre.sp.ui.EditProfileView.REQUEST_TYPES;switch(d.element.value){case f.ACCESS:fyre.sp.ui.EditProfileView.superClass_.privacyFormSubmit.call(this,a,this.getEvent("privacy-access-form-submit"));break;case f.DELETE:if(b)fyre.sp.ui.EditProfileView.superClass_.privacyFormSubmit.call(this,
a,this.getEvent("privacy-delete-form-submit"));else{this.$el.findElementByClass(c.PRIVACY_FORM_WRAPPER).addClass(c.HIDDEN);this.$el.findElementByClass(c.PRIVACY_DELETE_CONFIRMATION).removeClass(c.HIDDEN);return}}fyre.sp.config.privacy.enabled&&fyre.sp.config.privacy.recaptcha.enabled&&(grecaptcha.reset(),document.getElementById(fyre.sp.ui.EditProfileView.PRIVACY_SUBMIT_BUTTON_ID).setAttribute("disabled",!0))}};
fyre.sp.ui.EditProfileView.prototype.privacyDeleteFormSubmit=function(a){this.privacyFormSubmit(a,!0)};
fyre.sp.ui.EditProfileView.prototype.handlePrivacyProfileAccessSuccess=function(a){var b=fyre.sp.ui.EditProfileView.CLASSES;this.$el.findElementByClass(b.PRIVACY_FORM_WRAPPER).addClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_RESULT_WRAPPER).removeClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_ACCESS_RESULT).removeClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_DELETE_RESULT).addClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_ERROR).addClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_ACCESS_REPORT_PAGE_URL).element.href=
a.reportPageUrl;this.$el.findElementByClass(b.PRIVACY_ACCESS_REQUEST_ID).element.innerHTML=a.requestId};fyre.sp.ui.EditProfileView.prototype.handlePrivacyProfileAccessFailure=function(a){this.handleFailure()};fyre.sp.ui.EditProfileView.prototype.cancelPrivacyDeleteForm=function(a){var b=fyre.sp.ui.EditProfileView.CLASSES;a.preventDefault();this.closePrivacyDeleteConfirmation();this.$el.findElementByClass(b.PRIVACY_FORM_WRAPPER).removeClass(b.HIDDEN)};
fyre.sp.ui.EditProfileView.prototype.closePrivacyDeleteConfirmation=function(){var a=fyre.sp.ui.EditProfileView.CLASSES;this.$el.findElementByClass(a.PRIVACY_DELETE_CONFIRMATION).addClass(a.HIDDEN)};
fyre.sp.ui.EditProfileView.prototype.handlePrivacyProfileDeleteSuccess=function(a){this.closePrivacyDeleteConfirmation();var b=fyre.sp.ui.EditProfileView.CLASSES;this.$el.findElementByClass(b.PRIVACY_FORM_WRAPPER).addClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_RESULT_WRAPPER).removeClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_DELETE_RESULT).removeClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_ERROR).addClass(b.HIDDEN);this.$el.findElementByClass(b.PRIVACY_ACCESS_RESULT).addClass(b.HIDDEN);
this.$el.findElementByClass(b.PRIVACY_DELETE_REPORT_PAGE_URL).element.href=a.reportPageUrl;this.$el.findElementByClass(b.PRIVACY_DELETE_REQUEST_ID).element.innerHTML=a.requestId};fyre.sp.ui.EditProfileView.prototype.handlePrivacyProfileDeleteFailure=function(a){this.closePrivacyDeleteConfirmation();this.handleFailure()};
fyre.sp.ui.EditProfileView.prototype.handleFailure=function(){var a=fyre.sp.ui.EditProfileView.CLASSES;this.$el.findElementByClass(a.PRIVACY_FORM_WRAPPER).addClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_RESULT_WRAPPER).removeClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_ERROR).removeClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_DELETE_RESULT).addClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_ACCESS_RESULT).addClass(a.HIDDEN)};
fyre.sp.ui.EditProfileView.prototype.closePrivacyResult=function(){var a=fyre.sp.ui.EditProfileView.CLASSES;this.$el.findElementByClass(a.PRIVACY_RESULT_WRAPPER).addClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_FORM_WRAPPER).removeClass(a.HIDDEN);this.$el.findElementByClass(a.PRIVACY_ERROR).addClass(a.HIDDEN)};
...
this.registerControl(this.getRealTimeValidation().all(),a.KEYUP,this.handleInputKeyUp);this.registerControl(this.getPrivacyCancelButton(),a.CLICK,this.handleFormCancel);this.registerControl(this.getPrivacyForm(),a.SUBMIT,this.privacyFormSubmit);this.registerControl(this.getPrivacyDeleteCancelButton(),a.CLICK,this.cancelPrivacyDeleteForm);this.registerControl(this.getPrivacyDeleteConfirmButton(),a.CLICK,this.privacyDeleteFormSubmit);this.registerControl(this.getPrivacyAccessResultCloseButton(),a.CLICK,
this.closePrivacyResult);this.registerControl(this.getPrivacyDeleteResultCloseButton(),a.CLICK,this.handleFormCancel);this.registerControl(this.getPrivacyErrorCloseButton(),a.CLICK,this.closePrivacyResult);this.registerFocusEvents_();this.registerChangeEvents_();this.registerValidators_();this.registerImageFileControl()};
fyre.sp.ui.EditProfileView.prototype.registerFocusEvents_=function(){var a=this.getByTag("input").all(),b=this.getByTag("textarea").all(),c=this.getByTag("select").all(),a=goog.array.concat(a,b,c);this.registerControl(a,goog.events.EventType.FOCUS,this.handleInputsChanged)};fyre.sp.ui.EditProfileView.prototype.registerChangeEvents_=function(){var a=[];this.isMobile||a.push(this.getFileInput());a.push(this.getCheckboxInput());this.registerControl(a,goog.events.EventType.CHANGE,this.handleInputsChanged)};
fyre.sp.ui.EditProfileView.prototype.registerValidators_=function(){this.validator_set={};goog.array.forEach(this.getForms().all(),function(a){this.validator_set[a.name]=new fyre.forms.validate(fyre.dom(a))},this)};
...
fyre.sp.app.MobileEngage.prototype.setUri_=function(a,b){var c=this.AUTH_TYPES,d=new goog.Uri(fyre.sp.config.servers.profile+"/pages/auth/engage/"),f=new goog.Uri.QueryData;b===c.REDIRECT&&(a.next=fyre.util.base64.encodeString(window.location.href));f.extend(a);f.remove("events");return d.setQueryData(f)};fyre.sp.app.MobileEngage.prototype.NAME="fyre.sp.app.MobileEngage";fyre.sp.app.PageEngage=function(a){fyre.sp.app.EngageBase.call(this,a)};goog.inherits(fyre.sp.app.PageEngage,fyre.sp.app.EngageBase);
